...
QUnit.module('QuantumCircuitElement', hooks => {
  ...
  QUnit.module('phase', () => {
    QUnit.test('should apply a phase shift gate', assert => {
      ...
      assert.equal(qc.step(0).dropzone(0).draggableElement, null)
      assert.equal(qc.step(0).dropzone(1).draggableElement?.toJson(), '"P(0.123)"')
    })
    ...
    QUnit.test('should apply multiple phase shift gates', assert => {
      ...
      assert.equal(qc.step(0).dropzone(1).draggableElement?.toJson(), '"P(0.123)"')
      assert.equal(qc.step(0).dropzone(2).draggableElement, null)
      assert.equal(qc.step(0).dropzone(3).draggableElement?.toJson(), '"P(0.123)"')
    })
  ...
  QUnit.module('rnot', () => {
    QUnit.test('should apply a √X gate', assert => {
      ...
      assert.equal(qc.step(0).dropzone(0).draggableElement, null)
      assert.equal(qc.step(0).dropzone(1).draggableElement?.tagName, 'RNOT-GATE')
    })
    ...
    QUnit.test('should apply multiple √X gates', assert => {
      ...
      assert.equal(qc.step(0).dropzone(1).draggableElement?.tagName, 'RNOT-GATE')
      assert.equal(qc.step(0).dropzone(2).draggableElement, null)
      assert.equal(qc.step(0).dropzone(3).draggableElement?.tagName, 'RNOT-GATE')
    })
  ...
  QUnit.module('rx', () => {
    QUnit.test('should apply an Rx gate', assert => {
      ...
      assert.equal(qc.step(0).dropzone(0).draggableElement, null)
      assert.equal(qc.step(0).dropzone(1).draggableElement?.toJson(), '"Rx(0.123)"')
    })
    ...
    QUnit.test('should apply multiple Rx gates', assert => {
      ...
      assert.equal(qc.step(0).dropzone(1).draggableElement?.toJson(), '"Rx(0.123)"')
      assert.equal(qc.step(0).dropzone(2).draggableElement, null)
      assert.equal(qc.step(0).dropzone(3).draggableElement?.toJson(), '"Rx(0.123)"')
    })
  ...
  QUnit.module('ry', () => {
    QUnit.test('should apply an Ry gate', assert => {
      ...
      assert.equal(qc.step(0).dropzone(0).draggableElement, null)
      assert.equal(qc.step(0).dropzone(1).draggableElement?.toJson(), '"Ry(0.123)"')
    })
    ...
    QUnit.test('should apply multiple Ry gates', assert => {
      ...
      assert.equal(qc.step(0).dropzone(1).draggableElement?.toJson(), '"Ry(0.123)"')
      assert.equal(qc.step(0).dropzone(2).draggableElement, null)
      assert.equal(qc.step(0).dropzone(3).draggableElement?.toJson(), '"Ry(0.123)"')
    })
  ...
  QUnit.module('rz', () => {
    QUnit.test('should apply an Rz gate', assert => {
      ...
      assert.equal(qc.step(0).dropzone(0).draggableElement, null)
      assert.equal(qc.step(0).dropzone(1).draggableElement?.toJson(), '"Rz(0.123)"')
    })
    ...
    QUnit.test('should apply multiple Rz gates', assert => {
      ...
      assert.equal(qc.step(0).dropzone(1).draggableElement?.toJson(), '"Rz(0.123)"')
      assert.equal(qc.step(0).dropzone(2).draggableElement, null)
      assert.equal(qc.step(0).dropzone(3).draggableElement?.toJson(), '"Rz(0.123)"')
    })
  ...
  QUnit.module('control', () => {
    QUnit.test('should apply a control gate', assert => {
      ...
      assert.equal(qc.step(0).dropzone(0).draggableElement, null)
      assert.equal(qc.step(0).dropzone(1).draggableElement?.tagName, 'CONTROL-GATE')
    })
    ...
    QUnit.test('should apply multiple control gates', assert => {
      ...
      assert.equal(qc.step(0).dropzone(1).draggableElement?.tagName, 'CONTROL-GATE')
      assert.equal(qc.step(0).dropzone(2).draggableElement, null)
      assert.equal(qc.step(0).dropzone(3).draggableElement?.tagName, 'CONTROL-GATE')
    })
  ...
  QUnit.module('ccnot', () => {
    ...
    QUnit.test('should throw when the first control qubit is negative', assert => {
      assert.throws(() => qc.ccnot(-1, 0, 1))
    })

    QUnit.test('should throw when the second control qubit is negative', assert => {
  ...
  QUnit.module('swap', () => {
    QUnit.test('should apply a SWAP gate', assert => {
      ...
      assert.equal(qc.step(0).dropzone(0).draggableElement, null)
      assert.equal(qc.step(0).dropzone(1).draggableElement?.tagName, 'SWAP-GATE')
      assert.equal(qc.step(0).dropzone(2).draggableElement, null)
      assert.equal(qc.step(0).dropzone(3).draggableElement?.tagName, 'SWAP-GATE')
    })

    QUnit.test('should throw when the first target qubit is negative', assert => {
      assert.throws(() => qc.swap(-1, 0))
    })

    QUnit.test('should throw when the second target qubit is negative', assert => {
  ...
  QUnit.module('bloch', () => {
    QUnit.test('should put a bloch display', assert => {
      ...
      assert.equal(qc.step(0).dropzone(0).draggableElement, null)
      assert.equal(qc.step(0).dropzone(1).draggableElement?.tagName, 'BLOCH-DISPLAY')
    })
    ...
    QUnit.test('should put multiple bloch displays', assert => {
      ...
      assert.equal(qc.step(0).dropzone(1).draggableElement?.tagName, 'BLOCH-DISPLAY')
      assert.equal(qc.step(0).dropzone(2).draggableElement, null)
      assert.equal(qc.step(0).dropzone(3).draggableElement?.tagName, 'BLOCH-DISPLAY')
    })
  ...
  QUnit.module('measure', () => {
    QUnit.test('should apply a measurement gate', assert => {
      ...
      assert.equal(qc.step(0).dropzone(0).draggableElement, null)
      assert.equal(qc.step(0).dropzone(1).draggableElement?.tagName, 'MEASUREMENT-GATE')
    })
    ...
    QUnit.test('should apply multiple measurement gates', assert => {
      ...
      assert.equal(qc.step(0).dropzone(1).draggableElement?.tagName, 'MEASUREMENT-GATE')
      assert.equal(qc.step(0).dropzone(2).draggableElement, null)
      assert.equal(qc.step(0).dropzone(3).draggableElement?.tagName, 'MEASUREMENT-GATE')
    })
  })
})
