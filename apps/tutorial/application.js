...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    function _o(n, o, a, s) {
      ...
      for (var O = 0; O < s.interactions.list.length; O++) {
        ...
        if (N.interacting() && (++g >= h || N.interactable === n && ((x += G === a.name ? 1 : 0) >= f || N.element === o && (T++, G === a.name && T >= v))))
          return false;
      }
      return h > 0;
    }
    ...
    var dd = { id: "auto-start/base", before: ["actions"], install: function(n) {
      ...
      (function(a, s) {
        ...
        if (p.pointerIsDown && !p.interacting() && p.pointerWasMoved && p.prepared.name) {
          ...
          v && f && (f.options[v].manualStart || !_o(f, p.element, p.prepared, s) ? p.stop() : (p.start(p.prepared, f, p.element), Rl(p, s)));
        }
      }(n, o);
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    u(mn, "we"), Object.defineProperty(hn, "__esModule", { value: true }), hn.getRectOffset = ql, hn.default = void 0;
    var wd = function() {
      function n(s) {
        (function(p, f) {
          if (!(p instanceof f))
      ...
      return o = n, (a = [{ key: "start", value: function(s, p) {
        ...
        this.prepareStates(h), this.edges = (0, U.default)({}, v.edges), this.startOffset = ql(v.rect, p), this.startDelta = { x: 0, y: 0 };
        ...
        for (var O = 0; O < [[h, x], [v, T]].length; O++) {
          var N = Nl([[h, x], [v, T]][O], 2), G = N[0], D = N[1];
    ...
    var Wl = function() {
      ...
      return o = n, (a = [{ key: "start", value: function(s) {
        ...
        if (O < this.te) {
          ...
          this.isModified ? (s = this.targetOffset.x, p = this.targetOffset.y, f = this.modifiedOffset.x, v = this.modifiedOffset.y, N = { x: Ul(h = G, 0, s, f), y: Ul(h, 0, p, v) }) : N = { x: this.targetOffset.x * G, y: this.targetOffset.y * G };
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var jd = { id: "events", install: function(n) {
      var o, a = [], s = {}, p = [], f = { add: v, remove: h, addDelegate: function(T, O, N, G, D) {
        var $ = ki(D);
        if (!s[N]) {
          s[N] = [];
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var Su = { start: function(n) {
      ...
      v.offsets = f && O && O.length ? O.map(function(N, G) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var gf = function(n) {
      ...
      function v(h, g, x, T, O, N) {
        ...
        if (function(J, F) {
          if (!(J instanceof F))
            throw new TypeError("Cannot call a class as a function");
        }(this, v), mr(Pt(G = f.call(this, O)), "type", void 0), mr(Pt(G), "originalEvent", void 0), mr(Pt(G), "pointerId", void 0), mr(Pt(G), "pointerType", void 0), mr(Pt(G), "double", void 0), mr(Pt(G), "pageX", void 0), mr(Pt(G), "pageY", void 0), mr(Pt(G), "clientX", void 0), mr(Pt(G), "clientY", void 0), mr(Pt(G), "dt", void 0), mr(Pt(G), "eventable", void 0), K.pointerExtend(Pt(G), x), x !== g && K.pointerExtend(Pt(G), g), G.timeStamp = N, G.originalEvent = x, G.type = h, G.pointerId = K.getPointerId(g), G.pointerType = K.getPointerType(g), G.target = T, G.currentTarget = null, h === "tap") {
    ...
    function Au(n, o) {
      ...
      return v === "hold" && (T.targets = T.targets.filter(function(G) {
        var D;
...
function Ne(r) {
  var e;
  return (e = []).concat.apply(e, ke([], ve(r), false));
}
u(Ne, "flatten");
function nc(r) {
  return Gr(r) ? r : [r];
      ...
      default:
        ...
        if (V && w) {
          ...
          X = Y(Y({}, X), { exec: function(W) {
            ...
            V.apply(void 0, ke([w[H]], ve(ne), false));
          } });
        }
        return X;
    }
...
function An(r, e) {
  ...
  try {
    for (var M = me(C), k = M.next(); !k.done; k = M.next())
...
u(Qi, "has");
function Cc(r) {
  return ke([], ve(new Set(Ne(ke([], ve(r.map(function(e) {
    return e.ownEvents;
  })), false)))), false);
}
u(Cc, "nextEvents");
...
var vr = function() {
  ...
  return u(r, "State"), r.from = function(e, t) {
    ...
    if (e === void 0 && (e = this.value), t === void 0 && (t = "."), ge(e))
      return [e];
    var l = Object.keys(e);
    return l.concat.apply(l, ke([], ve(l.map(function(c) {
...
Event: `).concat(JSON.stringify(C.data)));
  ...
  return u(r, "Interpreter"), Object.defineProperty(r.prototype, "initialState", { get: function() {
    ...
    if (!this.initialized)
      return this;
    ke([], ve(this.state.configuration), false).sort(function(V, H) {
...
Event: `).concat(JSON.stringify(event)));
    ...
    this.scheduler.schedule(function() {
      var i, l, c = t.state, d = false, m = [], b = u(function(C) {
        ...
        }), m.push.apply(m, ke([], ve(c.actions.map(function(k) {
          return Mc(k, c);
        })), false)), d = d || !!c.changed;
      }, "_loop_1");
      try {
...
var Dc = function() {
  ...
  return u(r, "StateNode"), r.prototype._init = function() {
    ...
    return m.push.apply(m, ke([], ve(Ne(d.map(function(b) {
...
`).concat(B.message));
        ...
        if (P && _) {
          C.target !== void 0 && (b = C.target), m.push.apply(m, ke([], ve(C.actions), false)), y = C;
          break;
        }
      }
    } catch (B) {
    ...
    try {
      for (var k = me(y), S = k.next(); !S.done; S = k.next()) {
        var M = S.value;
    ...
    var P = new Set(e.entrySet), I = new Set(e.exitSet), L = ve([Ne(Array.from(P).map(function(X) {
      return ke(ke([], ve(X.activities.map(function(V) {
        return hc(V);
      })), false), ve(X.onEntry), false);
    })).concat(_.map(dc)), Ne(Array.from(I).map(function(X) {
      return ke(ke([], ve(X.onExit), false), ve(X.activities.map(function(V) {
        return mc(V);
      })), false);
    ...
    return b.configuration = ke([], ve(w), false), this.resolveTransition(b, c, c.context, l);
  }, r.prototype.resolveRaisedTransition = function(e, t, i) {
    var l, c = e.actions;
    return e = this.transition(e, t), e._event = i, e.event = i.data, (l = e.actions).unshift.apply(l, ke([], ve(c), false)), e;
    ...
    try {
      for (var k = me(C), S = k.next(); !S.done; S = k.next()) {
        var _ = S.value;
...
`).concat(m.message));
    ...
    var C = Ne(this.invoke.map(function(I) {
      var L = [];
      return I.onDone && L.push.apply(L, ke([], ve(Tn(String(si(I.id)), I.onDone)), false)), I.onError && L.push.apply(L, ke([], ve(Tn(String(On(I.id)), I.onError)), false)), L;
    })), M = this.after, k = Ne(ke(ke(ke(ke([], ve(A), false), ve(C), false), ve(l), false), ve(w), false).map(function(I) {
...
function Bc(r) {
  var e, t = r.popper, i = r.popperRect, l = r.placement, c = r.variation, d = r.offsets, m = r.position, b = r.gpuAcceleration, y = r.adaptive, w = r.roundOffsets, A = r.isFixed, C = d.x, M = C === void 0 ? 0 : C, k = d.y, S = k === void 0 ? 0 : k, _ = typeof w == "function" ? w({ x: M, y: S }) : { x: M, y: S };
  M = _.x, S = _.y;
...
function tl(r) {
  ...
  return i && (l = i.width, c = i.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (d = i.offsetLeft, m = i.offsetTop)), { width: l, height: c, x: d + qn(r), y: m };
}
u(tl, "getViewportRect");
function rl(r) {
  var e, t = gt(r), i = Gn(r), l = (e = r.ownerDocument) == null ? void 0 : e.body, c = gr(t.scrollWidth, t.clientWidth, l ? l.scrollWidth : 0, l ? l.clientWidth : 0), d = gr(t.scrollHeight, t.clientHeight, l ? l.scrollHeight : 0, l ? l.clientHeight : 0), m = -i.scrollLeft + qn(r), b = -i.scrollTop;
...
function nn(r, e) {
  var t;
  e === void 0 && (e = []);
  var i = Ga(r), l = i === ((t = r.ownerDocument) == null ? void 0 : t.body), c = Xe(i), d = l ? [c].concat(c.visualViewport || [], Ln(i) ? i : []) : i, m = e.concat(d);
...
function nl(r, e, t) {
  var i = e === "clippingParents" ? _h(r) : [].concat(e), l = [].concat(i, [t]), c = l[0], d = l.reduce(function(m, b) {
    var y = Fc(r, b);
    return m.top = gr(y.top, m.top), m.right = kn(y.right, m.right), m.bottom = kn(y.bottom, m.bottom), m.left = gr(y.left, m.left), m;
  }, Fc(r, c));
...
function il(r, e) {
  e === void 0 && (e = {});
  var t = e, i = t.placement, l = t.boundary, c = t.rootBoundary, d = t.padding, m = t.flipVariations, b = t.allowedAutoPlacements, y = b === void 0 ? ka : b, w = Zt(i), A = w ? m ? Qs : Qs.filter(function(k) {
    return Zt(k) === w;
...
function Ah(r) {
  ...
  if (!e.modifiersData[i]._skip) {
    for (var l = t.mainAxis, c = l === void 0 ? true : l, d = t.altAxis, m = d === void 0 ? true : d, b = t.fallbackPlacements, y = t.padding, w = t.boundary, A = t.rootBoundary, C = t.altBoundary, M = t.flipVariations, k = M === void 0 ? true : M, S = t.allowedAutoPlacements, _ = e.options.placement, P = st(_), I = P === _, L = b || (I || !k ? [di(_)] : Mh(_)), E = [_].concat(L).reduce(function(K, wt) {
      ...
      B[ze] > z[ze] && (qe = di(qe));
      var fe = di(qe), Ye = [];
      if (c && Ye.push(We[ie] <= 0), m && Ye.push(We[qe] <= 0, We[fe] <= 0), Ye.every(function(K) {
        return K;
      })) {
        H = ne, V = false;
        break;
...
function ll(r, e, t) {
  ...
  return (i || !i && !t) && ((at(e) !== "body" || Ln(c)) && (m = sl(e)), rt(e) ? (b = Yt(e, true), b.x += e.clientLeft, b.y += e.clientTop) : c && (b.x = qn(c))), { x: d.left + m.scrollLeft - b.x, y: d.top + m.scrollTop - b.y, width: d.width, height: d.height };
}
          ...
          for (let [c, d] of Ge(l, (m) => m.angle))
            for (let [m, b] of Ge(d, (y) => y.if))
              for (let [y, w] of Ge(b, (A) => A.controls.toString())) {
                ...
                m !== "" && (k.if = m), c !== "" && (k.angle = c), y !== "" && (k.controls = A.controls), e.push(k);
              }
          break;
        }
        case ar: {
...
var bt = class extends HTMLElement {
  ...
  setAmplitudes(e) {
    for (let t of this.qubitCircles) {
      ...
      ae.notNull(m), m.style.setProperty("--magnitude", d.toString());
  ...
  maybeRedrawQubitCircles() {
    ...
    for (let m of this.allQubitCircleElements(c))
      d.appendChild(m);
    this.innerContainer.textContent = "", this.innerContainer.appendChild(d), this.dispatchVisibilityChangedEvent();
  }
  dispatchVisibilityChangedEvent() {
    this.dispatchEvent(new CustomEvent("circle-notation-visibility-change", { detail: this.visibleQubitCircleKets, bubbles: true }));
  }
  ...
  qubitCircleElement(e) {
    ...
    c.className = "qubit-circle", c.setAttribute("data-ket", t.toString()), c.setAttribute("data-targets", "virtualized-grid.qubitCircles"), c.setAttribute("data-amplitude-real", "0"), c.setAttribute("data-amplitude-imag", "0"), c.style.setProperty("top", `${i}px`), c.style.setProperty("left", `${l}px`);
