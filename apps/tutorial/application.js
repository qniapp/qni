...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    __name(le, "le");
    u(le, "cn"), Object.defineProperty(Kn, "__esModule", { value: true }), Kn.default = Kn.InertiaState = void 0;
    var pu = function() {
      function n(s) {
        (function(p, v) {
          if (!(p instanceof v))
          ...
          for (var E = c.default.string(s.target) ? yt.from(s._context.querySelectorAll(s.target)) : [s.target], g = v.window.Promise, x = g ? [] : null, C = function() {
            ...
            if (q)
              ...
              D = function(rt, ot, pt, St, Lt) {
                ...
                vt.interactable = ot, vt.element = pt, vt.prevEvent = Lt, vt.updatePointer(Lt, Lt, pt, true), J.setZeroCoords(vt.coords.delta), (0, Le.copyAction)(vt.prepared, St), vt._doPhase(zt);
...
`).concat(B.message));
    ...
    }, e ? X({}, e.children) : {}), K = d ? t.configuration : e ? e.configuration : [], it = kn(K, this), nt = new mr({ value: m || e.value, context: V, _event: l, _sessionid: e ? e._sessionid : null, historyValue: m ? w ? bc(w, m) : void 0 : e ? e.historyValue : void 0, history: !m || t.source ? e : void 0, actions: m ? _ : [], activities: m ? S : e ? e.activities : {}, events: [], configuration: K, transitions: t.transitions, children: W, done: it, tags: pl(K), machine: this }), ct = i !== V;
...
function Jc(r) {
  ...
  var nt = Object.assign({ position: b }, d && Zh), ct = m === true ? Kh({ x: S, y: P }) : { x: S, y: P };
  if (S = ct.x, P = ct.y, h) {
    var Y;
...
function nm(r) {
  var t = rn(qr(r)), e = ["absolute", "fixed"].indexOf(Ae(r).position) >= 0, i = e && oe(r) ? gr(r) : r;
...
function om(r) {
  ...
  if (!t.modifiersData[i]._skip) {
    for (var l = e.mainAxis, c = l === void 0 ? true : l, f = e.altAxis, b = f === void 0 ? true : f, h = e.fallbackPlacements, d = e.padding, m = e.boundary, w = e.rootBoundary, y = e.altBoundary, S = e.flipVariations, O = S === void 0 ? true : S, P = e.allowedAutoPlacements, k = t.options.placement, j = de(k), L = j === k, V = h || (L || !O ? [mi(k)] : im(k)), M = [k].concat(V).reduce(function(Oe, ke) {
      ...
      var nt = M[it], ct = de(nt), Y = Ke(nt) === Gr, ut = [Ft, ie].indexOf(ct) >= 0, kt = ut ? "width" : "height", Wt = br(t, { placement: nt, boundary: m, rootBoundary: w, altBoundary: y, padding: d }), Gt = ut ? Y ? Zt : Vt : Y ? ie : Ft;
      B[kt] > _[kt] && (Gt = mi(Gt));
      var ft = mi(Gt), Xt = [];
...
u(cr, "ZGateElement");
tt(cr);
var Qt = u((r) => r instanceof Je || r instanceof lr || r instanceof ur || r instanceof cr || r instanceof er || r instanceof sr || r instanceof rr || r instanceof nr || r instanceof ir || r instanceof or || r instanceof ar || r instanceof Be || r instanceof ae || r instanceof He || r instanceof tr, "isOperation");
...
u($r, "GateCarouselElement"), A([z], $r.prototype, "currentGateSetIndex", 2), A([wt], $r.prototype, "contentClipper", 2), A([re], $r.prototype, "gateSets", 2), A([re], $r.prototype, "dots", 2), A([re], $r.prototype, "popinAnimationGates", 2), $r = A([tt], $r);
