...
export class CircuitEditorElement extends HTMLElement {
  ...
  connectedCallback(): void {
    ...
    this.addEventListener('draggable:grab-qpu-operation', this.grabOperation)
    this.addEventListener('resizeable:grab-resize-handle', this.grabResizeHandle)
    this.addEventListener('draggable:release-qpu-operation', this.releaseOperation)
    ...
    this.addEventListener('draggable:drop-qpu-operation', this.dropOperation)
