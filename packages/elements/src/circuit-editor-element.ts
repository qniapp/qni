...
export class CircuitEditorElement extends HTMLElement {
  ...
  connectedCallback(): void {
    ...
    this.addEventListener('draggable:qpu-operation-grab', this.grabOperation)
    this.addEventListener('resizeable:grab-resize-handle', this.grabResizeHandle)
    this.addEventListener('draggable:qpu-operation-release', this.releaseOperation)
    this.addEventListener('resizeable:end-resizing', this.resizeEnd)
    this.addEventListener('draggable:qpu-operation-end-dragging', this.endDraggingOperation)
    this.addEventListener('draggable:qpu-operation-drop', this.dropOperation)
    this.addEventListener('draggable:qpu-operation-delete', this.deleteOperation)
    ...
    this.addEventListener('draggable:qpu-operation-in-snap-range', this.operationInSnapRange)
