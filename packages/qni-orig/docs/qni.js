  ...
  @media (min-width: 768px) {
    ...
    >
      ...
      <path
        ...
        stroke-linejoin="round"
      />
    </svg>`}};var qs;t([h,e("design:type",Object)],zs.prototype,"iconType",void 0),t([h,e("design:type",Object)],zs.prototype,"theta",void 0),zs=Ss=t([m],zs);let Cs=qs=class RzGateElement extends(ri(Kr(ns(si(rs(os(es(ji(ts(Zr(Hr(is(HTMLElement))))))))))))){constructor(){super(...arguments),this.iconType="square",this.theta=""}static create({theta:t="π/2",dragAndDrop:e=!1}={}){const i=new qs;return i.theta=t,i.dragAndDrop=e,i}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initDragAndDrop(),this.addEventListener("mouseenter",this.showHelp),this.addEventListener("mousedown",this.showRightClickPopup))}update(){Ni(Li`${this.sizeableStyle} ${this.wiresStyle} ${this.iconStyle}
        ${this.dragAndDroppableStyle} ${this.disabledStyle} ${this.labelStyle}
      ...
      <path
        ...
        stroke-linejoin="round"
      />
    </svg>`}};var _s;t([h,e("design:type",Object)],Cs.prototype,"iconType",void 0),t([h,e("design:type",Object)],Cs.prototype,"theta",void 0),Cs=qs=t([m],Cs);let As=_s=class SwapGateElement extends(Kr(ns(si(rs(ji(ts(Zr(Hr(is(HTMLElement)))))))))){constructor(){super(...arguments),this.iconType="transparent"}static create({dragAndDrop:t=!1}={}){const e=new _s;return e.dragAndDrop=t,e}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initDragAndDrop())}update(){Ni(Li`${this.sizeableStyle} ${this.wiresStyle} ${this.iconStyle}
        ${this.dragAndDroppableStyle}
    ...
    </svg>`}};t([h,e("design:type",Object)],Ls.prototype,"iconType",void 0),Ls=$s=t([m],Ls);let Ns=class QuantumCircuitElement extends HTMLElement{constructor(){super(...arguments),this.json="",this.updateUrl=!1,this.minWireCount=1,this.maxWireCount=10,this.wireCount=1,this.minStepCount=1,this.interactive=!1,this.editing=!1,this.qubitCount=1,this.title="",this.breakpointStepIndex=0}get steps(){return Array.from(this.querySelectorAll("circuit-step"))}get breakpoint(){for(const t of this.steps)if(t.breakpoint)return t;return this.setBreakpoint(this.breakpointStepIndex),this.steps[this.breakpointStepIndex]}get activeStep(){for(const t of this.steps)if(t.active)return t;return null}get snappedStep(){for(const t of this.steps)if(t.snap)return t;return null}get serializedSteps(){const t=this.qubitCount;return this.steps.map((e=>e.serialize().slice(0,t)))}get emptySteps(){return this.steps.filter((t=>t.isEmpty))}get nonEmptySteps(){return this.steps.filter((t=>!t.isEmpty))}get largestStep(){let t=null,e=0;for(const i of this.steps)i.wireCount>0&&i.wireCount>e&&(t=i,e=i.wireCount);return t}get dropzones(){return Array.from(this.querySelectorAll("circuit-dropzone"))}get freeDropzones(){return this.dropzones.filter((t=>!t.occupied))}step(t){const e=this.steps[t];if(void 0===e)throw new Error(`step ${t} does not exist.`);return e}appendStep(){const t=new us,e=this.blocks.slice(-1)[0]||null;return null===e||e.finalized?this.append(t):e.append(t),t}i(){return this.appendStep().keep=!0,this.resize(),this}h(...t){return this.applyOperation(new ms,...t),this.resize(),this}x(...t){return this.applyOperation(new Os,...t),this.resize(),this}y(...t){return this.applyOperation(new Ps,...t),this.resize(),this}z(...t){return this.applyOperation(new Ls,...t),this.resize(),this}phase(t,...e){return this.applyOperation(vs.create({phi:t.toString()}),...e),this.resize(),this}rnot(...t){return this.applyOperation(new ys,...t),this.resize(),this}rx(t,...e){return this.applyOperation(Es.create({theta:t.toString()}),...e),this.resize(),this}ry(t,...e){return this.applyOperation(zs.create({theta:t.toString()}),...e),this.resize(),this}rz(t,...e){return this.applyOperation(Cs.create({theta:t.toString()}),...e),this.resize(),this}control(...t){return this.applyOperation(new fs,...t),this.resize(),this}cnot(t,e){this.validateQubits(t,e);const i=this.appendStep(),o=Math.max(t,e)+1;for(let t=0;t<o;t++)i.appendDropzone();return i.dropzones[t].assign(new fs),i.dropzones[e].assign(new Os),this.resize(),this}ccnot(t,e,i){this.validateQubits(t,e,i);const o=this.appendStep(),n=Math.max(t,e,i)+1;for(let t=0;t<n;t++)o.appendDropzone();return o.dropzones[t].assign(new fs),o.dropzones[e].assign(new fs),o.dropzones[i].assign(new Os),this.resize(),this}swap(t,e){return this.applyOperation(new As,t,e),this.resize(),this}bloch(...t){return this.applyOperation(new ds,...t),this.resize(),this}write(t,...e){return this.applyOperation(Ds.create(t),...e),this.resize(),this}measure(...t){return this.applyOperation(new as,...t),this.resize(),this}block(t,e){const i=new ps;return i.comment=t,i.setAttribute("data-targets","quantum-circuit.blocks"),this.append(i),e(this),i.finalize(),this}connectedCallback(){this.attachShadow({mode:"open"}),this.update(),this.loadFromJson(),this.updateAllSteps(),this.updateNqubit(),this.addEventListener("dragAndDroppable.ungrab",(()=>{this.editing=!1})),this.addEventListener("dragAndDroppable.ungrab",this.resize),this.addEventListener("dragAndDroppable.ungrab",this.enableDraggablesHover),this.addEventListener("dragAndDroppable.ungrab",this.dispatchStepMouseenterEvent),this.addEventListener("dragAndDroppable.enddragging",(()=>{this.editing=!1})),this.addEventListener("dragAndDroppable.enddragging",this.resize),this.addEventListener("dragAndDroppable.enddragging",this.enableDraggablesHover),this.addEventListener("dragAndDroppable.enddragging",this.dispatchStepMouseenterEvent),this.addEventListener("dragAndDroppable.trash",(()=>{this.editing=!1})),this.addEventListener("step.snap",this.snapStep),this.addEventListener("step.snap",this.updateStepConnections),this.addEventListener("step.snap",this.updateWires),this.addEventListener("step.snap",this.updateNqubit),this.addEventListener("step.unsnap",this.unsnapStep),this.addEventListener("step.unsnap",this.updateStepConnections),this.addEventListener("step.unsnap",this.updateWires),this.addEventListener("step.unsnap",this.updateNqubit),this.addEventListener("mouseleave",this.dispatchCircuitMouseLeaveEvent),this.dispatchEvent(new Event("circuit.load",{bubbles:!0}))}updateNqubit(){const t=this.steps;if(0===t.length)return this.qubitCount=1,void(this.wireCount=this.minWireCount);const e=Math.max(...t.map((t=>t.nqubit)));if(0===e)return this.qubitCount=1,void(this.wireCount=this.minWireCount);this.qubitCount=e,e>this.minWireCount?this.wireCount=e:this.wireCount=this.minWireCount}dispatchStepMouseenterEvent(t){const e=t.detail.x,i=t.detail.y,o=document.elementFromPoint(e,i),n=null==o?void 0:o.closest("circuit-step");null==n||n.dispatchStepMouseenterEvent()}dispatchCircuitMouseLeaveEvent(){for(const t of this.steps)t.active=!1;this.dispatchEvent(new Event("circuit.mouseleave",{bubbles:!0}))}setBreakpoint(t){const e=this.steps[t];this.breakpointStepIndex=t;for(const t of this.steps)t.breakpoint=!1;e.breakpoint=!0}snapStep(t){if(!this.interactive)return;const e=t.detail.step;for(const t of this.steps)this.editing&&(t.active=!1),t.snap=!1;this.editing&&(e.active=!0),e.snap=!0}unsnapStep(t){if(!this.interactive)return;const e=t.detail.step;this.editing&&(e.active=!1),e.snap=!1}update(){Ni(Li`<style>
          #body {
            display: flex;
            flex-direction: column;
            align-items: center;
