...
>
  ...
  ></line>
        ...
        <div data-action="dragAndDroppable.grab:palette-dropzone#newOperation">
          <slot></slot>
        </div>`,this.shadowRoot)}newOperation(t){const e=t.target,i=e.cloneNode(!0);e.disableHelp(),i.removeAttribute("data-grabbed"),this.prepend(i)}removeOperation(t){const e=t.detail.element;O.notNull(e),this.removeChild(e),t.stopPropagation()}};Xr=t([m],Xr);const Yr=Li`<style>
  ...
  @media (min-width: 768px) {
    ...
    `}};var gs;t([h,e("design:type",Object)],fs.prototype,"iconType",void 0),fs=hs=t([m],fs);let ms=gs=class HGateElement extends(ri(Kr(si(rs(os(es(Ii(ts(Zr(Hr(is(HTMLElement)))))))))))){constructor(){super(...arguments),this.iconType="square"}static create({dragAndDrop:t=!1,ifVar:e=""}={}){const i=new gs;return i.dragAndDrop=t,i.if=e,i}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initDragAndDrop(),this.addEventListener("mouseenter",this.showHelp),this.addEventListener("mousedown",this.showRightClickPopup))}update(){Ni(Li`${this.sizeableStyle} ${this.wiresStyle} ${this.iconStyle}
    ...
    </svg>`}};var bs;t([h,e("design:type",Object)],ms.prototype,"iconType",void 0),ms=gs=t([m],ms);let vs=bs=class PhaseGateElement extends(ri(Kr(ns(si(rs(os(es(Ii(ts(Zr(Hr(is(HTMLElement))))))))))))){constructor(){super(...arguments),this.iconType="circle",this.phi=""}static create({phi:t="π/2",dragAndDrop:e=!1}={}){const i=new bs;return i.phi=t,i.dragAndDrop=e,i}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initDragAndDrop(),this.addEventListener("mouseenter",this.showHelp),this.addEventListener("mousedown",this.showRightClickPopup))}update(){Ni(Li`${this.sizeableStyle} ${this.wiresStyle} ${this.iconStyle}
    ...
    </svg>`}};var ws;t([h,e("design:type",Object)],vs.prototype,"iconType",void 0),t([h,e("design:type",Object)],vs.prototype,"phi",void 0),vs=bs=t([m],vs);let ys=ws=class RnotGateElement extends(ri(Kr(si(rs(os(es(Ii(ts(Zr(Hr(is(HTMLElement)))))))))))){constructor(){super(...arguments),this.iconType="square"}static create({dragAndDrop:t=!1,ifVar:e=""}={}){const i=new ws;return i.dragAndDrop=t,i.if=e,i}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initDragAndDrop(),this.addEventListener("mouseenter",this.showHelp),this.addEventListener("mousedown",this.showRightClickPopup))}update(){Ni(Li`${this.sizeableStyle} ${this.wiresStyle} ${this.iconStyle}
        ${this.labelStyle} ${this.dragAndDroppableStyle} ${this.disabledStyle}
    ...
    >
    ...
    </svg>`}};var xs;t([h,e("design:type",Object)],ys.prototype,"iconType",void 0),ys=ws=t([m],ys);let Es=xs=class RxGateElement extends(ri(Kr(ns(si(rs(os(es(Ii(ts(Zr(Hr(is(HTMLElement))))))))))))){constructor(){super(...arguments),this.iconType="square",this.theta=""}static create({theta:t="π/2",dragAndDrop:e=!1}={}){const i=new xs;return i.theta=t,i.dragAndDrop=e,i}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initDragAndDrop(),this.addEventListener("mouseenter",this.showHelp),this.addEventListener("mousedown",this.showRightClickPopup))}update(){Ni(Li`${this.sizeableStyle} ${this.wiresStyle} ${this.iconStyle}
        ${this.dragAndDroppableStyle} ${this.disabledStyle} ${this.labelStyle}
      ...
      <path
        ...
        stroke-linejoin="round"
      />
    </svg>`}};var Ss;t([h,e("design:type",Object)],Es.prototype,"iconType",void 0),t([h,e("design:type",Object)],Es.prototype,"theta",void 0),Es=xs=t([m],Es);let zs=Ss=class RyGateElement extends(ri(Kr(ns(si(rs(os(es(Ii(ts(Zr(Hr(is(HTMLElement))))))))))))){constructor(){super(...arguments),this.iconType="square",this.theta=""}static create({theta:t="π/2",dragAndDrop:e=!1}={}){const i=new Ss;return i.theta=t,i.dragAndDrop=e,i}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initDragAndDrop(),this.addEventListener("mouseenter",this.showHelp),this.addEventListener("mousedown",this.showRightClickPopup))}update(){Ni(Li`${this.sizeableStyle} ${this.wiresStyle} ${this.iconStyle}
        ${this.dragAndDroppableStyle} ${this.disabledStyle} ${this.labelStyle}
      ...
      <path
        ...
        stroke-linejoin="round"
      />
    </svg>`}};var Cs;t([h,e("design:type",Object)],zs.prototype,"iconType",void 0),t([h,e("design:type",Object)],zs.prototype,"theta",void 0),zs=Ss=t([m],zs);let qs=Cs=class RzGateElement extends(ri(Kr(ns(si(rs(os(es(Ii(ts(Zr(Hr(is(HTMLElement))))))))))))){constructor(){super(...arguments),this.iconType="square",this.theta=""}static create({theta:t="π/2",dragAndDrop:e=!1}={}){const i=new Cs;return i.theta=t,i.dragAndDrop=e,i}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initDragAndDrop(),this.addEventListener("mouseenter",this.showHelp),this.addEventListener("mousedown",this.showRightClickPopup))}update(){Ni(Li`${this.sizeableStyle} ${this.wiresStyle} ${this.iconStyle}
        ${this.dragAndDroppableStyle} ${this.disabledStyle} ${this.labelStyle}
      ...
      <path
        ...
        stroke-linejoin="round"
      />
    </svg>`}};var As;t([h,e("design:type",Object)],qs.prototype,"iconType",void 0),t([h,e("design:type",Object)],qs.prototype,"theta",void 0),qs=Cs=t([m],qs);let _s=As=class SwapGateElement extends(Kr(ns(si(rs(Ii(ts(Zr(Hr(is(HTMLElement)))))))))){constructor(){super(...arguments),this.iconType="transparent"}static create({dragAndDrop:t=!1}={}){const e=new As;return e.dragAndDrop=t,e}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initDragAndDrop())}update(){Ni(Li`${this.sizeableStyle} ${this.wiresStyle} ${this.iconStyle}
        ${this.dragAndDroppableStyle}
    ...
    </svg>`}};var Os;t([h,e("design:type",Object)],Ds.prototype,"iconType",void 0),t([h,e("design:type",Object)],Ds.prototype,"value",void 0),Ds=Ms=t([m],Ds);let ks=Os=class XGateElement extends(ri(Kr(si(rs(os(es(Ii(ts(Zr(Hr(is(HTMLElement)))))))))))){constructor(){super(...arguments),this.iconType="circle"}static create({dragAndDrop:t=!1,ifVar:e=""}={}){const i=new Os;return i.dragAndDrop=t,i.if=e,i}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initDragAndDrop(),this.addEventListener("mouseenter",this.showHelp),this.addEventListener("mousedown",this.showRightClickPopup))}update(){Ni(Li`${this.sizeableStyle} ${this.wiresStyle} ${this.iconStyle}
        ${this.labelStyle} ${this.dragAndDroppableStyle} ${this.disabledStyle}
    ...
    </svg>`}};var Ts;t([h,e("design:type",Object)],ks.prototype,"iconType",void 0),ks=Os=t([m],ks);let Ps=Ts=class YGateElement extends(Kr(si(rs(os(es(Ii(ts(Zr(Hr(is(HTMLElement))))))))))){constructor(){super(...arguments),this.iconType="square"}static create({dragAndDrop:t=!1}={}){const e=new Ts;return e.dragAndDrop=t,e}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initDragAndDrop())}update(){Ni(Li`${this.sizeableStyle} ${this.wiresStyle} ${this.iconStyle}
        ${this.labelStyle} ${this.dragAndDroppableStyle} ${this.disabledStyle}
    ...
    </svg>`}};var $s;t([h,e("design:type",Object)],Ps.prototype,"iconType",void 0),Ps=Ts=t([m],Ps);let Ls=$s=class ZGateElement extends(Kr(si(rs(os(es(Ii(ts(Zr(Hr(is(HTMLElement))))))))))){constructor(){super(...arguments),this.iconType="square"}static create({dragAndDrop:t=!1}={}){const e=new $s;return e.dragAndDrop=t,e}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initDragAndDrop())}update(){Ni(Li`${this.sizeableStyle} ${this.wiresStyle} ${this.iconStyle}
        ${this.labelStyle} ${this.dragAndDroppableStyle} ${this.disabledStyle}
    ...
    >
      <path d="M17 13L31 13L17 35L31 35" />
        ...
        </div>`,this.shadowRoot)}applyOperation(t,...e){this.validateQubits(...e);const i=this.appendStep(),o=Math.max(...e)+1;for(let t=0;t<o;t++)i.appendDropzone();for(const o of e){const e=t.cloneNode();e instanceof vs&&(e.phi=t.phi),e instanceof Es&&(e.theta=t.theta),e instanceof zs&&(e.theta=t.theta),e instanceof qs&&(e.theta=t.theta),e instanceof Ds&&(e.value=t.value),i.dropzones[o].assign(e)}}validateQubits(...t){if(t.some((t=>t<0)))throw new Error("The index of the qubit must be greater than or equal to 0.")}loadFromJson(){let t,e=null;if(t=this.updateUrl?O.urlJson:this.json,""===t||"new"===t)return void(this.updateUrl&&this.resize());const i=JSON.parse(t);this.title=(i.title||"").trim();for(const t of i.cols){const i=this.appendStep();for(const o of t){switch(!0){case/^\|0>$/.test(o):i.appendOperation(Ds.create("0",{dragAndDrop:this.updateUrl}));break;case/^\|1>$/.test(o):i.appendOperation(Ds.create("1",{dragAndDrop:this.updateUrl}));break;case/^H$/.test(o):i.appendOperation(ms.create({dragAndDrop:this.updateUrl}));break;case/^H<(.+)$/.test(o):i.appendOperation(ms.create({dragAndDrop:this.updateUrl,ifVar:RegExp.$1.trim()}));break;case/^X$/.test(o):i.appendOperation(ks.create({dragAndDrop:this.updateUrl}));break;case/^X<(.+)$/.test(o):i.appendOperation(ks.create({dragAndDrop:this.updateUrl,ifVar:RegExp.$1.trim()}));break;case/^Y$/.test(o):i.appendOperation(Ps.create({dragAndDrop:this.updateUrl}));break;case/^Z$/.test(o):i.appendOperation(Ls.create({dragAndDrop:this.updateUrl}));break;case/^P$/.test(o):i.appendOperation(vs.create({dragAndDrop:this.updateUrl}));break;case/^P\((.+)\)$/.test(o):i.appendOperation(vs.create({phi:RegExp.$1.replace("_","/"),dragAndDrop:this.updateUrl}));break;case/^X\^½$/.test(o):{const t=new ys;t.dragAndDrop=this.updateUrl,i.appendOperation(t);break}case/^X\^½<(.+)$/.test(o):{const t=new ys;t.dragAndDrop=this.updateUrl,t.if=RegExp.$1.trim(),i.appendOperation(t);break}case/^Rx$/.test(o):i.appendOperation(Es.create({theta:"π/2",dragAndDrop:this.updateUrl}));break;case/^Rx\((.+)\)$/.test(o):i.appendOperation(Es.create({theta:RegExp.$1.replace("_","/"),dragAndDrop:this.updateUrl}));break;case/^Ry$/.test(o):i.appendOperation(zs.create({theta:"π/2",dragAndDrop:this.updateUrl}));break;case/^Ry\((.+)\)$/.test(o):i.appendOperation(zs.create({theta:RegExp.$1.replace("_","/"),dragAndDrop:this.updateUrl}));break;case/^Rz$/.test(o):i.appendOperation(qs.create({theta:"π/2",dragAndDrop:this.updateUrl}));break;case/^Rz\((.+)\)$/.test(o):i.appendOperation(qs.create({theta:RegExp.$1.replace("_","/"),dragAndDrop:this.updateUrl}));break;case/^Swap$/.test(o):i.appendOperation(_s.create({dragAndDrop:this.updateUrl}));break;case/^•$/.test(o):i.appendOperation(fs.create({dragAndDrop:this.updateUrl}));break;case/^Bloch$/.test(o):i.appendOperation(ds.create({dragAndDrop:this.updateUrl}));break;case/^Measure$/.test(o):i.appendOperation(as.create({dragAndDrop:this.updateUrl}));break;case/^Measure>(.+)$/.test(o):i.appendOperation(as.create({dragAndDrop:this.updateUrl,flag:RegExp.$1.trim()}));break;case/^[[{](.+)$/.test(o):{const t=RegExp.$1;i.remove(),e=new ps,e.comment=t,e.setAttribute("data-targets","quantum-circuit.blocks"),this.append(e);break}case/^[\]}]$/.test(o):i.remove(),e.finalize();break;default:if(1!==o)throw new Error(`Unknown instruction: ${o}`);0===i.qubitCount?i.keep=!0:i.keep=!1,i.appendDropzone()}i.updateConnections()}}this.resize()}updateStepConnections(t){t.detail.step.updateConnections()}updateWires(t){const e=t.detail.dropzone.index();O.notNull(e);let i=!1;for(const t of this.steps){const o=t.dropzones[e];O.notNull(o),o.inputWireQuantum=i,"write-gate"===o.draggableTagName?(o.inputWireQuantum=i,o.outputWireQuantum=!0,i=!0):"measurement-gate"===o.draggableTagName?(o.inputWireQuantum=i,o.outputWireQuantum=!1,i=!1):(o.inputWireQuantum=i,o.outputWireQuantum=i)}}updateAllSteps(){for(const t of this.steps)t.updateWires(),t.updateConnections()}prepareDraggableDrop(){this.interactive=!0,this.editing=!0,this.disableDraggablesOnCircuitHover(),this.appendWire()}disableDraggablesOnCircuitHover(){for(const t of this.draggablesOnCircuit)t.hoverable=!1}enableDraggablesHover(){for(const t of this.draggables)t.hoverable=!0}get draggables(){return Array.from(this.querySelectorAll("[data-drag-and-drop]"))}get draggablesOnCircuit(){return Array.from(this.querySelectorAll("[data-drag-and-drop]:not([data-grabbed])"))}appendWire(){if(!(this.qubitCount>=this.maxWireCount)){this.wireCount+=1;for(const t of this.steps)t.appendDropzone()}}appendCircuitStepAfter(t){const e=new us;e.shadow=!0;for(let t=0;t<this.wireCount;t++)e.appendDropzone();if(-1===t)this.prepend(e);else{const i=this.steps[t],o=i.parentElement;O.notNull(o),o.insertBefore(e,i.nextSibling)}return e}resize(){this.removeEmptySteps(),this.appendMinimumSteps(),this.removeLastEmptyWires()}removeEmptySteps(){for(const t of this.emptySteps)t.remove();for(const t of this.steps)t.shadow=!1}appendMinimumSteps(){const t=this.minStepCount-this.steps.length;for(let e=0;e<t;e++)this.appendStep();const e=this.largestStep&&this.largestStep.wireCount>this.minWireCount?this.largestStep.wireCount:this.minWireCount;for(const t of this.steps){const i=e-t.wireCount;for(let e=0;e<i;e++)t.appendDropzone()}}removeLastEmptyWires(){for(;this.steps.every((t=>t.wireCount>this.minWireCount&&!t.lastDropzone.occupied));)for(const t of this.steps)t.lastDropzone.remove();const t=this.steps[0];O.notNull(t),this.wireCount=t.wireCount}clear(){O.updateUrlJson('{"cols":[]}'),location.reload()}toJson(){let t=!1;const e=[];for(const i of this.nonEmptySteps){if(i.isInBlock){if(!t){const o=i.block;e.push(`["[${o.comment}"]`),t=!0}}else t&&(e.push('["]"]'),t=!1);e.push(i.toJson())}return t&&e.push('["]"]'),""!==this.title?`{"cols":[${e.join(",")}],"title":"${this.title}"}`:`{"cols":[${e.join(",")}]}`}};t([h,e("design:type",Object)],Ns.prototype,"json",void 0),t([h,e("design:type",Object)],Ns.prototype,"updateUrl",void 0),t([h,e("design:type",Object)],Ns.prototype,"minWireCount",void 0),t([h,e("design:type",Object)],Ns.prototype,"maxWireCount",void 0),t([h,e("design:type",Object)],Ns.prototype,"wireCount",void 0),t([h,e("design:type",Object)],Ns.prototype,"minStepCount",void 0),t([h,e("design:type",Object)],Ns.prototype,"interactive",void 0),t([h,e("design:type",Object)],Ns.prototype,"editing",void 0),t([h,e("design:type",Object)],Ns.prototype,"qubitCount",void 0),t([h,e("design:type",Object)],Ns.prototype,"title",void 0),t([d,e("design:type",HTMLSlotElement)],Ns.prototype,"slotEl",void 0),t([p,e("design:type",Array)],Ns.prototype,"blocks",void 0),Ns=t([m],Ns);let Is=class CircleNotationElement extends HTMLElement{constructor(){super(...arguments),this.qubitCount=1,this.size="",this.magnitudes="1.0",this.phases="",this.multiQubits=!1,this.showKets=!1}setAmplitudes(t){const e=this.qubitCircles;for(const[i,o]of Object.entries(t)){const t=e[parseInt(i)];t.setAttribute("data-amplitude-real",o.real.toString()),t.setAttribute("data-amplitude-imag",o.imag.toString());const n=o.abs();if(this.setRoundedMagnitude(t,n),0===n)continue;const r=o.phase()/Math.PI*180;this.setRoundedPhase(t,r)}}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initQubitCirclePopup(this.qubitCircles),this.multiQubits&&(this.startQubitCircleVisibilityObserver(),this.dispatchLoadEvent()))}dispatchLoadEvent(){this.dispatchEvent(new Event("circle-notation.load",{bubbles:!0}))}attributeChangedCallback(t,e,i){null!==this.shadowRoot&&e!==i&&"data-qubit-count"===t&&this.dispatchVisibilityChangedEvent()}startQubitCircleVisibilityObserver(){const t=new IntersectionObserver((t=>{for(const e of t){const t=e.target;e.intersectionRatio>=.2?(t.setAttribute("data-targets","circle-notation.qubitCircleGroups circle-notation.visibleQubitCircleGroups"),this.dispatchVisibilityChangedEvent()):0===e.intersectionRatio&&t.setAttribute("data-targets","circle-notation.qubitCircleGroups")}}),{root:this,threshold:[0,.2]});for(const e of this.qubitCircleGroups)t.observe(e)}dispatchVisibilityChangedEvent(){this.dispatchEvent(new CustomEvent("circle-notation.visibilityChanged",{detail:this.visibleQubitCircleKets,bubbles:!0}))}get visibleQubitCircleKets(){const t=Math.pow(2,this.qubitCount);return this.visibleQubitCircles.map((t=>parseInt(t.getAttribute("data-ket")))).filter((e=>e<t))}get visibleQubitCircles(){const t=this.visibleQubitCircleGroups.map((t=>Array.from(t.querySelectorAll(".qubit-circle"))));return[].concat(...t)}update(){Ni(Li`<style>
          @media (min-width: 768px) {
