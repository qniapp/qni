...
>
  ...
  ></line>
        ...
        <div data-action="dragAndDroppable.grab:palette-dropzone#newOperation">
          <slot></slot>
        </div>`,this.shadowRoot)}newOperation(t){const e=t.target,n=e.cloneNode(!0);e.disableHelp(),n.removeAttribute("data-grabbed"),this.prepend(n)}};Qr=t([m],Qr);const Kr=Rn`<style>
  ...
  @media (min-width: 768px) {
    ...
    :host([data-drag-and-drop][data-grabbed]) #body::after {
      ...
      >
        ...
        <line
          ...
          vector-effect="non-scaling-stroke"
        ></line>
      </svg>`}}return t([h,e("design:type",Object)],i.prototype,"wireTop",void 0),t([h,e("design:type",Object)],i.prototype,"wireTopDisabled",void 0),t([h,e("design:type",Object)],i.prototype,"wireBottom",void 0),t([h,e("design:type",Object)],i.prototype,"wireBottomDisabled",void 0),i}var ca;let la=ca=class MeasurementGateElement extends(an(ta(na(ea(ra(Vr(oa(HTMLElement)))))))){constructor(){super(...arguments),this.iconType="transparent",this.value=0,this.flag=""}static create({dragAndDrop:t=!1,flag:e=""}={}){const n=new ca;return n.dragAndDrop=t,n.flag=e,n}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initDragAndDrop(),this.addEventListener("mouseenter",this.showHelp),this.addEventListener("mousedown",this.showRightClickPopup))}update(){$n(Rn`${this.sizeableStyle} ${this.iconStyle} ${this.dragAndDroppableStyle}
        ${this.labelStyle}
    ...
    >
    ...
    </svg>`}};var Sa;t([h,e("design:type",Object)],Ea.prototype,"iconType",void 0),Ea=xa=t([m],Ea);let _a=Sa=class RxGateElement extends(an(ta(aa(sn(sa(ra(ia(Ln(na(ea(Vr(oa(HTMLElement))))))))))))){constructor(){super(...arguments),this.iconType="square",this.theta=""}static create({theta:t="π/2",dragAndDrop:e=!1}={}){const n=new Sa;return n.theta=t,n.dragAndDrop=e,n}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initDragAndDrop(),this.addEventListener("mouseenter",this.showHelp),this.addEventListener("mousedown",this.showRightClickPopup))}update(){$n(Rn`${this.sizeableStyle} ${this.wiresStyle} ${this.iconStyle}
        ${this.dragAndDroppableStyle} ${this.disabledStyle} ${this.labelStyle}
      ...
      <path
        ...
        stroke-linejoin="round"
      />
    </svg>`}};var Oa;t([h,e("design:type",Object)],_a.prototype,"iconType",void 0),t([h,e("design:type",Object)],_a.prototype,"theta",void 0),_a=Sa=t([m],_a);let Ma=Oa=class RyGateElement extends(an(ta(aa(sn(sa(ra(ia(Ln(na(ea(Vr(oa(HTMLElement))))))))))))){constructor(){super(...arguments),this.iconType="square",this.theta=""}static create({theta:t="π/2",dragAndDrop:e=!1}={}){const n=new Oa;return n.theta=t,n.dragAndDrop=e,n}connectedCallback(){null===this.shadowRoot&&(this.attachShadow({mode:"open"}),this.update(),this.initDragAndDrop(),this.addEventListener("mouseenter",this.showHelp),this.addEventListener("mousedown",this.showRightClickPopup))}update(){$n(Rn`${this.sizeableStyle} ${this.wiresStyle} ${this.iconStyle}
        ${this.dragAndDroppableStyle} ${this.disabledStyle} ${this.labelStyle}
      ...
      />
        ...
        <div id="body" data-action="mouseenter:swap-gate#showHelp">
          ${this.wiresSvg} ${this.iconSvg}
        </div>`,this.shadowRoot)}toJson(){return'"Swap"'}serialize(){const t=this.targets;if(2!==t.length&&0!==t.length)throw new Error(`Invalid swap targets: ${this.targets.toString()}`);return{type:Ke,controls:this.controls,targets:t}}get iconSvg(){return Rn`<svg
      id="icon"
      fill="none"
      stroke-linecap="round"
      stroke-linejoin="round"
