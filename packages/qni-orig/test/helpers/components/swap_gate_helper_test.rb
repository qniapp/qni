...
class Components::ControlGateHelperTest < ActionView::TestCase
  ...
  test 'swap_gate' do
    assert_dom_equal beautify(<<~ERB), beautify(swap_gate(bit: 0, targets: [0, 1]))
      <div class="gate swap-gate draggable draggable--circuit connectable--upper-bit" data-targets="0,1" data-action="mouseenter->gate-description#initPopup:passive mousedown->editor#grabDraggableOld:passive mouseup->editor#releaseDraggable:passive click->editor#ignoreDraggableClick:passive">
