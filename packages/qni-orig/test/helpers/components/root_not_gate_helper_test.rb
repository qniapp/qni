...
class Components::RootNotGateHelperTest < ActionView::TestCase
  ...
  test 'root_not_gate if:' do
    assert_dom_equal beautify(<<~ERB), beautify(root_not_gate(if: 'alice_h'))
      <div class="draggable draggable--circuit gate gate--ifable root-not-gate"
           data-if="alice_h"
  ...
  test 'root_not_gate disabled: true' do
  ...
  test 'root_not_gate bit: 1, controls: [0]' do
    assert_dom_equal beautify(<<~ERB), beautify(root_not_gate(bit: 1, controls: [0]))
  ...
  test 'root_not_gate bit: 0, controls: [1]' do
    assert_dom_equal beautify(<<~ERB), beautify(root_not_gate(bit: 0, controls: [1]))
  ...
  test 'root_not_gate bit: 0, controls: [2,1,3]' do
    assert_dom_equal beautify(<<~ERB), beautify(root_not_gate(bit: 0, controls: [2, 1, 3]))
      <div class="connectable--upper-bit draggable draggable--circuit gate gate--ifable root-not-gate"
           data-controls="1,2,3"
           data-gate-popup-type="if"
           data-action="mouseenter->gate-description#initPopup:passive mousedown->editor#grabDraggable:passive mouseup->editor#releaseDraggable:passive click->editor#ignoreDraggableClick:passive">
  ...
  test 'root_not_gate bit: 3, controls: [1,2], targets: [4]' do
    assert_dom_equal beautify(<<~ERB), beautify(root_not_gate(bit: 3, controls: [1, 2], targets: [4]))
  ...
  test 'root_not_gate palette: true' do
  ...
  test 'root_not_gate bit: -1' do
    assert_raises ActiveModel::ValidationError do
      root_not_gate(bit: -1)
    end
  end

  test 'root_not_gate bit: 11' do
    assert_raises ActiveModel::ValidationError do
      root_not_gate(bit: 11)
    end
  end

  test 'root_not_gate bit: :foo' do
    assert_raises ActiveModel::ValidationError do
      root_not_gate(bit: :foo)
    end
  end

  test 'root_not_gate controls: -1' do
    assert_raises ActiveModel::ValidationError do
      root_not_gate(controls: -1)
    end
  end

  test 'root_not_gate controls: :foo' do
    assert_raises ActiveModel::ValidationError do
      root_not_gate(controls: :foo)
    end
  end
  ...
  test 'root_not_gate controls: 11' do
    assert_raises ActiveModel::ValidationError do
      root_not_gate(controls: 11)
    end
  end
  ...
  test 'root_not_gate targets: -1' do
    assert_raises ActiveModel::ValidationError do
      root_not_gate(targets: -1)
    end
  end

  test 'root_not_gate targets: :foo' do
    assert_raises ActiveModel::ValidationError do
      root_not_gate(targets: :foo)
    end
  end
  ...
  test 'root_not_gate targets: 11' do
    assert_raises ActiveModel::ValidationError do
      root_not_gate(targets: 11)
    end
  end
