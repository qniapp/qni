...
describe('RX', () => {
  ...
  test('isHermitian', () => {
    ...
    expect(RX('2π').isHermitian(0.01)).toBeTruthy()
    expect(RX('5π/2').isHermitian(0.01)).toBeFalsy()
    expect(RX('3π').isHermitian(0.01)).toBeFalsy()
    expect(RX('7π/2').isHermitian(0.01)).toBeFalsy()
  })
})
