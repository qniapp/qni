...
var Ei = /* @__PURE__ */ __name(class extends HTMLElement {
  ...
  releaseResizeHandle(e) {
    ...
    if (!We(t))
      throw new Error(`${t} must be an Operation.`);
    this.circuitEditorService.send({ type: "RELEASE_RELEASE_HANDLE", operation: t });
  }
