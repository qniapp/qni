...
var require_fraction = __commonJS({
  "../node_modules/fraction.js/fraction.js"(exports, module) {
    (function(root) {
      ...
      function modpow(b3, e, m2) {
        var r = 1;
        for (; e > 0; b3 = b3 * b3 % m2, e >>= 1) {
          if (e & 1) {
            r = r * b3 % m2;
          }
        }
...
var require_interact_min = __commonJS({
  "../node_modules/interactjs/dist/interact.min.js"(exports, module) {
    !function(t) {
      ...
      __name(L3, "L");
      function U2(t2, e2) {
        return e2 = e2 || { x: 0, y: 0 }, b3.default.isOperaMobile && W2(t2) ? (L3("screen", t2, e2), e2.x += window.scrollX, e2.y += window.scrollY) : L3("page", t2, e2), e2;
      }
      __name(U2, "U");
      function V2(t2, e2) {
        return e2 = e2 || {}, b3.default.isOperaMobile && W2(t2) ? L3("screen", t2, e2) : L3("client", t2, e2), e2;
      }
      __name(V2, "V");
      function N3(t2) {
        var e2 = [];
      ...
      var St = { id: "actions/resize", before: ["actions/drag"], install: function(t2) {
        ...
        if (o3) {
          var s3 = (0, j2.default)({}, e2.coords.cur.page), l4 = n2.options.resize;
      ...
      __name(Ft2, "Ft");
      var Xt2 = { id: "auto-scroll", install: function(t2) {
      ...
      var _e2 = function() {
        ...
        return e2 = t2, (n2 = [{ key: "start", value: function(t3, e3) {
          ...
          for (var i2 = r2 ? this.states.slice(r2) : this.states, a2 = Pe(t3.coords, t3.rect), s3 = 0; s3 < i2.length; s3++) {
            var l4, u3 = i2[s3], c3 = u3.options, f3 = (0, j2.default)({}, t3.coords), d3 = null;
      ...
      Se2.default = Te3;
      var Me2 = {};
      Object.defineProperty(Me2, "__esModule", { value: true }), Me2.defaults = void 0, Me2.defaults = { base: { preventDefault: "auto", deltaSource: "page" }, perAction: { enabled: false, origin: { x: 0, y: 0 } }, actions: {} };
      var je = {};
      function ke(t2) {
      ...
      __name(Qe, "Qe");
      Object.defineProperty(Ge3, "__esModule", { value: true }), Ge3.addTotal = He2, Ge3.applyPending = Ze, Ge3.default = void 0, Le._ProxyMethods.offsetBy = "";
      ...
      var xn = function() {
        ...
        return n2 = t2, (r2 = [{ key: "_defaults", get: function() {
          ...
          for (var r3 in e2) {
            ...
            o3 === "listeners" && this.updatePerActionListeners(t3, a2.listeners, s3), i.default.array(s3) ? a2[o3] = Z2.from(s3) : i.default.plainObject(s3) ? (a2[o3] = (0, j2.default)(a2[o3] || {}, (0, ge2.default)(s3)), i.default.object(n3.perAction[o3]) && "enabled" in n3.perAction[o3] && (a2[o3].enabled = s3.enabled !== false)) : i.default.bool(s3) && i.default.object(n3.perAction[o3]) ? a2[o3].enabled = s3 : a2[o3] = s3;
          }
        } }, { key: "getRect", value: function(t3) {
            ...
            for (a3 = f3.length - 1; a3 >= 0; a3--) {
              ...
              if (p3.selector === t3 && p3.context === e3) {
                for (var v4 = p3.listeners, h3 = v4.length - 1; h3 >= 0; h3--) {
                  var g3 = Mn(v4[h3], 2), y3 = g3[0], m3 = g3[1], b4 = m3.capture, x3 = m3.passive;
                  if (y3 === o4 && b4 === s4.capture && x3 === s4.passive) {
            ...
            for (var u4 = 0; u4 < a3.length; u4++) {
              ...
              if (_2.matchesSelector(l5, f3) && _2.nodeContains(d3, s4) && _2.nodeContains(d3, l5)) {
                ...
                for (var v4 = 0; v4 < p3.length; v4++) {
                  var h3 = Mn(p3[v4], 2), g3 = h3[0], y3 = h3[1], m3 = y3.capture, b4 = y3.passive;
                  m3 === n3.capture && b4 === n3.passive && g3(o4);
                }
              }
            }
            l5 = _2.parentNode(l5);
      ...
      function $n(t2, e2) {
        return function(n2) {
          ...
          for (var y3 = 0; y3 < l4.length; y3++) {
            var m3 = Yn(l4[y3], 4), x3 = m3[0], w2 = m3[1], _3 = m3[2];
            m3[3][t2](x3, n2, w2, _3);
          }
        };
      }
      ...
      var sr = function() {
        function t2() {
          var e2 = this;
          rr(this, t2), ar(this, "id", "__interact_scope_".concat(Math.floor(100 * Math.random()))), ar(this, "isInitialized", false), ar(this, "listenerMaps", []), ar(this, "browser", b3.default), ar(this, "defaults", (0, ge2.default)(Me2.defaults)), ar(this, "Eventable", cn.Eventable), ar(this, "actions", { map: {}, phases: { start: true, move: true, end: true }, methodDict: {}, phaselessTypes: {} }), ar(this, "interactStatic", (0, gn.createInteractStatic)(this)), ar(this, "InteractEvent", je.InteractEvent), ar(this, "Interactable", void 0), ar(this, "interactables", new wn.InteractableSet(this)), ar(this, "_win", void 0), ar(this, "document", void 0), ar(this, "window", void 0), ar(this, "documents", []), ar(this, "_plugins", { list: [], map: {} }), ar(this, "onWindowUnload", function(t3) {
      ...
      function lr(t2, n2) {
        return t2.isInitialized = true, i.default.window(n2) && e.init(n2), h2.default.init(n2), b3.default.init(n2), jt.default.init(n2), t2.window = n2, t2.document = n2.document, t2.usePlugin(Fn.default), t2.usePlugin(Sn.default), t2;
      }
      __name(lr, "lr");
      function ur(t2) {
      ...
      var Er = { start: function(t2) {
        ...
        return s3.changed && (i2(e2, Math.abs(l4.x) > Math.abs(l4.y), s3.coords, s3.rect), (0, j2.default)(r2, s3.coords)), s3.eventProps;
      ...
      var Cr = { start: function(t2) {
        var e2 = t2.rect, n2 = t2.startOffset, r2 = t2.state, o3 = t2.interaction, i2 = t2.pageCoords, a2 = r2.options, s3 = a2.elementRect, l4 = (0, j2.default)({ left: 0, top: 0, right: 0, bottom: 0 }, a2.offset || {});
        if (e2 && s3) {
      ...
      var Lr = { noInner: Yr, noOuter: Br, start: function(t2) {
        ...
        if (n2) {
          var s3 = (0, j2.default)({}, e2), l4 = (0, Rr.getRestrictionRect)(a2.inner, r2, s3) || {}, u3 = (0, Rr.getRestrictionRect)(a2.outer, r2, s3) || {};
      ...
      var eo2 = { start: function(t2) {
        ...
        var e2 = t2.interaction, n2 = t2.coords, r2 = t2.state, o3 = r2.options, a2 = r2.offsets, s3 = (0, A2.default)(e2.interactable, e2.element, e2.prepared.name), l4 = (0, j2.default)({}, n2), u3 = [];
        ...
        for (var m3 = { target: null, inRange: false, distance: 0, range: 0, delta: { x: 0, y: 0 } }, b4 = 0; b4 < u3.length; b4++) {
          var x3 = u3[b4], w2 = x3.range, _3 = x3.x - l4.x, P3 = x3.y - l4.y, O4 = (0, C3.default)(_3, P3), S4 = O4 <= w2;
          w2 === 1 / 0 && m3.inRange && m3.range !== 1 / 0 && (S4 = false), m3.target && !(S4 ? m3.inRange && w2 !== 1 / 0 ? O4 / w2 < m3.distance / m3.range : w2 === 1 / 0 && m3.range !== 1 / 0 || O4 < m3.distance : !m3.inRange && O4 < m3.distance) || (m3.target = x3, m3.distance = O4, m3.range = w2, m3.inRange = S4, m3.delta.x = _3, m3.delta.y = P3);
        }
        return m3.inRange && (n2.x = m3.target.x, n2.y = m3.target.y), r2.closest = m3, m3;
      }, defaults: { range: 1 / 0, targets: null, offset: null, offsetWithOrigin: true, origin: null, relativePoints: null, endOnly: false, enabled: false } };
      to.snap = eo2;
      var no = (0, Se2.makeModifier)(eo2, "snap");
      to.default = no;
      var ro = {};
      function oo(t2, e2) {
        (e2 == null || e2 > t2.length) && (e2 = t2.length);
...
var it = l2((a) => typeof a == "object" && a !== null && typeof a.angle == "string" && typeof a.reducedAngle == "string", "isAngleable");
function J2(a) {
  class t extends a {
    constructor() {
      super(...arguments);
...
var nt = l2((a) => typeof a == "object" && a !== null && typeof a.controls == "object", "isControllable");
function S2(a) {
  class t extends a {
    set controls(i) {
...
var rt = l2((a) => typeof a == "object" && a !== null && typeof a.flag == "string", "isFlaggable");
function ee(a) {
  class t extends a {
    constructor() {
      super(...arguments);
...
`;
var V = /* @__PURE__ */ __name(class extends x(E(S2(v2(T(y(g(HTMLElement))))))) {
  get operationType() {
    return Ge;
  }
  connectedCallback() {
...
`;
var $ = /* @__PURE__ */ __name(class extends x(E(O2(S2(v2(T(y(g(HTMLElement)))))))) {
  get operationType() {
    return we;
  }
  connectedCallback() {
...
`;
var H2 = /* @__PURE__ */ __name(class extends x(E(v2(y(g(HTMLElement))))) {
  constructor() {
    super(...arguments);
    this.value = "";
  }
...
`;
var F2 = /* @__PURE__ */ __name(class extends x(E(O2(S2(v2(T(y(g(HTMLElement)))))))) {
  get operationType() {
    return he;
  }
  connectedCallback() {
...
l2(F2, "ZGateElement");
controller(F2);
var G2 = l2((a) => a instanceof k || a instanceof B || a instanceof U || a instanceof F2 || a instanceof q2 || a instanceof $ || a instanceof D2 || a instanceof N2 || a instanceof L2 || a instanceof P || a instanceof V || a instanceof M2 || a instanceof z || a instanceof H2 || a instanceof R2, "isOperation");
var we2 = l2((a) => a != null && a instanceof k, "isHGateElement");
var Te2 = l2((a) => a != null && a instanceof B, "isXGateElement");
var Se = l2((a) => a != null && a instanceof U, "isYGateElement");
var Ge2 = l2((a) => a != null && a instanceof F2, "isZGateElement");
var ht = l2((a) => a != null && a instanceof q2, "isPhaseGateElement");
var Oe = l2((a) => a != null && a instanceof $, "isTGateElement");
var Ie = l2((a) => a != null && a instanceof D2, "isRnotGateElement");
...
var A = /* @__PURE__ */ __name(class extends HTMLElement {
  ...
  set operation(t) {
    if (this.clear(), this.disableAllPanes(), X(t) && (this.conditionalGatePaneDisabled = false, this.ifInput.value = t.if), it(t)) {
      let e = Y(t.angle);
    ...
    rt(t) && (this.conditionalFlagPaneDisabled = false, this.flagInput.value = t.flag);
  }
  clear() {
  ...
  changeDenominator() {
    ...
    Me(t) && parseInt(t) > 1 ? (this.denominatorLabel.textContent = t, this.angleSlider.denominator = parseInt(t), this.angleInput.value = this.angleSlider.angle) : this.restoreOriginalDenominator();
  }
  changeReduceSetting() {
...
controller(A);
var Y2 = /* @__PURE__ */ __name(class extends HTMLElement {
  constructor() {
    super(...arguments);
    this.qubitCount = 1;
    this.size = "";
  ...
  setAmplitudes(t) {
    ...
    for (let [i, n] of Object.entries(t)) {
      ...
      if (this.setRoundedMagnitude(o2, p2), p2 === 0)
        continue;
      let c2 = r.phase() / Math.PI * 180;
      this.setRoundedPhase(o2, c2);
    }
  }
  connectedCallback() {
  ...
  stateVectorHtml(t) {
    let e = html``, i = this.qubitCircleGroup([...Array(2 ** t).keys()], (n) => this.qubitCircleGroup(n, (o2) => this.qubitCircleGroup(o2, (r) => this.qubitCircleGroup(r, (p2) => this.qubitCircleGroup(p2, (c2) => this.qubitCircleGroup(c2, (d2) => this.qubitCircleGroup(d2)))))), 256);
    for (let n of i)
      e = html`${e} ${n}`;
    return e;
  }
  qubitCircleGroup(t, e, i = t.length / 2) {
    return l2((o2, r = 1) => o2.reduce((p2, c2, d2) => d2 % r ? p2 : [...p2, o2.slice(d2, d2 + r)], []), "arrayChunk")(t, i).map((o2) => {
      let r = html``;
      if (e)
        for (let p2 of e(o2))
          r = html`${r} ${p2}`;
  ...
  setPopupContent(t) {
    if (this.popupEl === null)
      return;
    let e = t.target, i = this.ketDecimal(e), n = e.getAttribute("data-amplitude-real"), o2 = e.getAttribute("data-amplitude-imag"), r = e.getAttribute("data-magnitude"), p2 = e.getAttribute("data-phase"), c2;
    n === null || o2 === null ? c2 = b.ZERO : c2 = new b(parseFloat(n), parseFloat(o2));
    let d2;
    r && parseFloat(r) === 0 ? d2 = 0 : d2 = p2 ? parseFloat(p2) : 0, this.setQubitCirclePopupContent(this.popupEl.content, e, i, c2, r ? parseFloat(r) : 0, d2, this.qubitCount);
  }
  setQubitCirclePopupContent(t, e, i, n, o2, r, p2) {
    e._tippy.setContent(this.popupContent(t, i, n, o2, r, p2));
  }
  popupContent(t, e, i, n, o2, r) {
    let p2 = t.querySelector(".circle-notation-popup__ket-binary"), c2 = t.querySelector(".circle-notation-popup__ket-decimal"), d2 = t.querySelector(".circle-notation-popup__amplitude-real"), m2 = t.querySelector(".circle-notation-popup__amplitude-imag"), h2 = t.querySelector(".circle-notation-popup__probability"), u2 = t.querySelector(".circle-notation-popup__phase");
    p2 && (p2.textContent = e.toString(2).padStart(r, "0")), c2 && (c2.textContent = e.toString()), d2 && (d2.textContent = this.forceSigned(i.real, 5)), m2 && (m2.textContent = `${this.forceSigned(i.imag, 5)}i`), h2 && (h2.textContent = `${this.forceSigned(n * n * 100, 4)}%`), u2 && (u2.textContent = `${this.forceSigned(o2, 2)}\xB0`);
...
l2(Y2, "CircleNotationElement"), s([attr], Y2.prototype, "qubitCount", 2), s([attr], Y2.prototype, "size", 2), s([attr], Y2.prototype, "magnitudes", 2), s([attr], Y2.prototype, "phases", 2), s([attr], Y2.prototype, "multiQubits", 2), s([attr], Y2.prototype, "showKets", 2), s([targets], Y2.prototype, "qubitCircles", 2), s([targets], Y2.prototype, "qubitCircleGroups", 2), s([targets], Y2.prototype, "visibleQubitCircleGroups", 2);
controller(Y2);
...
var at = /* @__PURE__ */ __name(class extends HTMLElement {
  constructor() {
    ...
    this.runCircuitButtonMachine = createMachine({ id: "run-circuit-button", initial: "unknown", states: { unknown: { always: [{ target: "idle", cond: "isIdle" }, { target: "running", cond: "isRunning" }] }, idle: { on: { CLICK: { target: "running", actions: ["ripple", "setRunningTrue", "dispatchClickEvent"] } } }, running: { on: { FINISH: { target: "idle", actions: ["setRunningFalse"] } } } } }, { actions: { setRunningFalse: () => {
      ...
      i.id = "ripple";
      let n = Math.max(this.clientWidth, this.clientHeight), o2 = n / 2, r = this.getBoundingClientRect(), p2 = r.left + window.pageXOffset, c2 = r.top + window.pageYOffset;
      i.setAttribute("part", "ripple"), i.setAttribute("data-target", "run-circuit-button.ripple"), i.style.width = i.style.height = `${n}px`, i.style.left = `${e.clientX - (p2 + o2)}px`, i.style.top = `${e.clientY - (c2 + o2)}px`, this.body.appendChild(i);
    }, dispatchClickEvent: () => {
...
l2(at, "RunCircuitButtonElement"), s([attr], at.prototype, "running", 2), s([attr], at.prototype, "debug", 2), s([target], at.prototype, "body", 2), s([target], at.prototype, "ripple", 2);
controller(at);
...
`;
var Xt = l2((a) => a != null && a instanceof _, "isCircuitDropzoneElement");
...
var W = /* @__PURE__ */ __name(class extends HTMLElement {
  ...
  updatePhasePhaseConnections(t) {
    ...
    for (let i of this.freeDropzones) {
      let o2 = this.phaseGateDropzones.filter((c2) => c2.connectTop || c2.connectBottom).map((c2) => this.bit(c2)), r = Math.min(...o2), p2 = Math.max(...o2);
  ...
  updateControlledUConnections(t) {
    let e = this.controllableDropzones(t), i = this.controlGateDropzones, n = [...new Set(e.map((m2) => m2.operationName))], o2 = this.numControlGateDropzones(t, n), r = i.map((m2) => this.bit(m2)), p2 = o2 === null ? r : r.slice(0, o2), c2 = e.map((m2) => this.bit(m2)), d2 = p2.concat(c2);
    for (let [m2, h2] of Object.entries(i)) {
      let u2 = h2.operation;
      h2.connectBottom = d2.some((w) => this.bit(h2) < w), h2.connectTop = d2.some((w) => this.bit(h2) > w), o2 === null || o2 !== null && parseInt(m2) < o2 ? u2.enable() : (h2.connectTop = Math.max(...d2) > this.bit(h2), u2.disable());
    }
    for (let m2 of e) {
      if (!nt(m2.operation))
        throw new Error(`${m2.operation} isn't controllable.`);
      m2.operation.controls = this.controlBits(m2, r, t), m2.connectTop = d2.some((h2) => h2 < this.bit(m2)), m2.connectBottom = d2.some((h2) => h2 > this.bit(m2));
    }
  }
  updateFreeDropzoneConnections(t) {
    let e = this.controllableDropzones(t), i = this.controlGateDropzones.filter((c2) => Bt(c2.operation) && !c2.operation.disabled).map((c2) => this.bit(c2)), n = e.map((c2) => this.bit(c2)), o2 = i.concat(n), r = Math.min(...o2), p2 = Math.max(...o2);
    for (let c2 of this.freeDropzones)
      r < this.bit(c2) && this.bit(c2) < p2 && (c2.connectTop = true, c2.connectBottom = true);
  }
  controlBits(t, e, i) {
    let n = e;
      ...
      switch (e) {
        case k: {
          ...
          for (let [o2, r] of C2(n, (p2) => p2.if))
            for (let [p2, c2] of C2(r, (d2) => d2.controls.toString())) {
              let d2 = c2[0], m2 = d2.operationType, h2 = c2.map((w) => w.bit), u2 = { type: m2, targets: h2 };
              o2 !== "" && (u2.if = o2), p2 !== "" && (u2.controls = d2.controls), t.push(u2);
            }
          break;
        }
        case B: {
        ...
        case q2: {
          ...
          for (let [o2, r] of C2(n, (p2) => p2.angle))
            for (let [p2, c2] of C2(r, (d2) => d2.if))
              for (let [d2, m2] of C2(c2, (h2) => h2.controls.toString())) {
                let h2 = m2[0], u2 = h2.operationType, w = m2.map((et) => et.bit), I2 = { type: u2, targets: w };
                p2 !== "" && (I2.if = p2), o2 !== "" && (I2.angle = o2), d2 !== "" && (I2.controls = h2.controls), t.push(I2);
              }
          break;
        }
        case $: {
        ...
        case M2: {
          ...
          if (n.length < 2 || this.operations.some((r) => nt(r) && r.controls.length > 0))
            break;
        ...
        case R2: {
          ...
          for (let [o2, r] of C2(n, (p2) => p2.flag)) {
            let p2 = r.map((m2) => m2.bit), d2 = { type: r[0].operationType, targets: p2 };
            o2 !== "" && (d2.flag = o2), t.push(d2);
          }
          break;
        }
        default:
...
l2(W, "CircuitStepElement"), s([attr], W.prototype, "active", 2), s([attr], W.prototype, "breakpoint", 2), s([attr], W.prototype, "shadow", 2), s([attr], W.prototype, "debug", 2);
controller(W);
var b2 = /* @__PURE__ */ __name(class extends HTMLElement {
  constructor() {
    super(...arguments);
    this.minStepCount = 1;
    this.minWireCount = 1;
  ...
  swap(...t) {
    let e = this.applyOperationToTargets(() => new V(), ...t);
  ...
  controlledU(t, e, i) {
    let n = [].concat(e), o2 = [].concat(i), r = n.concat(o2), p2 = Math.max(...r) + 1, c2 = this.appendStepWithDropzones(p2);
    for (let d2 of n)
      c2.dropzoneAt(d2).put(new M2());
    for (let d2 of o2)
      c2.dropzoneAt(d2).put(new t());
    this.appendMinimumWires(), this.updateStepOperationAttributes(c2);
  }
  appendStep() {
    let t = new W();
  ...
  setSnapTargets(t) {
    ...
    for (let [o2, r] of Object.entries(this.dropzones)) {
      let p2 = r.snapTarget, c2 = this.isVertical ? p2.y : p2.x, d2 = this.isVertical ? p2.x : p2.y, m2 = parseInt(o2) % this.wireCount, h2 = c2 - t.snapRange * 0.75, u2 = c2 + t.snapRange * 0.75;
      parseInt(o2) < this.wireCount && (this.isVertical ? i.push({ x: d2, y: h2 }) : i.push({ x: h2, y: d2 }), this.snapTargets[h2] === void 0 && (this.snapTargets[h2] = {}), this.snapTargets[h2][d2] === void 0 && (this.snapTargets[h2][d2] = { dropzone: null, stepIndex: -1, wireIndex: m2 })), this.isVertical ? i.push({ x: d2, y: u2 }) : i.push({ x: u2, y: d2 }), this.snapTargets[u2] === void 0 && (this.snapTargets[u2] = {}), this.snapTargets[u2][d2] === void 0 && (this.snapTargets[u2][d2] = { dropzone: null, stepIndex: Math.floor(parseInt(o2) / this.wireCount), wireIndex: m2 }), (!r.occupied || r === n) && i.push(p2), this.snapTargets[c2] === void 0 && (this.snapTargets[c2] = {}), this.snapTargets[c2][d2] === void 0 && (this.snapTargets[c2][d2] = { dropzone: r, stepIndex: null, wireIndex: m2 });
    }
    t.snapTargets = i;
  }
  updateSnapTargets(t) {
    ...
    for (let [n, o2] of Object.entries(t)) {
      let r = o2.snapTarget, p2 = this.isVertical ? r.y : r.x, c2 = this.isVertical ? r.x : r.y;
      m.notNull(this.snapTargets[p2]), this.snapTargets[p2][c2] = { dropzone: o2, stepIndex: null, wireIndex: parseInt(n) };
    }
  }
  serialize() {
...
var tt = /* @__PURE__ */ __name(class extends HTMLElement {
    ...
    switch (e.type) {
      case "step": {
        ...
        for (let r in e.blochVectors) {
          let p2 = parseInt(r), c2 = o2.dropzoneAt(p2).operation;
          if (_e(c2)) {
            let d2 = e.blochVectors[p2];
            c2.x = d2[0], c2.y = d2[1], c2.z = d2[2];
          }
        }
        if (e.measuredBits) {
          let r = e.measuredBits;
          for (let p2 in r) {
            let c2 = parseInt(p2), d2 = o2.dropzoneAt(c2).operation;
            Ae2(d2) && (d2.value = r[c2].toString());
          }
        }
        ...
        if (i === e.step) {
          ...
          for (let p2 in e.amplitudes) {
            let c2 = e.amplitudes[p2];
            r[p2] = new b(c2[0], c2[1]);
          }
  ...
  run() {
    ...
    let i = Math.max(...e.map((r) => Math.max(...r.map((p2) => {
      let c2 = [];
      return nt(p2) && (c2 = p2.controls), Math.max(...p2.targets.concat(c2));
    })))), n = i >= 0 ? i + 1 : 1;
...
l2(tt, "QuantumSimulatorElement"), s([attr], tt.prototype, "backend", 2), s([attr], tt.prototype, "updateUrl", 2), s([target], tt.prototype, "circuit", 2), s([target], tt.prototype, "circleNotation", 2), s([targets], tt.prototype, "runCircuitButtons", 2);
controller(tt);
