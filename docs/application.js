    ...
    ;(function (root) {
      ...
      Fraction.prototype = {
        ...
        gcd: function (a, b2) {
          parse2(a, b2)
          return new Fraction(
            gcd(P2['n'], this['n']) * gcd(P2['d'], this['d']),
            P2['d'] * this['d']
          )
        },
        lcm: function (a, b2) {
        ...
        pow: function (a, b2) {
          ...
          if (P2['d'] === 1) {
            if (P2['s'] < 0) {
              return new Fraction(
                Math.pow(this['s'] * this['d'], P2['n']),
                Math.pow(this['n'], P2['n'])
              )
            } else {
              return new Fraction(
                Math.pow(this['s'] * this['n'], P2['n']),
                Math.pow(this['d'], P2['n'])
              )
            }
          }
  ...
  '../node_modules/interactjs/dist/interact.min.js'(exports, module) {
    !(function (t) {
      ...
      function o2(t2) {
        ...
        o3.ownerDocument !== t2.document &&
          typeof t2.wrap == 'function' &&
          t2.wrap(o3) === o3 &&
          (t2 = t2.wrap(t2)),
          (e.window = r = t2)
      }
      ...
      var s2 = /* @__PURE__ */ __name(function (t2) {
        ...
        l3 = /* @__PURE__ */ __name(function (t2) {
        ...
        u2 = {
          ...
          element: function (t2) {
            if (!t2 || a(t2) !== 'object') return false
            var n2 = e.getWindow(t2) || e.window
            return /object|function/.test(a(n2.Element))
              ? t2 instanceof n2.Element
              : t2.nodeType === 1 && typeof t2.nodeName == 'string'
          },
          plainObject: function (t2) {
            return s2(t2) && !!t2.constructor && /function Object\b/.test(t2.constructor.toString())
          },
          array: function (t2) {
            return s2(t2) && t2.length !== void 0 && l3(t2.splice)
          },
        }
      i.default = u2
      var c2 = {}
      function f2(t2) {
        ...
        if (e2.prepared.name === 'drag') {
          ...
          n2 === 'x'
            ? ((e2.coords.cur.page.y = e2.coords.start.page.y),
              (e2.coords.cur.client.y = e2.coords.start.client.y),
              (e2.coords.velocity.client.y = 0),
              (e2.coords.velocity.page.y = 0))
            : n2 === 'y' &&
              ((e2.coords.cur.page.x = e2.coords.start.page.x),
              (e2.coords.cur.client.x = e2.coords.start.client.x),
              (e2.coords.velocity.client.x = 0),
              (e2.coords.velocity.page.x = 0))
        }
      }
      __name(f2, 'f')
      function d2(t2) {
        ...
        if (n2.prepared.name === 'drag') {
          ...
          if (r2 === 'x' || r2 === 'y') {
            var o3 = r2 === 'x' ? 'y' : 'x'
            ;(e2.page[o3] = n2.coords.start.page[o3]),
              (e2.client[o3] = n2.coords.start.client[o3]),
              (e2.delta[o3] = 0)
          }
        }
      }
      ...
      var p2 = {
          ...
          install: function (t2) {
            var e2 = t2.actions,
              n2 = t2.Interactable,
              r2 = t2.defaults
            ;(n2.prototype.draggable = p2.draggable),
              (e2.map.drag = p2),
              (e2.methodDict.drag = 'draggable'),
              (r2.actions.drag = p2.defaults)
          },
          listeners: {
            'interactions:before-action-move': f2,
            'interactions:action-resume': f2,
            'interactions:action-move': d2,
            'auto-start:check': function (t2) {
              ...
              if (
                ...
                o3.enabled &&
                (!e2.pointerIsDown ||
                  !/mouse|pointer/.test(e2.pointerType) ||
                  (r2 & n2.options.drag.mouseButtons) != 0)
              )
                return (
                  (t2.action = {
                    name: 'drag',
                    axis: o3.lockAxis === 'start' ? o3.startAxis : o3.lockAxis,
                  }),
                  false
                )
            },
          ...
          draggable: function (t2) {
            return i.default.object(t2)
              ? ((this.options.drag.enabled = t2.enabled !== false),
                this.setPerAction('drag', t2),
                this.setOnEvents('drag', t2),
                /^(xy|x|y|start)$/.test(t2.lockAxis) && (this.options.drag.lockAxis = t2.lockAxis),
                /^(xy|x|y)$/.test(t2.startAxis) && (this.options.drag.startAxis = t2.startAxis),
                this)
              : i.default.bool(t2)
              ? ((this.options.drag.enabled = t2), this)
              : this.options.drag
          },
          beforeMove: f2,
          move: d2,
      ...
      var g2 = {
        init: function (t2) {
          var e2 = t2
          ;(g2.document = e2.document),
            (g2.DocumentFragment = e2.DocumentFragment || y2),
            (g2.SVGElement = e2.SVGElement || y2),
            (g2.SVGSVGElement = e2.SVGSVGElement || y2),
            (g2.SVGElementInstance = e2.SVGElementInstance || y2),
            (g2.Element = e2.Element || y2),
            (g2.HTMLElement = e2.HTMLElement || g2.Element),
            (g2.Event = e2.Event),
            (g2.Touch = e2.Touch || y2),
            (g2.PointerEvent = e2.PointerEvent || e2.MSPointerEvent)
        },
        document: null,
      ...
      var x2 = {
          init: function (t2) {
            var e2 = h2.default.Element,
              n2 = t2.navigator || {}
            ;(x2.supportsTouch =
              'ontouchstart' in t2 ||
              (i.default.func(t2.DocumentTouch) &&
                h2.default.document instanceof t2.DocumentTouch)),
              (x2.supportsPointerEvent = n2.pointerEnabled !== false && !!h2.default.PointerEvent),
              (x2.isIOS = /iP(hone|od|ad)/.test(n2.platform)),
              (x2.isIOS7 = /iP(hone|od|ad)/.test(n2.platform) && /OS 7[^\d]/.test(n2.appVersion)),
              (x2.isIe9 = /MSIE 9/.test(n2.userAgent)),
              (x2.isOperaMobile =
                n2.appName === 'Opera' && x2.supportsTouch && /Presto/.test(n2.userAgent)),
              (x2.prefixedMatchesSelector =
                'matches' in e2.prototype
                  ? 'matches'
                  : 'webkitMatchesSelector' in e2.prototype
                  ? 'webkitMatchesSelector'
                  : 'mozMatchesSelector' in e2.prototype
                  ? 'mozMatchesSelector'
                  : 'oMatchesSelector' in e2.prototype
                  ? 'oMatchesSelector'
                  : 'msMatchesSelector'),
              (x2.pEventTypes = x2.supportsPointerEvent
                ? h2.default.PointerEvent === t2.MSPointerEvent
                  ? {
                      up: 'MSPointerUp',
                      down: 'MSPointerDown',
                      over: 'mouseover',
                ...
                : null),
              (x2.wheelEvent =
                h2.default.document && 'onmousewheel' in h2.default.document
                  ? 'mousewheel'
                  : 'wheel')
          },
          supportsTouch: null,
      ...
      function O3(t2, n2) {
        return (
          e.window !== e.realWindow && (n2 = n2.replace(/\/deep\//g, ' ')),
          t2[b2.default.prefixedMatchesSelector](n2)
        )
      }
      __name(O3, 'O')
      Object.defineProperty(_2, '__esModule', { value: true }),
        ...
        (_2.closest = function (t2, e2) {
          for (; i.default.element(t2); ) {
            if (O3(t2, e2)) return t2
            t2 = P2(t2)
          }
          return null
        }),
        (_2.parentNode = P2),
        (_2.matchesSelector = O3),
        (_2.indexOfDeepestElement = function (t2) {
                ...
                if (s3 !== i2.ownerDocument)
                  if (l4 !== i2.ownerDocument)
                    if (s3 !== l4) {
                      ...
                      var u3 = void 0
                      if (
                        a2 instanceof h2.default.HTMLElement &&
                        i2 instanceof h2.default.SVGElement &&
                        !(i2 instanceof h2.default.SVGSVGElement)
                      ) {
                        if (i2 === l4) continue
                      ...
                      (v3 = i2),
                        ...
                        void 0,
                        void 0,
                        (parseInt(e.getWindow(v3).getComputedStyle(v3).zIndex, 10) || 0) >=
                          (parseInt(e.getWindow(g3).getComputedStyle(g3).zIndex, 10) || 0) &&
                          (n2 = o3)
                  else n2 = o3
              } else n2 = o3
          }
        ...
        (_2.matchesUpTo = function (t2, e2, n2) {
          for (; i.default.element(t2); ) {
            if (O3(t2, e2)) return true
            if ((t2 = P2(t2)) === n2) return O3(t2, e2)
          }
          return false
        }),
        ...
        (_2.getScrollXY = T2),
        (_2.getElementClientRect = M3),
        (_2.getElementRect = function (t2) {
          var n2 = M3(t2)
        ...
        (_2.getPath = function (t2) {
          for (var e2 = []; t2; ) e2.push(t2), (t2 = P2(t2))
          return e2
        }),
      ...
      function T2(t2) {
        return {
          x: (t2 = t2 || e.window).scrollX || t2.document.documentElement.scrollLeft,
          y: t2.scrollY || t2.document.documentElement.scrollTop,
        }
      }
      __name(T2, 'T')
      function M3(t2) {
        var e2 =
          t2 instanceof h2.default.SVGElement ? t2.getBoundingClientRect() : t2.getClientRects()[0]
        return (
          e2 && {
            left: e2.left,
            right: e2.right,
      ...
      Object.defineProperty(k2, '__esModule', { value: true }),
        (k2.getStringOptionResult = D3),
        (k2.resolveRectLike = function (t2, e2, n2, r2) {
          var o3,
            a2 = t2
          return (
            i.default.string(a2)
              ...
              : i.default.func(a2) &&
                (a2 = a2.apply(
                  void 0,
                  (function (t3) {
                    if (Array.isArray(t3)) return I2(t3)
                  })((o3 = r2)) ||
                    (function (t3) {
                    ...
                    (function (t3, e3) {
                      if (t3) {
                        if (typeof t3 == 'string') return I2(t3, e3)
            ...
            i.default.element(a2) && (a2 = (0, _2.getElementRect)(a2)),
            a2
          )
        }),
        ...
        (k2.xywhToTlbr = function (t2) {
          return (
            !t2 ||
              ('left' in t2 && 'top' in t2) ||
              (((t2 = (0, j2.default)({}, t2)).left = t2.x || 0),
              (t2.top = t2.y || 0),
              (t2.right = t2.right || t2.left + t2.width),
              (t2.bottom = t2.bottom || t2.top + t2.height)),
            t2
          )
        }),
        (k2.tlbrToXywh = function (t2) {
          return (
            !t2 ||
              ('x' in t2 && 'y' in t2) ||
              (((t2 = (0, j2.default)({}, t2)).x = t2.left || 0),
              (t2.y = t2.top || 0),
              (t2.width = t2.width || (t2.right || 0) - t2.x),
              (t2.height = t2.height || (t2.bottom || 0) - t2.y)),
            t2
          )
        }),
        (k2.addEdges = function (t2, e2, n2) {
          t2.left && (e2.left += n2.x),
            t2.right && (e2.right += n2.x),
            t2.top && (e2.top += n2.y),
            t2.bottom && (e2.bottom += n2.y),
            (e2.width = e2.right - e2.left),
            (e2.height = e2.bottom - e2.top)
        })
      var A3 = {}
      Object.defineProperty(A3, '__esModule', { value: true }),
        (A3.default = function (t2, e2, n2) {
          var r2 = t2.options[n2],
            o3 = (r2 && r2.origin) || t2.options.origin,
            i2 = (0, k2.resolveRectLike)(o3, t2, e2, [t2 && e2])
      ...
      Object.defineProperty(R3, '__esModule', { value: true }),
        (R3.default = /* @__PURE__ */ __name(function t2(e2, n2, r2) {
          if (
            ((r2 = r2 || {}),
            i.default.string(e2) && e2.search(' ') !== -1 && (e2 = z3(e2)),
            i.default.array(e2))
          )
      ...
      Object.defineProperty(C2, '__esModule', { value: true }),
        (C2.default = void 0),
        (C2.default = function (t2, e2) {
          return Math.sqrt(t2 * t2 + e2 * e2)
        })
      var F3 = {}
      function X2(t2, e2) {
        for (var n2 in e2) {
          var r2 = X2.prefixedPropREs,
            o3 = false
          for (var i2 in r2)
      ...
      function U2(t2, e2) {
        return (
          (e2 = e2 || { x: 0, y: 0 }),
          b2.default.isOperaMobile && W3(t2)
            ? (L2('screen', t2, e2), (e2.x += window.scrollX), (e2.y += window.scrollY))
            : L2('page', t2, e2),
          e2
        )
      }
      ...
      function V3(t2, e2) {
        return (
          (e2 = e2 || {}),
          b2.default.isOperaMobile && W3(t2) ? L2('screen', t2, e2) : L2('client', t2, e2),
          e2
        )
      }
      __name(V3, 'V')
      function N3(t2) {
        ...
        return (
          i.default.array(t2)
            ...
            : t2.type === 'touchend'
            ? t2.touches.length === 1
              ? ((e2[0] = t2.touches[0]), (e2[1] = t2.changedTouches[0]))
              : t2.touches.length === 0 &&
                ((e2[0] = t2.changedTouches[0]), (e2[1] = t2.changedTouches[1]))
            : ((e2[0] = t2.touches[0]), (e2[1] = t2.touches[1])),
          e2
        )
      }
      __name(N3, 'N')
      function q3(t2) {
        for (
          var e2 = { pageX: 0, pageY: 0, clientX: 0, clientY: 0, screenX: 0, screenY: 0 }, n2 = 0;
          n2 < t2.length;
          n2++
        ) {
          var r2 = t2[n2]
          for (var o3 in e2) e2[o3] += r2[o3]
        }
        for (var i2 in e2) e2[i2] /= t2.length
        return e2
      }
      __name(q3, 'q')
      Object.defineProperty(B2, '__esModule', { value: true }),
        (B2.copyCoords = function (t2, e2) {
          ;(t2.page = t2.page || {}),
            (t2.page.x = e2.page.x),
            (t2.page.y = e2.page.y),
            (t2.client = t2.client || {}),
            (t2.client.x = e2.client.x),
            (t2.client.y = e2.client.y),
            (t2.timeStamp = e2.timeStamp)
        }),
        (B2.setCoordDeltas = function (t2, e2, n2) {
          ;(t2.page.x = n2.page.x - e2.page.x),
            (t2.page.y = n2.page.y - e2.page.y),
            (t2.client.x = n2.client.x - e2.client.x),
            (t2.client.y = n2.client.y - e2.client.y),
            (t2.timeStamp = n2.timeStamp - e2.timeStamp)
        }),
        (B2.setCoordVelocity = function (t2, e2) {
          var n2 = Math.max(e2.timeStamp / 1e3, 1e-3)
          ;(t2.page.x = e2.page.x / n2),
            (t2.page.y = e2.page.y / n2),
            (t2.client.x = e2.client.x / n2),
            (t2.client.y = e2.client.y / n2),
            (t2.timeStamp = n2)
        }),
        (B2.setZeroCoords = function (t2) {
          ;(t2.page.x = 0), (t2.page.y = 0), (t2.client.x = 0), (t2.client.y = 0)
        }),
        (B2.isNativePointer = W3),
        (B2.getXY = L2),
        (B2.getPageXY = U2),
        (B2.getClientXY = V3),
        (B2.getPointerId = function (t2) {
        ...
        (B2.getTouchPair = N3),
        (B2.pointerAverage = q3),
        (B2.touchBBox = function (t2) {
          if (!t2.length) return null
          var e2 = N3(t2),
            n2 = Math.min(e2[0].pageX, e2[1].pageX),
            r2 = Math.min(e2[0].pageY, e2[1].pageY),
            o3 = Math.max(e2[0].pageX, e2[1].pageX),
            i2 = Math.max(e2[0].pageY, e2[1].pageY)
          return {
            x: n2,
            y: r2,
            left: n2,
        ...
        (B2.getPointerType = function (t2) {
          return i.default.string(t2.pointerType)
            ? t2.pointerType
            : i.default.number(t2.pointerType)
            ? [void 0, void 0, 'touch', 'pen', 'mouse'][t2.pointerType]
            : /touch/.test(t2.type || '') || t2 instanceof h2.default.Touch
            ? 'touch'
            : 'mouse'
        }),
        (B2.getEventTargets = function (t2) {
          ...
          return [
            _2.getActualElement(e2 ? e2[0] : t2.target),
            _2.getActualElement(t2.currentTarget),
          ]
        }),
        ...
        Object.defineProperty(B2, 'pointerExtend', {
          enumerable: true,
          get: function () {
            return F3.default
          },
      ...
      function G3(t2, e2) {
        for (var n2 = 0; n2 < e2.length; n2++) {
          ...
          ;(r2.enumerable = r2.enumerable || false),
            ...
            Object.defineProperty(t2, r2.key, r2)
        }
      }
      __name(G3, 'G')
      ...
      var K = (function () {
        function t2(e3) {
          !(function (t3, e4) {
            ...
            H3(this, 'type', void 0),
            H3(this, 'target', void 0),
            H3(this, 'currentTarget', void 0),
            H3(this, 'interactable', void 0),
            H3(this, '_interaction', void 0),
            H3(this, 'timeStamp', void 0),
            H3(this, 'immediatePropagationStopped', false),
            H3(this, 'propagationStopped', false),
            (this._interaction = e3)
        }
        __name(t2, 't')
        var e2, n2
        return (
      ...
      Object.defineProperty(Z2, '__esModule', { value: true }),
        (Z2.find = Z2.findIndex = Z2.from = Z2.merge = Z2.remove = Z2.contains = void 0),
        (Z2.contains = function (t2, e2) {
      ...
      var lt = (function (t2) {
        ...
        function a2(t3, e3, n3) {
          ...
          !(function (t4, e4) {
            ...
            st2(it2((r3 = i2.call(this, e3._interaction))), 'target', void 0),
            st2(it2(r3), 'dropzone', void 0),
            st2(it2(r3), 'dragEvent', void 0),
            st2(it2(r3), 'relatedTarget', void 0),
            st2(it2(r3), 'draggable', void 0),
            st2(it2(r3), 'timeStamp', void 0),
            st2(it2(r3), 'propagationStopped', false),
            st2(it2(r3), 'immediatePropagationStopped', false)
          var o4 = n3 === 'dragleave' ? t3.prev : t3.cur,
            s3 = o4.element,
            l4 = o4.dropzone
          return (
            (r3.type = n3),
            ...
            (r3.dropzone = l4),
            (r3.dragEvent = e3),
            (r3.relatedTarget = e3.target),
            (r3.draggable = e3.interactable),
            (r3.timeStamp = e3.timeStamp),
            r3
          )
        }
        __name(a2, 'a')
          ...
          (n2 = [
            {
              ...
              value: function () {
                var t3 = this,
                  e3 = this._interaction.dropState
                if (
                  this.type === 'dropactivate' ||
                  (this.dropzone &&
                    e3.cur.dropzone === this.dropzone &&
                    e3.cur.element === this.target)
                )
                  if (
                    ((e3.prev.dropzone = this.dropzone),
                    (e3.prev.element = this.target),
                    (e3.rejected = true),
                    (e3.events.enter = null),
                    this.stopImmediatePropagation(),
                    this.type === 'dropactivate')
                  ) {
                    var n3 = e3.activeDrops,
                      r3 = Z2.findIndex(n3, function (e4) {
                        var n4 = e4.dropzone,
                          r4 = e4.element
                    ...
                    ;(o4.dropzone = this.dropzone),
                      (o4.target = this.target),
                      this.dropzone.fire(o4)
                  } else this.dropzone.fire(new a2(e3, this.dragEvent, 'dragleave'))
              },
            },
            { key: 'preventDefault', value: function () {} },
            {
      ...
      function ct2(t2, e2) {
        for (var n2 = 0; n2 < t2.slice().length; n2++) {
          ...
          ;(e2.dropzone = o3),
            (e2.target = i2),
            o3.fire(e2),
            (e2.propagationStopped = e2.immediatePropagationStopped = false)
        }
      }
      __name(ct2, 'ct')
      function ft2(t2, e2) {
          ...
          var n2 = (function (t3, e3) {
              for (var n3 = t3.interactables, r3 = [], o4 = 0; o4 < n3.list.length; o4++) {
                ...
                if (a2.options.drop.enabled) {
                  ...
                  if (
                    !(
                      (i.default.element(s3) && s3 !== e3) ||
                      (i.default.string(s3) && !_2.matchesSelector(e3, s3)) ||
                      (i.default.func(s3) && !s3({ dropzone: a2, draggableElement: e3 }))
                    )
                  )
                    for (
                      var l4 = i.default.string(a2.target)
                          ? a2._context.querySelectorAll(a2.target)
                          : i.default.array(a2.target)
                          ? a2.target
                          : [a2.target],
                        u3 = 0;
                      u3 < l4.length;
      ...
      function dt(t2, e2, n2) {
        for (
          var r2 = t2.dropState, o3 = t2.interactable, i2 = t2.element, a2 = [], s3 = 0;
          s3 < r2.activeDrops.length;
          s3++
        ) {
          var l4 = r2.activeDrops[s3],
            u3 = l4.dropzone,
            c3 = l4.element,
            f3 = l4.rect
      ...
      function pt(t2, e2, n2) {
        ...
        return (
          n2.type === 'dragstart' &&
            ((o3.activate = new tt.DropEvent(r2, n2, 'dropactivate')),
            (o3.activate.target = null),
            (o3.activate.dropzone = null)),
          n2.type === 'dragend' &&
            ((o3.deactivate = new tt.DropEvent(r2, n2, 'dropdeactivate')),
            (o3.deactivate.target = null),
            (o3.deactivate.dropzone = null)),
          r2.rejected ||
            (r2.cur.element !== r2.prev.element &&
              (r2.prev.dropzone &&
                ((o3.leave = new tt.DropEvent(r2, n2, 'dragleave')),
                (n2.dragLeave = o3.leave.target = r2.prev.element),
                (n2.prevDropzone = o3.leave.dropzone = r2.prev.dropzone)),
              r2.cur.dropzone &&
                ((o3.enter = new tt.DropEvent(r2, n2, 'dragenter')),
                (n2.dragEnter = r2.cur.element),
                (n2.dropzone = r2.cur.dropzone))),
            n2.type === 'dragend' &&
              r2.cur.dropzone &&
              ((o3.drop = new tt.DropEvent(r2, n2, 'drop')),
              (n2.dropzone = r2.cur.dropzone),
              (n2.relatedTarget = r2.cur.element)),
            n2.type === 'dragmove' &&
              r2.cur.dropzone &&
              ((o3.move = new tt.DropEvent(r2, n2, 'dropmove')),
              (o3.move.dragmove = n2),
              (n2.dropzone = r2.cur.dropzone))),
          o3
        )
      ...
      function vt(t2, e2) {
        var n2 = t2.dropState,
          ...
          o3 = n2.cur,
          i2 = n2.prev
        e2.leave && i2.dropzone.fire(e2.leave),
          e2.enter && o3.dropzone.fire(e2.enter),
          e2.move && o3.dropzone.fire(e2.move),
          e2.drop && o3.dropzone.fire(e2.drop),
          e2.deactivate && ct2(r2, e2.deactivate),
          (n2.prev.dropzone = o3.dropzone),
          (n2.prev.element = o3.element)
      }
      __name(vt, 'vt')
      function ht2(t2, e2) {
        ...
        if (r2.type === 'dragmove' || r2.type === 'dragend') {
          var i2 = n2.dropState
          e2.dynamicDrop && (i2.activeDrops = ft2(e2, n2.element))
          var a2 = r2,
            s3 = dt(n2, a2, o3)
          ;(i2.rejected =
            i2.rejected &&
            !!s3 &&
            s3.dropzone === i2.cur.dropzone &&
            s3.element === i2.cur.element),
            (i2.cur.dropzone = s3 && s3.dropzone),
            (i2.cur.element = s3 && s3.element),
            (i2.events = pt(n2, 0, a2))
        }
      }
      __name(ht2, 'ht')
      ...
      var gt = {
          ...
          install: function (t2) {
            var e2 = t2.actions,
              n2 = t2.interactStatic,
              r2 = t2.Interactable,
              o3 = t2.defaults
            t2.usePlugin(c2.default),
              (r2.prototype.dropzone = function (t3) {
                return (function (t4, e3) {
                  if (i.default.object(e3)) {
                    if (((t4.options.drop.enabled = e3.enabled !== false), e3.listeners)) {
                      var n3 = (0, R3.default)(e3.listeners),
                        r3 = Object.keys(n3).reduce(function (t5, e4) {
                          return (
                            (t5[
                              /^(enter|leave)/.test(e4)
                                ? 'drag'.concat(e4)
                                : /^(activate|deactivate|move)/.test(e4)
                                ? 'drop'.concat(e4)
                                : e4
                            ] = n3[e4]),
                            t5
                    ...
                    return (
                      i.default.func(e3.ondrop) && t4.on('drop', e3.ondrop),
                      i.default.func(e3.ondropactivate) && t4.on('dropactivate', e3.ondropactivate),
                      i.default.func(e3.ondropdeactivate) &&
                        t4.on('dropdeactivate', e3.ondropdeactivate),
                      i.default.func(e3.ondragenter) && t4.on('dragenter', e3.ondragenter),
                      i.default.func(e3.ondragleave) && t4.on('dragleave', e3.ondragleave),
                      i.default.func(e3.ondropmove) && t4.on('dropmove', e3.ondropmove),
                      /^(pointer|center)$/.test(e3.overlap)
                        ? (t4.options.drop.overlap = e3.overlap)
                        : i.default.number(e3.overlap) &&
                          (t4.options.drop.overlap = Math.max(Math.min(1, e3.overlap), 0)),
                      'accept' in e3 && (t4.options.drop.accept = e3.accept),
                      'checker' in e3 && (t4.options.drop.checker = e3.checker),
                      t4
                    )
                  }
              ...
              (r2.prototype.dropCheck = function (t3, e3, n3, r3, o4, a2) {
                return (function (t4, e4, n4, r4, o5, a3, s3) {
                  ...
                  if (!(s3 = s3 || t4.getRect(a3)))
                    return (
                      !!t4.options.drop.checker &&
                      t4.options.drop.checker(e4, n4, l4, t4, a3, r4, o5)
                    )
                  var u3 = t4.options.drop.overlap
                  if (u3 === 'pointer') {
                    var c3 = (0, A3.default)(r4, o5, 'drag'),
                      f3 = B2.getPageXY(e4)
                    ;(f3.x += c3.x), (f3.y += c3.y)
                    var d3 = f3.x > s3.left && f3.x < s3.right,
                      p3 = f3.y > s3.top && f3.y < s3.bottom
                    l4 = d3 && p3
                  }
                  var v3 = r4.getRect(o5)
                  if (v3 && u3 === 'center') {
                    var h3 = v3.left + v3.width / 2,
                      g3 = v3.top + v3.height / 2
                    l4 = h3 >= s3.left && h3 <= s3.right && g3 >= s3.top && g3 <= s3.bottom
                  }
                  return (
                    v3 &&
                      i.default.number(u3) &&
                      (l4 =
                        (Math.max(0, Math.min(s3.right, v3.right) - Math.max(s3.left, v3.left)) *
                          Math.max(0, Math.min(s3.bottom, v3.bottom) - Math.max(s3.top, v3.top))) /
                          (v3.width * v3.height) >=
                        u3),
                    t4.options.drop.checker &&
                      (l4 = t4.options.drop.checker(e4, n4, l4, t4, a3, r4, o5)),
                    l4
                  )
              ...
              (0, j2.default)(e2.phaselessTypes, {
                dragenter: true,
                dragleave: true,
                dropactivate: true,
                dropdeactivate: true,
              ...
              (e2.methodDict.drop = 'dropzone'),
              (t2.dynamicDrop = false),
              (o3.actions.drop = gt.defaults)
          },
          listeners: {
            'interactions:before-action-start': function (t2) {
              var e2 = t2.interaction
              e2.prepared.name === 'drag' &&
                (e2.dropState = {
            ...
            'interactions:after-action-start': function (t2, e2) {
              var n2 = t2.interaction,
                r2 = (t2.event, t2.iEvent)
              if (n2.prepared.name === 'drag') {
                var o3 = n2.dropState
                ;(o3.activeDrops = null),
                  (o3.events = null),
                  (o3.activeDrops = ft2(e2, n2.element)),
                  (o3.events = pt(n2, 0, r2)),
                  o3.events.activate &&
                    (ct2(o3.activeDrops, o3.events.activate),
                    e2.fire('actions/drop:start', { interaction: n2, dragEvent: r2 }))
              }
            },
            'interactions:action-move': ht2,
            'interactions:after-action-move': function (t2, e2) {
              var n2 = t2.interaction,
                r2 = t2.iEvent
              n2.prepared.name === 'drag' &&
                (vt(n2, n2.dropState.events),
                e2.fire('actions/drop:move', { interaction: n2, dragEvent: r2 }),
                (n2.dropState.events = {}))
            },
            'interactions:action-end': function (t2, e2) {
              if (t2.interaction.prepared.name === 'drag') {
                ...
                ht2(t2, e2),
                  vt(n2, n2.dropState.events),
                  e2.fire('actions/drop:end', { interaction: n2, dragEvent: r2 })
              }
            },
            'interactions:stop': function (t2) {
              ...
              if (e2.prepared.name === 'drag') {
                ...
                n2 &&
                  ((n2.activeDrops = null),
                  (n2.events = null),
                  (n2.cur.dropzone = null),
                  (n2.cur.element = null),
                  (n2.prev.dropzone = null),
                  (n2.prev.element = null),
                  (n2.rejected = false))
              }
            },
          },
          ...
          getDropEvents: pt,
          fireDropEvents: vt,
          defaults: { enabled: false, accept: null, overlap: 'pointer' },
        },
        yt2 = gt
      ut.default = yt2
      var mt = {}
      function bt2(t2) {
        ...
        if (e2.prepared.name === 'gesture') {
          var o3 = e2.pointers.map(function (t3) {
            ...
            a2 = r2 === 'start',
            s3 = r2 === 'end',
            l4 = e2.interactable.options.deltaSource
          if (((n2.touches = [o3[0], o3[1]]), a2))
            (n2.distance = B2.touchDistance(o3, l4)),
              (n2.box = B2.touchBBox(o3)),
              (n2.scale = 1),
              (n2.ds = 0),
              (n2.angle = B2.touchAngle(o3, l4)),
              (n2.da = 0),
              (e2.gesture.startDistance = n2.distance),
              (e2.gesture.startAngle = n2.angle)
          else if (s3) {
            var u3 = e2.prevEvent
            ;(n2.distance = u3.distance),
              (n2.box = u3.box),
              (n2.scale = u3.scale),
              (n2.ds = 0),
              (n2.angle = u3.angle),
            ...
            (n2.distance = B2.touchDistance(o3, l4)),
              (n2.box = B2.touchBBox(o3)),
              (n2.scale = n2.distance / e2.gesture.startDistance),
              (n2.angle = B2.touchAngle(o3, l4)),
              (n2.ds = n2.scale - e2.gesture.scale),
              (n2.da = n2.angle - e2.gesture.angle)
          ;(e2.gesture.distance = n2.distance),
            (e2.gesture.angle = n2.angle),
            i.default.number(n2.scale) &&
              n2.scale !== 1 / 0 &&
              !isNaN(n2.scale) &&
              (e2.gesture.scale = n2.scale)
        }
      }
      __name(bt2, 'bt')
      ...
      var xt2 = {
          ...
          install: function (t2) {
            ...
            ;(n2.prototype.gesturable = function (t3) {
              return i.default.object(t3)
                ? ((this.options.gesture.enabled = t3.enabled !== false),
                  this.setPerAction('gesture', t3),
                  this.setOnEvents('gesture', t3),
                  this)
                : i.default.bool(t3)
                ? ((this.options.gesture.enabled = t3), this)
                : this.options.gesture
            }),
              (e2.map.gesture = xt2),
              (e2.methodDict.gesture = 'gesturable'),
              (r2.actions.gesture = xt2.defaults)
          },
          listeners: {
            'interactions:action-start': bt2,
            'interactions:action-move': bt2,
            'interactions:action-end': bt2,
      ...
      mt.default = wt2
      var _t = {}
      function Pt(t2, e2, n2, r2, o3, a2, s3) {
        if (!e2) return false
        if (e2 === true) {
          var l4 = i.default.number(a2.width) ? a2.width : a2.right - a2.left,
            u3 = i.default.number(a2.height) ? a2.height : a2.bottom - a2.top
          if (
            ((s3 = Math.min(s3, Math.abs((t2 === 'left' || t2 === 'right' ? l4 : u3) / 2))),
            l4 < 0 && (t2 === 'left' ? (t2 = 'right') : t2 === 'right' && (t2 = 'left')),
            u3 < 0 && (t2 === 'top' ? (t2 = 'bottom') : t2 === 'bottom' && (t2 = 'top')),
            t2 === 'left')
          )
            return n2.x < (l4 >= 0 ? a2.left : a2.right) + s3
          if (t2 === 'top') return n2.y < (u3 >= 0 ? a2.top : a2.bottom) + s3
          if (t2 === 'right') return n2.x > (l4 >= 0 ? a2.right : a2.left) - s3
          if (t2 === 'bottom') return n2.y > (u3 >= 0 ? a2.bottom : a2.top) - s3
        }
        return (
          !!i.default.element(r2) &&
          (i.default.element(e2) ? e2 === r2 : _2.matchesUpTo(r2, e2, o3))
        )
      }
      __name(Pt, 'Pt')
      function Ot(t2) {
        ...
        if (n2.prepared.name === 'resize' && n2.resizeAxes) {
          var r2 = e2
          n2.interactable.options.resize.square
            ? (n2.resizeAxes === 'y' ? (r2.delta.x = r2.delta.y) : (r2.delta.y = r2.delta.x),
              (r2.axes = 'xy'))
            : ((r2.axes = n2.resizeAxes),
              n2.resizeAxes === 'x' ? (r2.delta.y = 0) : n2.resizeAxes === 'y' && (r2.delta.x = 0))
        }
      }
      __name(Ot, 'Ot')
      ...
      var St = {
          ...
          install: function (t2) {
            ...
            ;(St.cursors = (function (t3) {
              ...
              (St.defaultMargin = n2.supportsTouch || n2.supportsPointerEvent ? 20 : 10),
              (r2.prototype.resizable = function (e3) {
                return (function (t3, e4, n3) {
                  return i.default.object(e4)
                    ? ((t3.options.resize.enabled = e4.enabled !== false),
                      t3.setPerAction('resize', e4),
                      t3.setOnEvents('resize', e4),
                      i.default.string(e4.axis) && /^x$|^y$|^xy$/.test(e4.axis)
                        ? (t3.options.resize.axis = e4.axis)
                        : e4.axis === null &&
                          (t3.options.resize.axis = n3.defaults.actions.resize.axis),
                      i.default.bool(e4.preserveAspectRatio)
                        ? (t3.options.resize.preserveAspectRatio = e4.preserveAspectRatio)
                        : i.default.bool(e4.square) && (t3.options.resize.square = e4.square),
                      t3)
                    : i.default.bool(e4)
                    ? ((t3.options.resize.enabled = e4), t3)
                    : t3.options.resize
                })(this, e3, t2)
              }),
              (e2.map.resize = St),
              (e2.methodDict.resize = 'resizable'),
              (o3.actions.resize = St.defaults)
          },
          listeners: {
            'interactions:new': function (t2) {
              ...
              !(function (t3) {
                ...
                if (n2.prepared.name === 'resize' && n2.prepared.edges) {
                  var r2 = e2,
                    o3 = n2.rect
                  ;(n2._rects = {
                    start: (0, j2.default)({}, o3),
                    corrected: (0, j2.default)({}, o3),
                    previous: (0, j2.default)({}, o3),
                    delta: { left: 0, right: 0, width: 0, top: 0, bottom: 0, height: 0 },
                  }),
                    (r2.edges = n2.prepared.edges),
                    (r2.rect = n2._rects.corrected),
                    (r2.deltaRect = n2._rects.delta)
                }
              })(t2),
                Ot(t2)
            },
            'interactions:action-move': function (t2) {
              !(function (t3) {
                ...
                if (n2.prepared.name === 'resize' && n2.prepared.edges) {
                  var r2 = e2,
                    o3 = n2.interactable.options.resize.invert,
                    i2 = o3 === 'reposition' || o3 === 'negate',
                    a2 = n2.rect,
                    s3 = n2._rects,
                    l4 = s3.start,
                    u3 = s3.corrected,
                  ...
                  if (((0, j2.default)(f3, u3), i2)) {
                    ...
                    (u3.top = Math.min(a2.top, l4.bottom)),
                      (u3.bottom = Math.max(a2.bottom, l4.top)),
                      (u3.left = Math.min(a2.left, l4.right)),
                      (u3.right = Math.max(a2.right, l4.left))
                  for (var v3 in ((u3.width = u3.right - u3.left),
            ...
            'auto-start:check': function (t2) {
              var e2 = t2.interaction,
                ...
                a2 = t2.buttons
              if (o3) {
                var s3 = (0, j2.default)({}, e2.coords.cur.page),
                  l4 = n2.options.resize
                if (
                  l4 &&
                  l4.enabled &&
                  (!e2.pointerIsDown ||
                    !/mouse|pointer/.test(e2.pointerType) ||
                    (a2 & l4.mouseButtons) != 0)
                ) {
                  if (i.default.object(l4.edges)) {
                    ...
                    for (var c3 in u3)
                      u3[c3] = Pt(
                        ...
                        l4.edges[c3],
                        s3,
                        e2._latestPointer.eventTarget,
                        r2,
                        o3,
                        l4.margin || St.defaultMargin
                      )
                    ;(u3.left = u3.left && !u3.right),
                      (u3.top = u3.top && !u3.bottom),
                      (u3.left || u3.right || u3.top || u3.bottom) &&
                        (t2.action = { name: 'resize', edges: u3 })
                  } else {
                    var f3 = l4.axis !== 'y' && s3.x > o3.right - St.defaultMargin,
                      d3 = l4.axis !== 'x' && s3.y > o3.bottom - St.defaultMargin
                    ;(f3 || d3) &&
                      (t2.action = { name: 'resize', axes: (f3 ? 'x' : '') + (d3 ? 'y' : '') })
                  }
          ...
          getCursor: function (t2) {
            ...
            if (n2) i2 = o3[r2 + n2]
              ...
              for (
                var a2 = '', s3 = ['top', 'bottom', 'left', 'right'], l4 = 0;
                l4 < s3.length;
                l4++
              ) {
                var u3 = s3[l4]
      ...
      var Mt = {
        id: 'actions',
        install: function (t2) {
          t2.usePlugin(mt.default),
            t2.usePlugin(_t.default),
            t2.usePlugin(c2.default),
            t2.usePlugin(ut.default)
        },
      }
      Tt2.default = Mt
      var jt2 = {}
          ...
          init: function (t2) {
            if (((kt = t2.requestAnimationFrame), (It2 = t2.cancelAnimationFrame), !kt))
              for (var e2 = ['ms', 'moz', 'webkit', 'o'], n2 = 0; n2 < e2.length; n2++) {
                var r2 = e2[n2]
                ;(kt = t2[''.concat(r2, 'RequestAnimationFrame')]),
                  (It2 =
                    t2[''.concat(r2, 'CancelAnimationFrame')] ||
                    t2[''.concat(r2, 'CancelRequestAnimationFrame')])
              }
            ;(kt = kt && kt.bind(t2)),
              (It2 = It2 && It2.bind(t2)),
              kt ||
                ((kt = /* @__PURE__ */ __name(function (e3) {
                  var n3 = Date.now(),
                    r3 = Math.max(0, 16 - (n3 - Dt)),
                    o3 = t2.setTimeout(function () {
                      e3(n3 + r3)
                    }, r3)
                  return (Dt = n3 + r3), o3
                }, 'kt')),
                (It2 = /* @__PURE__ */ __name(function (t3) {
      ...
      Object.defineProperty(Rt, '__esModule', { value: true }),
        (Rt.getContainer = Ct2),
        (Rt.getScroll = Ft2),
        (Rt.getScrollSize = function (t2) {
          return (
            i.default.window(t2) && (t2 = window.document.body),
            { x: t2.scrollWidth, y: t2.scrollHeight }
          )
        }),
        (Rt.getScrollSizeDelta = function (t2, e2) {
          var n2 = t2.interaction,
            r2 = t2.element,
            o3 = n2 && n2.interactable.options[n2.prepared.name].autoScroll
          if (!o3 || !o3.enabled) return e2(), { x: 0, y: 0 }
          var i2 = Ct2(o3.container, n2.interactable, r2),
            a2 = Ft2(i2)
          e2()
          var s3 = Ft2(i2)
        ...
        (Rt.default = void 0)
      var zt = {
        defaults: { enabled: false, margin: 60, container: null, speed: 300 },
        now: Date.now,
        interaction: null,
        i: 0,
        x: 0,
        ...
        start: function (t2) {
          ;(zt.isScrolling = true),
            jt2.default.cancel(zt.i),
            (t2.autoScroll = zt),
            (zt.interaction = t2),
            (zt.prevTime = zt.now()),
            (zt.i = jt2.default.request(zt.scroll))
        },
        stop: function () {
          ;(zt.isScrolling = false),
            zt.interaction && (zt.interaction.autoScroll = null),
            jt2.default.cancel(zt.i)
        },
        scroll: function () {
          var t2 = zt.interaction,
            e2 = t2.interactable,
            n2 = t2.element,
            r2 = t2.prepared.name,
            o3 = e2.options[r2].autoScroll,
            a2 = Ct2(o3.container, e2, n2),
            s3 = zt.now(),
            l4 = (s3 - zt.prevTime) / 1e3,
            u3 = o3.speed * l4
          if (u3 >= 1) {
            ...
            if (c3.x || c3.y) {
              var f3 = Ft2(a2)
              i.default.window(a2)
                ? a2.scrollBy(c3.x, c3.y)
                : a2 && ((a2.scrollLeft += c3.x), (a2.scrollTop += c3.y))
              var d3 = Ft2(a2),
                p3 = { x: d3.x - f3.x, y: d3.y - f3.y }
              ;(p3.x || p3.y) &&
                e2.fire({
                  type: 'autoscroll',
                  target: n2,
          ...
          if (e2.interacting() && zt.check(e2.interactable, e2.prepared.name))
            if (e2.simulation) zt.x = zt.y = 0
              ...
              var r2,
                ...
                u3 = e2.element,
                c3 = e2.prepared.name,
                f3 = l4.options[c3].autoScroll,
                d3 = Ct2(f3.container, l4, u3)
              if (i.default.window(d3))
                (s3 = n2.clientX < zt.margin),
                  (r2 = n2.clientY < zt.margin),
                  (o3 = n2.clientX > d3.innerWidth - zt.margin),
                  (a2 = n2.clientY > d3.innerHeight - zt.margin)
              else {
                var p3 = _2.getElementClientRect(d3)
                ;(s3 = n2.clientX < p3.left + zt.margin),
                  (r2 = n2.clientY < p3.top + zt.margin),
                  (o3 = n2.clientX > p3.right - zt.margin),
                  (a2 = n2.clientY > p3.bottom - zt.margin)
              }
              ;(zt.x = o3 ? 1 : s3 ? -1 : 0),
                (zt.y = a2 ? 1 : r2 ? -1 : 0),
                zt.isScrolling || ((zt.margin = f3.margin), (zt.speed = f3.speed), zt.start(e2))
            }
        },
      }
      function Ct2(t2, n2, r2) {
        return (
          (i.default.string(t2) ? (0, k2.getStringOptionResult)(t2, n2, r2) : t2) ||
          (0, e.getWindow)(r2)
        )
      }
      __name(Ct2, 'Ct')
      function Ft2(t2) {
        return (
          i.default.window(t2) && (t2 = window.document.body), { x: t2.scrollLeft, y: t2.scrollTop }
        )
      }
      __name(Ft2, 'Ft')
      var Xt = {
        ...
        install: function (t2) {
          ...
          ;(t2.autoScroll = zt),
            ...
            (n2.phaselessTypes.autoscroll = true),
            (e2.perAction.autoScroll = zt.defaults)
        },
        listeners: {
          'interactions:new': function (t2) {
      ...
      var Bt2 = {}
      function Wt(t2) {
        return i.default.bool(t2)
          ? ((this.options.styleCursor = t2), this)
          : t2 === null
      ...
      __name(Wt, 'Wt')
      function Lt(t2) {
        return i.default.func(t2)
          ? ((this.options.actionChecker = t2), this)
          : t2 === null
          ? (delete this.options.actionChecker, this)
          : this.options.actionChecker
      }
      __name(Lt, 'Lt')
      Object.defineProperty(Bt2, '__esModule', { value: true }), (Bt2.default = void 0)
      var Ut2 = {
            ...
            var i2 = (function (t3, e4, n3, r3, o4) {
              var i3 = t3.getRect(r3),
                a2 = {
                  ...
                  element: r3,
                  rect: i3,
                  buttons: e4.buttons || { 0: 1, 1: 4, 3: 8, 4: 16 }[e4.button],
                }
              return o4.fire('auto-start:check', a2), a2.action
            })(this, n2, r2, o3, t2)
            return this.options.actionChecker
              ? this.options.actionChecker(e3, n2, i2, this, o3, r2)
              : i2
          }),
            (e2.prototype.ignoreFrom = (0, Yt.warnOnce)(function (t3) {
              return this._backCompatOption('ignoreFrom', t3)
            }, 'Interactable.ignoreFrom() has been deprecated. Use Interactble.draggable({ignoreFrom: newValue}).')),
            (e2.prototype.allowFrom = (0, Yt.warnOnce)(function (t3) {
              return this._backCompatOption('allowFrom', t3)
            }, 'Interactable.allowFrom() has been deprecated. Use Interactble.draggable({allowFrom: newValue}).')),
            (e2.prototype.actionChecker = Lt),
            (e2.prototype.styleCursor = Wt)
        },
      }
      Bt2.default = Ut2
      var Vt = {}
      function Nt(t2, e2, n2, r2, o3) {
        return e2.testIgnoreAllow(e2.options[t2.name], n2, r2) &&
          e2.options[t2.name].enabled &&
          Ht(e2, n2, t2, o3)
          ? t2
          : null
      }
      ...
      function qt(t2, e2, n2, r2, o3, i2, a2) {
        for (var s3 = 0, l4 = r2.length; s3 < l4; s3++) {
          var u3 = r2[s3],
            c3 = o3[s3],
            f3 = u3.getAction(e2, n2, t2, c3)
          if (f3) {
            var d3 = Nt(f3, u3, c3, i2, a2)
            if (d3) return { action: d3, interactable: u3, element: c3 }
          }
        }
      ...
      function $t(t2, e2, n2, r2, o3) {
        var a2 = [],
          ...
          l4 = r2
        function u3(t3) {
          a2.push(t3), s3.push(l4)
        }
        __name(u3, 'u')
        for (; i.default.element(l4); ) {
          ;(a2 = []), (s3 = []), o3.interactables.forEachMatch(l4, u3)
          var c3 = qt(t2, e2, n2, a2, s3, r2, o3)
          if (c3.action && !c3.interactable.options[c3.action.name].manualStart) return c3
          l4 = _2.parentNode(l4)
        }
        return { action: null, interactable: null, element: null }
      }
      ...
      function Gt2(t2, e2, n2) {
        ...
        ;(r2 = r2 || { name: null }),
          (t2.interactable = o3),
          (t2.element = i2),
          (0, Yt.copyAction)(t2.prepared, r2),
          (t2.rect = o3 && r2.name ? o3.getRect(i2) : null),
          Jt(t2, n2),
          n2.fire('autoStart:prepared', { interaction: t2 })
      }
      __name(Gt2, 'Gt')
      function Ht(t2, e2, n2, r2) {
        var o3 = t2.options,
          i2 = o3[n2.name].max,
          a2 = o3[n2.name].maxPerElement,
          s3 = r2.autoStart.maxInteractions,
          l4 = 0,
          u3 = 0,
          c3 = 0
        if (!(i2 && a2 && s3)) return false
        for (var f3 = 0; f3 < r2.interactions.list.length; f3++) {
          var d3 = r2.interactions.list[f3],
            p3 = d3.prepared.name
          if (d3.interacting()) {
            if (++l4 >= s3) return false
            if (d3.interactable === t2) {
              if ((u3 += p3 === n2.name ? 1 : 0) >= i2) return false
              if (d3.element === e2 && (c3++, p3 === n2.name && c3 >= a2)) return false
            }
          }
        }
        return s3 > 0
      ...
      __name(Ht, 'Ht')
      function Kt(t2, e2) {
        return i.default.number(t2)
          ? ((e2.autoStart.maxInteractions = t2), this)
          : e2.autoStart.maxInteractions
      }
      __name(Kt, 'Kt')
      function Zt(t2, e2, n2) {
        var r2 = n2.autoStart.cursorElement
        r2 && r2 !== t2 && (r2.style.cursor = ''),
          (t2.ownerDocument.documentElement.style.cursor = e2),
          (t2.style.cursor = e2),
          (n2.autoStart.cursorElement = e2 ? t2 : null)
      }
      __name(Zt, 'Zt')
      function Jt(t2, e2) {
        ...
        if (t2.pointerType === 'mouse' && n2 && n2.options.styleCursor) {
          ...
          if (o3.name) {
            ...
            a2 = i.default.func(s3)
              ? s3(o3, n2, r2, t2._interacting)
              : e2.actions.map[o3.name].getCursor(o3)
          }
          Zt(t2.element, a2 || '', e2)
        } else e2.autoStart.cursorElement && Zt(e2.autoStart.cursorElement, '', e2)
      }
      __name(Jt, 'Jt')
      ...
      var Qt2 = {
        ...
        install: function (t2) {
          var e2 = t2.interactStatic,
            n2 = t2.defaults
          t2.usePlugin(Bt2.default),
            (n2.base.actionChecker = null),
            (n2.base.styleCursor = true),
            (0, j2.default)(n2.perAction, {
              manualStart: false,
              max: 1 / 0,
              maxPerElement: 1,
              allowFrom: null,
          ...
          'interactions:move': function (t2, e2) {
            !(function (t3, e3) {
              var n2 = t3.interaction,
                ...
                o3 = t3.event,
                i2 = t3.eventTarget
              n2.pointerType !== 'mouse' ||
                n2.pointerIsDown ||
                n2.interacting() ||
                Gt2(n2, $t(n2, r2, o3, i2, e3), e3)
            })(t2, e2),
              (function (t3, e3) {
                var n2 = t3.interaction
                if (
                  ...
                  var r2 = n2.interactable,
                    o3 = n2.prepared.name
                  o3 &&
                    r2 &&
                    (r2.options[o3].manualStart || !Ht(r2, n2.element, n2.prepared, e3)
                      ? n2.stop()
                      : (n2.start(n2.prepared, r2, n2.element), Jt(n2, e3)))
                }
              })(t2, e2)
          },
      ...
      var ee2 = {
        ...
        listeners: {
          'autoStart:before-start': function (t2, e2) {
            var n2 = t2.interaction,
              r2 = t2.eventTarget,
              o3 = t2.dx,
              a2 = t2.dy
            if (n2.prepared.name === 'drag') {
              var s3 = Math.abs(o3),
                l4 = Math.abs(a2),
                u3 = n2.interactable.options.drag,
                c3 = u3.startAxis,
                f3 = s3 > l4 ? 'x' : s3 < l4 ? 'y' : 'xy'
              if (
                ((n2.prepared.axis = u3.lockAxis === 'start' ? f3[0] : u3.lockAxis),
                f3 !== 'xy' && c3 !== 'xy' && c3 !== f3)
              ) {
                      ...
                      if (t3 !== n2.interactable) {
                        ...
                        if (!o4.manualStart && t3.testIgnoreAllow(o4, d3, r2)) {
                          ...
                          if (
                            ...
                            Vt.default.validateAction(i2, t3, d3, r2, e2)
                          )
                            return t3
                        }
                      }
        ...
        listeners: {
          ...
          'autoStart:prepared': function (t2) {
            var e2 = t2.interaction,
              n2 = re(e2)
            n2 > 0 &&
              (e2.autoStartHoldTimer = setTimeout(function () {
          ...
          'interactions:move': function (t2) {
            var e2 = t2.interaction,
              n2 = t2.duplicate
            e2.autoStartHoldTimer &&
              e2.pointerWasMoved &&
              !n2 &&
              (clearTimeout(e2.autoStartHoldTimer), (e2.autoStartHoldTimer = null))
          },
      ...
      var ae = {
        id: 'auto-start',
        install: function (t2) {
          t2.usePlugin(Vt.default), t2.usePlugin(ne2.default), t2.usePlugin(te.default)
        },
      }
      ie.default = ae
      var se2 = {}
      function le3(t2) {
        return /^(always|never|auto)$/.test(t2)
          ? ((this.options.preventDefault = t2), this)
          : i.default.bool(t2)
          ? ((this.options.preventDefault = t2 ? 'always' : 'never'), this)
      ...
      function ce2(t2) {
        var n2 = t2.Interactable
        ;(n2.prototype.preventDefault = le3),
          (n2.prototype.checkAndPreventDefault = function (n3) {
            return (function (t3, n4, r2) {
              var o3 = t3.options.preventDefault
              if (o3 !== 'never')
                if (o3 !== 'always') {
                  if (n4.events.supportsPassive && /^touch(start|move)$/.test(r2.type)) {
                    var a2 = (0, e.getWindow)(r2.target).document,
                      s3 = n4.getDocOptions(a2)
                    if (!s3 || !s3.events || s3.events.passive !== false) return
                  }
                  ;/^(mouse|pointer|touch)*(down|start)/i.test(r2.type) ||
                    (i.default.element(r2.target) &&
                      (0, _2.matchesSelector)(
                        r2.target,
                        'input,select,textarea,[contenteditable=true],[contenteditable=true] *'
                      )) ||
                    r2.preventDefault()
                } else r2.preventDefault()
            })(this, t2, n3)
          }),
          t2.interactions.docEvents.push({
            type: 'dragstart',
            listener: function (e2) {
              for (var n3 = 0; n3 < t2.interactions.list.length; n3++) {
                var r2 = t2.interactions.list[n3]
                if (
                  r2.element &&
                  (r2.element === e2.target || (0, _2.nodeContains)(r2.element, e2.target))
                )
      ...
      var pe,
        ve3 = {}
      Object.defineProperty(ve3, '__esModule', { value: true }),
        (ve3.default = void 0),
        (function (t2) {
          ;(t2.touchAction = 'touchAction'),
            (t2.boxSizing = 'boxSizing'),
            (t2.noListeners = 'noListeners')
        })(pe || (pe = {}))
      ...
      Object.defineProperty(ge, '__esModule', { value: true }),
        (ge.default = /* @__PURE__ */ __name(function t2(e2) {
          var n2 = {}
          for (var r2 in e2) {
            var o3 = e2[r2]
            i.default.plainObject(o3)
              ? (n2[r2] = t2(o3))
              : i.default.array(o3)
              ? (n2[r2] = Z2.from(o3))
              : (n2[r2] = o3)
        ...
        return (
          ...
          (function (t3, e3) {
            if (typeof Symbol != 'undefined' && Symbol.iterator in Object(t3)) {
              ...
              try {
                for (
                  var a2, s3 = t3[Symbol.iterator]();
                  !(r2 = (a2 = s3.next()).done) && (n2.push(a2.value), !e3 || n2.length !== e3);
                  r2 = true
                );
              } catch (t4) {
                ;(o3 = true), (i2 = t4)
          ...
          (function (t3, e3) {
            if (t3) {
              if (typeof t3 == 'string') return be3(t3, e3)
              var n2 = Object.prototype.toString.call(t3).slice(8, -1)
              return (
                n2 === 'Object' && t3.constructor && (n2 = t3.constructor.name),
                n2 === 'Map' || n2 === 'Set'
                  ? Array.from(t3)
                  : n2 === 'Arguments' || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n2)
                  ? be3(t3, e3)
                  : void 0
              )
            }
      ...
      var _e2 = (function () {
        function t2(e3) {
          !(function (t3, e4) {
            ...
            we2(this, 'states', []),
            we2(this, 'startOffset', { left: 0, right: 0, top: 0, bottom: 0 }),
            we2(this, 'startDelta', void 0),
            we2(this, 'result', void 0),
            we2(this, 'endResult', void 0),
            we2(this, 'edges', void 0),
            we2(this, 'interaction', void 0),
            (this.interaction = e3),
            (this.result = Pe())
        }
        __name(t2, 't')
          ...
          (n2 = [
            {
              ...
              value: function (t3, e3) {
                var n3 = t3.phase,
                  r2 = this.interaction,
                  o3 = (function (t4) {
                    var e4 = t4.interactable.options[t4.prepared.name],
                      n4 = e4.modifiers
                    return n4 && n4.length
                      ? n4
                      : [
                ...
                this.prepareStates(o3),
                  (this.edges = (0, j2.default)({}, r2.edges)),
                  (this.startOffset = Oe2(r2.rect, e3)),
            ...
            },
            {
              ...
              value: function (t3) {
                ...
                return (
                  (t3.interaction = e3),
                  (t3.interactable = e3.interactable),
                  (t3.element = e3.element),
                  (t3.rect = t3.rect || e3.rect),
                  (t3.edges = this.edges),
                  (t3.startOffset = this.startOffset),
                  t3
                )
              },
            },
            ...
            },
            {
              ...
              value: function (t3) {
                var e3 = t3.phase,
                  ...
                  r2 = t3.skipModifiers,
                  o3 = t3.rect
                ;(t3.coords = (0, j2.default)({}, t3.pageCoords)),
                  (t3.rect = (0, j2.default)({}, o3))
                for (
                  var i2 = r2 ? this.states.slice(r2) : this.states,
                    a2 = Pe(t3.coords, t3.rect),
                    s3 = 0;
                  s3 < i2.length;
                  s3++
                ) {
                  var l4,
                    u3 = i2[s3],
                    c3 = u3.options,
                    f3 = (0, j2.default)({}, t3.coords),
                    d3 = null
                  ;(l4 = u3.methods) != null &&
                    l4.set &&
                    this.shouldDo(c3, n3, e3) &&
                    ((t3.state = u3),
                    (d3 = u3.methods.set(t3)),
                    k2.addEdges(this.interaction.edges, t3.rect, {
                      x: t3.coords.x - f3.x,
                      y: t3.coords.y - f3.y,
                    })),
                    a2.eventProps.push(d3)
                }
                ;(a2.delta.x = t3.coords.x - t3.pageCoords.x),
                  (a2.delta.y = t3.coords.y - t3.pageCoords.y),
                  (a2.rectDelta.left = t3.rect.left - o3.left),
                  (a2.rectDelta.right = t3.rect.right - o3.right),
                  (a2.rectDelta.top = t3.rect.top - o3.top),
                  (a2.rectDelta.bottom = t3.rect.bottom - o3.bottom)
                var p3 = this.result.coords,
                  v3 = this.result.rect
                if (p3 && v3) {
                  var h3 =
                    a2.rect.left !== v3.left ||
                    a2.rect.right !== v3.right ||
                    a2.rect.top !== v3.top ||
                    a2.rect.bottom !== v3.bottom
                  a2.changed = h3 || p3.x !== a2.coords.x || p3.y !== a2.coords.y
                }
                return a2
              },
            },
            {
              ...
              value: function (t3) {
                ...
                var d3 = this.result.rectDelta,
                  p3 = t3.rect || e3.rect
                ;(p3.left += d3.left),
                  (p3.right += d3.right),
                  (p3.top += d3.top),
                  (p3.bottom += d3.bottom),
                  (p3.width = p3.right - p3.left),
                  (p3.height = p3.bottom - p3.top)
              },
            },
            {
              key: 'setAndApply',
                ...
                var e3 = this.interaction,
                  ...
                  i2 = this.setAll(
                    this.fillArg({
                      preEnd: r2,
                      phase: n3,
                      pageCoords: t3.modifiedCoords || e3.coords.cur.page,
                    })
                  )
                if (
                  ((this.result = i2),
                  !i2.changed && (!o3 || o3 < this.states.length) && e3.interacting())
                )
                  return false
                if (t3.modifiedCoords) {
                  var a2 = e3.coords.cur.page,
                    s3 = { x: t3.modifiedCoords.x - a2.x, y: t3.modifiedCoords.y - a2.y }
                  ;(i2.coords.x += s3.x),
                    (i2.coords.y += s3.y),
                    (i2.delta.x += s3.x),
                    (i2.delta.y += s3.y)
              ...
              value: function (t3) {
                ...
                if (r2 && r2.length) {
                  for (var o3 = false, i2 = 0; i2 < r2.length; i2++) {
                    ...
                    var s3 = a2.options,
                      l4 = a2.methods,
                      u3 = l4.beforeEnd && l4.beforeEnd(t3)
                    if (u3) return (this.endResult = u3), false
            ...
            },
            {
              key: 'copyFrom',
              value: function (t3) {
                ;(this.startOffset = t3.startOffset),
                  (this.startDelta = t3.startDelta),
                  (this.edges = t3.edges),
                  (this.states = t3.states.map(function (t4) {
                    return (0, ge.default)(t4)
                  })),
                  (this.result = Pe(
                    (0, j2.default)({}, t3.result.coords),
                    (0, j2.default)({}, t3.result.rect)
                  ))
              },
            },
            {
      ...
      function Ee2(t2) {
        var e2 = t2.iEvent,
          n2 = t2.interaction.modification.result
        n2 && (e2.modifiers = n2.eventProps)
      }
      __name(Ee2, 'Ee')
      Object.defineProperty(Se3, '__esModule', { value: true }),
        (Se3.makeModifier = function (t2, e2) {
          var n2 = t2.defaults,
            r2 = { start: t2.start, set: t2.set, beforeEnd: t2.beforeEnd, stop: t2.stop },
            o3 = /* @__PURE__ */ __name(function (t3) {
              var o4 = t3 || {}
      ...
      var Te2 = {
        ...
        listeners: {
          ...
          'interactions:before-action-start': function (t2) {
            ...
            e2.start(t2, t2.interaction.coords.start.page),
              (t2.interaction.edges = e2.edges),
              e2.applyToInteraction(t2)
          },
          ...
          'interactions:action-start': Ee2,
          'interactions:action-move': Ee2,
          'interactions:action-end': Ee2,
      ...
      Object.defineProperty(Me3, '__esModule', { value: true }),
        ...
        (Me3.defaults = {
          ...
          perAction: { enabled: false, origin: { x: 0, y: 0 } },
          actions: {},
        })
      var je = {}
      function ke2(t2) {
      ...
      __name(De2, 'De')
      function Ae2(t2, e2) {
        return !e2 || (ke2(e2) !== 'object' && typeof e2 != 'function') ? Re2(t2) : e2
      }
      __name(Ae2, 'Ae')
      function Re2(t2) {
        if (t2 === void 0)
      ...
      __name(Re2, 'Re')
      function ze2(t2) {
        return (ze2 = Object.setPrototypeOf
          ? Object.getPrototypeOf
          : function (t3) {
              return t3.__proto__ || Object.getPrototypeOf(t3)
            })(t2)
      ...
      var Fe3 = (function (t2) {
        ...
        function a2(t3, e3, n3, r3, o4, s3, l4) {
          var u3
          !(function (t4, e4) {
            if (!(t4 instanceof e4)) throw new TypeError('Cannot call a class as a function')
          })(this, a2),
            Ce3(Re2((u3 = i2.call(this, t3))), 'target', void 0),
            Ce3(Re2(u3), 'currentTarget', void 0),
            Ce3(Re2(u3), 'relatedTarget', null),
            Ce3(Re2(u3), 'screenX', void 0),
            Ce3(Re2(u3), 'screenY', void 0),
            Ce3(Re2(u3), 'button', void 0),
            Ce3(Re2(u3), 'buttons', void 0),
            Ce3(Re2(u3), 'ctrlKey', void 0),
            Ce3(Re2(u3), 'shiftKey', void 0),
            Ce3(Re2(u3), 'altKey', void 0),
            Ce3(Re2(u3), 'metaKey', void 0),
            Ce3(Re2(u3), 'page', void 0),
            Ce3(Re2(u3), 'client', void 0),
            Ce3(Re2(u3), 'delta', void 0),
            Ce3(Re2(u3), 'rect', void 0),
            Ce3(Re2(u3), 'x0', void 0),
            Ce3(Re2(u3), 'y0', void 0),
            Ce3(Re2(u3), 't0', void 0),
            Ce3(Re2(u3), 'dt', void 0),
            Ce3(Re2(u3), 'duration', void 0),
            Ce3(Re2(u3), 'clientX0', void 0),
            Ce3(Re2(u3), 'clientY0', void 0),
            Ce3(Re2(u3), 'velocity', void 0),
            Ce3(Re2(u3), 'speed', void 0),
            Ce3(Re2(u3), 'swipe', void 0),
            Ce3(Re2(u3), 'timeStamp', void 0),
            Ce3(Re2(u3), 'axes', void 0),
            Ce3(Re2(u3), 'preEnd', void 0),
            (o4 = o4 || t3.element)
          var c3 = t3.interactable,
            f3 = ((c3 && c3.options) || Me3.defaults).deltaSource,
            d3 = (0, A3.default)(c3, o4, n3),
            p3 = r3 === 'start',
            v3 = r3 === 'end',
            h3 = p3 ? Re2(u3) : t3.prevEvent,
            g3 = p3
              ? t3.coords.start
              : v3
              ? { page: h3.page, client: h3.client, timeStamp: t3.coords.cur.timeStamp }
              : t3.coords.cur
          return (
            (u3.page = (0, j2.default)({}, g3.page)),
            (u3.client = (0, j2.default)({}, g3.client)),
            (u3.rect = (0, j2.default)({}, t3.rect)),
            (u3.timeStamp = g3.timeStamp),
            v3 ||
              ((u3.page.x -= d3.x),
              (u3.page.y -= d3.y),
              (u3.client.x -= d3.x),
              (u3.client.y -= d3.y)),
            (u3.ctrlKey = e3.ctrlKey),
            (u3.altKey = e3.altKey),
            (u3.shiftKey = e3.shiftKey),
            (u3.metaKey = e3.metaKey),
            (u3.button = e3.button),
            (u3.buttons = e3.buttons),
            (u3.target = o4),
            (u3.currentTarget = o4),
            (u3.preEnd = s3),
            (u3.type = l4 || n3 + (r3 || '')),
            (u3.interactable = c3),
            (u3.t0 = p3 ? t3.pointers[t3.pointers.length - 1].downTime : h3.t0),
            (u3.x0 = t3.coords.start.page.x - d3.x),
            (u3.y0 = t3.coords.start.page.y - d3.y),
            (u3.clientX0 = t3.coords.start.client.x - d3.x),
            (u3.clientY0 = t3.coords.start.client.y - d3.y),
            (u3.delta =
              p3 || v3 ? { x: 0, y: 0 } : { x: u3[f3].x - h3[f3].x, y: u3[f3].y - h3[f3].y }),
            (u3.dt = t3.coords.delta.timeStamp),
            (u3.duration = u3.timeStamp - u3.t0),
            (u3.velocity = (0, j2.default)({}, t3.coords.velocity[f3])),
            (u3.speed = (0, C2.default)(u3.velocity.x, u3.velocity.y)),
            (u3.swipe = v3 || r3 === 'inertiastart' ? u3.getSwipe() : null),
            u3
          )
        }
        __name(a2, 'a')
          ...
          (n2 = [
            {
              ...
              value: function () {
                ...
                if (t3.prevEvent.speed < 600 || this.timeStamp - t3.prevEvent.timeStamp > 150)
                  return null
                var e3 =
                  (180 * Math.atan2(t3.prevEvent.velocityY, t3.prevEvent.velocityX)) / Math.PI
                e3 < 0 && (e3 += 360)
                var n3 = 112.5 <= e3 && e3 < 247.5,
                  r3 = 202.5 <= e3 && e3 < 337.5
                return {
                  up: r3,
                  down: !r3 && 22.5 <= e3 && e3 < 157.5,
                  left: n3,
                  right: !n3 && (292.5 <= e3 || e3 < 67.5),
                  angle: e3,
                  speed: t3.prevEvent.speed,
                  velocity: { x: t3.prevEvent.velocityX, y: t3.prevEvent.velocityY },
                }
              },
            },
            { key: 'preventDefault', value: function () {} },
      ...
      ;(je.InteractEvent = Fe3),
        Object.defineProperties(Fe3.prototype, {
          pageX: {
            get: function () {
              return this.page.x
            },
      ...
      Object.defineProperty(Xe2, '__esModule', { value: true }),
        (Xe2.PointerInfo = void 0),
        (Xe2.PointerInfo = /* @__PURE__ */ __name(function t2(e2, n2, r2, o3, i2) {
          !(function (t3, e3) {
        ...
        qe2 = (function () {
          function t2(e3) {
            ...
            !(function (t3, e4) {
              ...
              Ve(this, 'pointerIsDown', false),
              Ve(this, 'pointerWasMoved', false),
              Ve(this, '_interacting', false),
              Ve(this, '_ending', false),
              Ve(this, '_stopped', true),
              Ve(this, '_proxy', null),
              Ve(this, 'simulation', null),
              Ve(
                this,
                'doMove',
                (0, Yt.warnOnce)(function (t3) {
                  this.move(t3)
            ...
            var a2 = /* @__PURE__ */ __name(function (t3) {
              Object.defineProperty(n3._proxy, t3, {
                get: function () {
                  return i2[t3]
                },
              })
            }, 'a')
            for (var s3 in Be) a2(s3)
            ...
            (n2 = [
              ...
              },
              {
                ...
                value: function (t3, e3, n3) {
                  var r2 = this.updatePointer(t3, e3, n3, true),
                    o3 = this.pointers[r2]
                ...
                value: function (t3, e3, n3) {
                  return (
                    !(
                      this.interacting() ||
                      !this.pointerIsDown ||
                      this.pointers.length < (t3.name === 'gesture' ? 2 : 1) ||
                      !e3.options[t3.name].enabled
                    ) &&
                    ((0, Yt.copyAction)(this.prepared, t3),
                    (this.interactable = e3),
                    (this.element = n3),
                    (this.rect = e3.getRect(n3)),
                    (this.edges = this.prepared.edges
                      ? (0, j2.default)({}, this.prepared.edges)
              ...
              },
              {
                ...
                value: function (t3, e3, n3) {
                  this.simulation ||
                    ...
                    this.updatePointer(t3, e3, n3, false)
                  var r2,
                    o3,
                    i2 =
                  ...
                  this.pointerIsDown &&
                    ...
                    ((r2 = this.coords.cur.client.x - this.coords.start.client.x),
                    (o3 = this.coords.cur.client.y - this.coords.start.client.y),
                    (this.pointerWasMoved = (0, C2.default)(r2, o3) > this.pointerMoveTolerance))
                  var a2 = this.getPointerIndex(t3),
                    s3 = {
                      pointer: t3,
                      pointerIndex: a2,
                      pointerInfo: this.pointers[a2],
                      event: e3,
                      type: 'move',
                      eventTarget: n3,
                      dx: r2,
                  ...
                  i2 || B2.setCoordVelocity(this.coords.velocity, this.coords.delta),
                    this._scopeFire('interactions:move', s3),
                    i2 ||
                      this.simulation ||
                      (this.interacting() && ((s3.type = null), this.move(s3)),
                      this.pointerWasMoved && B2.copyCoords(this.coords.prev, this.coords.cur))
                },
              },
              {
                key: 'move',
                value: function (t3) {
                  ;(t3 && t3.event) || B2.setZeroCoords(this.coords.delta),
                    ((t3 = (0, j2.default)(
                      {
              ...
              },
              {
                ...
                value: function (t3, e3, n3, r2) {
                  ...
                  this._scopeFire('interactions:'.concat(i2), {
                    pointer: t3,
                    pointerIndex: o3,
                    pointerInfo: this.pointers[o3],
                    event: e3,
                    eventTarget: n3,
                    type: i2,
                    curEventTarget: r2,
                    ...
                    this.simulation || this.end(e3),
                    this.removePointer(t3, e3)
                },
              },
              {
                key: 'documentBlur',
              ...
              },
              {
                ...
                value: function (t3) {
                  var e3
                  ;(this._ending = true),
                    (t3 = t3 || this._latestPointer.event),
                    this.interacting() &&
                      (e3 = this._doPhase({ event: t3, interaction: this, phase: 'end' })),
                    (this._ending = false),
                    e3 === true && this.stop()
                },
              },
              ...
              },
              {
                ...
                value: function (t3) {
                  ...
                  return this.pointerType === 'mouse' || this.pointerType === 'pen'
                    ...
                    : Z2.findIndex(this.pointers, function (t4) {
                        return t4.id === e3
                      })
                },
              },
              ...
              },
              {
                key: 'updatePointer',
                value: function (t3, e3, n3, r2) {
                  var o3 = B2.getPointerId(t3),
                    i2 = this.getPointerIndex(t3),
                    a2 = this.pointers[i2]
                  return (
                    (r2 = r2 !== false && (r2 || /(down|start)$/i.test(e3.type))),
                    a2
                      ? (a2.pointer = t3)
                      : ((a2 = new Xe2.PointerInfo(o3, t3, e3, null, null)),
                        (i2 = this.pointers.length),
                        this.pointers.push(a2)),
                    B2.setCoords(
                      this.coords.cur,
                      this.pointers.map(function (t4) {
                        return t4.pointer
                      }),
                      this._now()
                    ),
                    B2.setCoordDeltas(this.coords.delta, this.coords.prev, this.coords.cur),
                    r2 &&
                      ((this.pointerIsDown = true),
                      (a2.downTime = this.coords.cur.timeStamp),
                      (a2.downTarget = n3),
                      B2.pointerExtend(this.downPointer, t3),
                      this.interacting() ||
                        (B2.copyCoords(this.coords.start, this.coords.cur),
                        B2.copyCoords(this.coords.prev, this.coords.cur),
                        (this.downEvent = e3),
                        (this.pointerWasMoved = false))),
                    this._updateLatestPointer(t3, e3, n3),
              ...
              },
              {
                ...
                value: function (t3, e3, n3) {
                  ;(this._latestPointer.pointer = t3),
                    (this._latestPointer.event = e3),
                    (this._latestPointer.eventTarget = n3)
                },
              },
              {
                key: 'destroy',
              ...
              },
              {
                key: '_fireEvent',
                value: function (t3) {
                  this.interactable.fire(t3),
                    (!this.prevEvent || t3.timeStamp >= this.prevEvent.timeStamp) &&
                      (this.prevEvent = t3)
                },
              },
              {
                ...
                value: function (t3) {
                  ...
                  if (
                    (i2 &&
                      ...
                      (i2.width = i2.right - i2.left),
                      (i2.height = i2.bottom - i2.top)),
                    this._scopeFire('interactions:before-action-'.concat(n3), t3) === false)
                  )
                    return false
                  var a2 = (t3.iEvent = this._createPreparedEvent(e3, n3, r2, o3))
                  return (
                    this._scopeFire('interactions:action-'.concat(n3), t3),
                    n3 === 'start' && (this.prevEvent = a2),
                    this._fireEvent(a2),
                    this._scopeFire('interactions:after-action-'.concat(n3), t3),
                    true
                  )
                },
              },
      ...
      function He2(t2) {
        t2.pointerIsDown &&
          (Qe(t2.coords.cur, t2.offset.total), (t2.offset.pending.x = 0), (t2.offset.pending.y = 0))
      }
      __name(He2, 'He')
      function Ke(t2) {
        Ze(t2.interaction)
      ...
      function Ze(t2) {
        ...
        return (
          Qe(t2.coords.cur, e2),
          Qe(t2.coords.delta, e2),
          k2.addEdges(t2.edges, t2.rect, e2),
          (e2.x = 0),
          (e2.y = 0),
          true
        )
      ...
      function Je(t2) {
        var e2 = t2.x,
          n2 = t2.y
        ;(this.offset.pending.x += e2),
          (this.offset.pending.y += n2),
          (this.offset.total.x += e2),
          (this.offset.total.y += n2)
      }
      __name(Je, 'Je')
      function Qe(t2, e2) {
        var n2 = t2.page,
      ...
      var tn = {
        ...
        listeners: {
          ...
          'interactions:before-action-end': function (t2) {
            var e2 = t2.interaction
            if (Ze(e2)) return e2.move({ offset: true }), e2.end(), false
          },
          'interactions:stop': function (t2) {
            var e2 = t2.interaction
            ;(e2.offset.total.x = 0),
              (e2.offset.total.y = 0),
              (e2.offset.pending.x = 0),
              (e2.offset.pending.y = 0)
          },
        },
      }
      Ge2.default = tn
      ...
      var on = (function () {
        function t2(e3) {
          !(function (t3, e4) {
            ...
            rn(this, 'active', false),
            rn(this, 'isModified', false),
            rn(this, 'smoothEnd', false),
            rn(this, 'allowResume', false),
          ...
          (n2 = [
            {
              ...
              value: function (t3) {
                var e3 = this.interaction,
                  n3 = an(e3)
                if (!n3 || !n3.enabled) return false
                var r2 = e3.coords.velocity.client,
                  o3 = (0, C2.default)(r2.x, r2.y),
                  i2 = this.modification || (this.modification = new ye3.default(e3))
                if (
                  (i2.copyFrom(e3.modification),
                  (this.t0 = e3._now()),
                  (this.allowResume = n3.allowResume),
                  (this.v0 = o3),
                  (this.currentOffset = { x: 0, y: 0 }),
                  (this.startCoords = e3.coords.cur.page),
                  (this.modifierArg = i2.fillArg({
                    pageCoords: this.startCoords,
                    preEnd: true,
                    phase: 'inertiastart',
                  })),
                  this.t0 - e3.coords.cur.timeStamp < 50 && o3 > n3.minSpeed && o3 > n3.endSpeed)
                )
                  this.startInertia()
                else {
                  if (((i2.result = i2.setAll(this.modifierArg)), !i2.result.changed)) return false
                  this.startSmoothEnd()
                }
                return (
                  (e3.modification.result.rect = null),
                  e3.offsetBy(this.targetOffset),
                  e3._doPhase({ interaction: e3, event: t3, phase: 'inertiastart' }),
                  e3.offsetBy({ x: -this.targetOffset.x, y: -this.targetOffset.y }),
                  (e3.modification.result.rect = null),
                  (this.active = true),
                  (e3.simulation = this),
                  true
            ...
            },
            {
              ...
              value: function () {
                var t3 = this,
                  e3 = this.interaction.coords.velocity.client,
                  n3 = an(this.interaction),
                  r2 = n3.resistance,
                  o3 = -Math.log(n3.endSpeed / this.v0) / r2
                ;(this.targetOffset = { x: (e3.x - o3) / r2, y: (e3.y - o3) / r2 }),
                  (this.te = o3),
                  (this.lambda_v0 = r2 / this.v0),
                  (this.one_ve_v0 = 1 - n3.endSpeed / this.v0)
                var i2 = this.modification,
                  a2 = this.modifierArg
                ;(a2.pageCoords = {
                  x: this.startCoords.x + this.targetOffset.x,
                  y: this.startCoords.y + this.targetOffset.y,
                }),
                  (i2.result = i2.setAll(a2)),
                  i2.result.changed &&
                    ((this.isModified = true),
                    (this.modifiedOffset = {
                      x: this.targetOffset.x + i2.result.delta.x,
                      y: this.targetOffset.y + i2.result.delta.y,
                    })),
            ...
            },
            {
              ...
              value: function () {
                var t3,
                  ...
                  a2 = this.interaction,
                  s3 = an(a2).resistance,
                  l4 = (a2._now() - this.t0) / 1e3
                if (l4 < this.te) {
                  var u3,
                    c3 = 1 - (Math.exp(-s3 * l4) - this.lambda_v0) / this.one_ve_v0
                  this.isModified
                    ? (0,
                      0,
                      (t3 = this.targetOffset.x),
                      (e3 = this.targetOffset.y),
                      (n3 = this.modifiedOffset.x),
                      (r2 = this.modifiedOffset.y),
                      (u3 = { x: sn((o3 = c3), 0, t3, n3), y: sn(o3, 0, e3, r2) }))
                    : (u3 = { x: this.targetOffset.x * c3, y: this.targetOffset.y * c3 })
                  var f3 = { x: u3.x - this.currentOffset.x, y: u3.y - this.currentOffset.y }
                  ;(this.currentOffset.x += f3.x),
                    (this.currentOffset.y += f3.y),
                    a2.offsetBy(f3),
                    a2.move(),
                    this.onNextFrame(function () {
            ...
            },
            {
              ...
              value: function () {
                var t3 = this,
                  e3 = this.interaction,
                  n3 = e3._now() - this.t0,
                  r2 = an(e3).smoothEndDuration
                if (n3 < r2) {
                  var o3 = {
                      x: ln(n3, 0, this.targetOffset.x, r2),
                      y: ln(n3, 0, this.targetOffset.y, r2),
                    },
                    i2 = { x: o3.x - this.currentOffset.x, y: o3.y - this.currentOffset.y }
                  ;(this.currentOffset.x += i2.x),
                    (this.currentOffset.y += i2.y),
                    e3.offsetBy(i2),
                    e3.move({ skipModifiers: this.modifierCount }),
                    this.onNextFrame(function () {
                      return t3.smoothEndTick()
                    })
                } else
            ...
            },
            {
              ...
              value: function (t3) {
                var e3 = t3.pointer,
                  ...
                  r2 = t3.eventTarget,
                  o3 = this.interaction
                o3.offsetBy({ x: -this.currentOffset.x, y: -this.currentOffset.y }),
                  o3.updatePointer(e3, n3, r2, true),
                  o3._doPhase({ interaction: o3, event: n3, phase: 'resume' }),
                  (0, B2.copyCoords)(o3.coords.prev, o3.coords.cur),
                  this.stop()
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ;(this.active = this.smoothEnd = false),
                  ...
                  jt2.default.cancel(this.timeout)
              },
            },
          ]) && nn(e2.prototype, n2),
          t2
      ...
      var un = {
        ...
        install: function (t2) {
          var e2 = t2.defaults
          t2.usePlugin(Ge2.default),
            t2.usePlugin(Se3.default),
            (t2.actions.phases.inertiastart = true),
            (t2.actions.phases.resume = true),
            (e2.perAction.inertia = {
              enabled: false,
              resistance: 10,
              minSpeed: 100,
              endSpeed: 10,
        ...
        listeners: {
          ...
          'interactions:action-resume': Se3.addEventModifiers,
          'interactions:action-inertiastart': Se3.addEventModifiers,
      ...
      var vn = (function () {
        function t2(e3) {
          !(function (t3, e4) {
            ...
            dn(this, 'types', {}),
            dn(this, 'propagationStopped', false),
            dn(this, 'immediatePropagationStopped', false),
            dn(this, 'global', void 0),
            (this.options = (0, j2.default)({}, e3 || {}))
        }
        __name(t2, 't')
        var e2, n2
        return (
          ...
          (n2 = [
            {
              ...
              value: function (t3) {
                var e3,
                  n3 = this.global
                ;(e3 = this.types[t3.type]) && pn(t3, e3),
                  !t3.propagationStopped && n3 && (e3 = n3[t3.type]) && pn(t3, e3)
              },
            },
            {
              key: 'on',
              value: function (t3, e3) {
                ...
                for (t3 in n3) this.types[t3] = Z2.merge(this.types[t3] || [], n3[t3])
              },
            },
            {
              key: 'off',
      ...
      Object.defineProperty(hn, '__esModule', { value: true }),
        (hn.default = function (t2, e2) {
          if (e2.phaselessTypes[t2]) return true
          for (var n2 in e2.map)
            if (t2.indexOf(n2) === 0 && t2.substr(n2.length) in e2.phases) return true
          return false
        })
      var gn = {}
      Object.defineProperty(gn, '__esModule', { value: true }),
        (gn.createInteractStatic = function (t2) {
          ...
          return (
            (e2.getPointerAverage = B2.pointerAverage),
            (e2.getTouchBBox = B2.touchBBox),
            (e2.getTouchDistance = B2.touchDistance),
            (e2.getTouchAngle = B2.touchAngle),
            (e2.getElementRect = _2.getElementRect),
            (e2.getElementClientRect = _2.getElementClientRect),
            (e2.matchesSelector = _2.matchesSelector),
            (e2.closest = _2.closest),
            (e2.globalEvents = {}),
            (e2.version = '1.10.11'),
            (e2.scope = t2),
            (e2.use = function (t3, e3) {
            ...
            (e2.on = (0, Yt.warnOnce)(function (t3, e3, n2) {
              if (
                (i.default.string(t3) && t3.search(' ') !== -1 && (t3 = t3.trim().split(/ +/)),
                i.default.array(t3))
              ) {
              ...
              if (i.default.object(t3)) {
                for (var a2 in t3) this.on(a2, t3[a2], e3)
                return this
              }
              return (
                (0, hn.default)(t3, this.scope.actions)
                  ? this.globalEvents[t3]
                    ? this.globalEvents[t3].push(e3)
                    : (this.globalEvents[t3] = [e3])
                  : this.scope.events.add(this.scope.document, t3, e3, { options: n2 }),
                this
              )
            }, 'The interact.on() method is being deprecated')),
            (e2.off = (0, Yt.warnOnce)(function (t3, e3, n2) {
              if (
                (i.default.string(t3) && t3.search(' ') !== -1 && (t3 = t3.trim().split(/ +/)),
                i.default.array(t3))
              ) {
              ...
              if (i.default.object(t3)) {
                for (var a2 in t3) this.off(a2, t3[a2], e3)
                return this
              }
              var s3
              return (
                (0, hn.default)(t3, this.scope.actions)
                  ? t3 in this.globalEvents &&
                    (s3 = this.globalEvents[t3].indexOf(e3)) !== -1 &&
                    this.globalEvents[t3].splice(s3, 1)
                  : this.scope.events.remove(this.scope.document, t3, e3, n2),
                this
              )
            ...
            (e2.pointerMoveTolerance = function (t3) {
              return i.default.number(t3)
                ? ((this.scope.interactions.pointerMoveTolerance = t3), this)
      ...
      var xn = (function () {
        function t2(n3, r3, o3, i2) {
          !(function (t3, e2) {
            ...
            (this._actions = r3.actions),
            (this.target = n3),
            (this._context = r3.context || o3),
            (this._win = (0, e.getWindow)((0, _2.trySelector)(n3) ? this._context : n3)),
            (this._doc = this._win.document),
            (this._scopeEvents = i2),
            this.set(r3)
        }
        __name(t2, 't')
        var n2, r2
          ...
          (r2 = [
            ...
            },
            {
              ...
              value: function (t3, e2) {
                return (
                  i.default.func(e2.onstart) && this.on(''.concat(t3, 'start'), e2.onstart),
                  i.default.func(e2.onmove) && this.on(''.concat(t3, 'move'), e2.onmove),
                  i.default.func(e2.onend) && this.on(''.concat(t3, 'end'), e2.onend),
                  i.default.func(e2.oninertiastart) &&
                    this.on(''.concat(t3, 'inertiastart'), e2.oninertiastart),
                  this
                )
              },
            },
            {
              ...
              value: function (t3, e2, n3) {
                ;(i.default.array(e2) || i.default.object(e2)) && this.off(t3, e2),
                  (i.default.array(n3) || i.default.object(n3)) && this.on(t3, n3)
              },
            },
            {
              key: 'setPerAction',
              value: function (t3, e2) {
                ...
                for (var r3 in e2) {
                  var o3 = r3,
                    a2 = this.options[t3],
                    s3 = e2[o3]
                  o3 === 'listeners' && this.updatePerActionListeners(t3, a2.listeners, s3),
                    i.default.array(s3)
                      ? (a2[o3] = Z2.from(s3))
                      : i.default.plainObject(s3)
                      ? ((a2[o3] = (0, j2.default)(a2[o3] || {}, (0, ge.default)(s3))),
                        i.default.object(n3.perAction[o3]) &&
                          'enabled' in n3.perAction[o3] &&
                          (a2[o3].enabled = s3.enabled !== false))
                      : i.default.bool(s3) && i.default.object(n3.perAction[o3])
                      ? (a2[o3].enabled = s3)
                      : (a2[o3] = s3)
                }
              },
            },
            {
              ...
              value: function (t3) {
                return (
                  (t3 = t3 || (i.default.element(this.target) ? this.target : null)),
                  i.default.string(this.target) &&
                    (t3 = t3 || this._context.querySelector(this.target)),
                  (0, _2.getElementRect)(t3)
                )
              },
            },
            {
              ...
              value: function (t3) {
                var e2 = this
                return i.default.func(t3)
                  ? ((this._rectChecker = t3),
                    (this.getRect = function (t4) {
                      var n3 = (0, j2.default)({}, e2._rectChecker(t4))
                      return (
                        'width' in n3 ||
                          ((n3.width = n3.right - n3.left), (n3.height = n3.bottom - n3.top)),
                        n3
                      )
                    }),
                    this)
            ...
            },
            {
              key: 'deltaSource',
              value: function (t3) {
                return t3 === 'page' || t3 === 'client'
                  ? ((this.options.deltaSource = t3), this)
            ...
            },
            {
              ...
              value: function (t3, e2, n3) {
                return (
                  !this.testIgnore(t3.ignoreFrom, e2, n3) && this.testAllow(t3.allowFrom, e2, n3)
                )
              },
            },
            {
              ...
              value: function (t3, e2, n3) {
                return (
                  !t3 ||
                  (!!i.default.element(n3) &&
                    (i.default.string(t3)
                      ? (0, _2.matchesUpTo)(n3, t3, e2)
                      : !!i.default.element(t3) && (0, _2.nodeContains)(t3, n3)))
                )
              },
            },
            {
            ...
            {
              key: '_onOff',
              value: function (t3, e2, n3, r3) {
                i.default.object(e2) && !i.default.array(e2) && ((r3 = n3), (n3 = null))
                var o3 = t3 === 'on' ? 'add' : 'remove',
                  a2 = (0, R3.default)(e2, n3)
                for (var s3 in a2) {
                  s3 === 'wheel' && (s3 = b2.default.wheelEvent)
                  for (var l4 = 0; l4 < a2[s3].length; l4++) {
                    var u3 = a2[s3][l4]
                    ;(0, hn.default)(s3, this._actions)
                      ? this.events[t3](s3, u3)
                      : i.default.string(this.target)
                      ? this._scopeEvents[''.concat(o3, 'Delegate')](
                          this.target,
                          this._context,
                          s3,
                          u3,
                      ...
                      : this._scopeEvents[o3](this.target, s3, u3, r3)
                  }
                }
                return this
              },
            ...
            },
            {
              ...
              value: function (t3) {
                ...
                for (var n3 in (i.default.object(t3) || (t3 = {}),
                (this.options = (0, ge.default)(e2.base)),
                this._actions.methodDict)) {
                  var r3 = n3,
                    o3 = this._actions.methodDict[r3]
                  ;(this.options[r3] = {}),
                    this.setPerAction(
                      r3,
                      (0, j2.default)((0, j2.default)({}, e2.perAction), e2.actions[r3])
                    ),
                    this[o3](t3[r3])
                }
                for (var a2 in t3) i.default.func(this[a2]) && this[a2](t3[a2])
                return this
              },
            },
            {
              ...
              value: function () {
                if (i.default.string(this.target))
                  for (var t3 in this._scopeEvents.delegatedEvents)
                    for (
                      var e2 = this._scopeEvents.delegatedEvents[t3], n3 = e2.length - 1;
                      n3 >= 0;
                      n3--
                    ) {
                      var r3 = e2[n3],
                      ...
                      for (var l4 = s3.length - 1; l4 >= 0; l4--)
      ...
      var On = (function () {
        function t2(e3) {
          ...
          !(function (t3, e4) {
            ...
            (this.scope = e3),
            e3.addListeners({
              'interactable:unset': function (t3) {
                var e4 = t3.interactable,
                  r2 = e4.target,
                  o3 = e4._context,
                  a2 = i.default.string(r2) ? n3.selectorMap[r2] : r2[n3.scope.id],
                  s3 = Z2.findIndex(a2, function (t4) {
          ...
          (n2 = [
            {
              ...
              value: function (t3, e3) {
                ...
                var n3 = new this.scope.Interactable(
                    t3,
                    e3,
                    this.scope.document,
                    this.scope.events
                  ),
                  r2 = { context: n3._context, interactable: n3 }
                return (
                  this.scope.addDocument(n3._doc),
                  this.list.push(n3),
                  i.default.string(t3)
                    ? (this.selectorMap[t3] || (this.selectorMap[t3] = []),
                      this.selectorMap[t3].push(r2))
                    : (n3.target[this.scope.id] ||
                        Object.defineProperty(t3, this.scope.id, { value: [], configurable: true }),
                      t3[this.scope.id].push(r2)),
            ...
            },
            {
              key: 'get',
              value: function (t3, e3) {
                var n3 = (e3 && e3.context) || this.scope.document,
                  r2 = i.default.string(t3),
                  o3 = r2 ? this.selectorMap[t3] : t3[this.scope.id]
                if (!o3) return null
              ...
              value: function (t3, e3) {
                for (var n3 = 0; n3 < this.list.length; n3++) {
                  var r2 = this.list[n3],
                    o3 = void 0
                  if (
                    ((i.default.string(r2.target)
                      ? i.default.element(t3) && _2.matchesSelector(t3, r2.target)
                      : t3 === r2.target) &&
                      r2.inContext(t3) &&
                      (o3 = e3(r2)),
                    o3 !== void 0)
      ...
      function Mn(t2, e2) {
        return (
          ...
          (function (t3, e3) {
            if (t3) {
              if (typeof t3 == 'string') return jn(t3, e3)
              var n2 = Object.prototype.toString.call(t3).slice(8, -1)
              return (
                n2 === 'Object' && t3.constructor && (n2 = t3.constructor.name),
                n2 === 'Map' || n2 === 'Set'
      ...
      function In(t2) {
        if (!i.default.object(t2)) return { capture: !!t2, passive: false }
        ...
        install: function (t2) {
          var e2,
            ...
            a2 = {
              add: s3,
              remove: l4,
              addDelegate: function (t3, e3, n3, i2, a3) {
                var l5 = In(a3)
                if (!r2[n3]) {
                  r2[n3] = []
                  for (var f3 = 0; f3 < o3.length; f3++) {
                    var d3 = o3[f3]
                    s3(d3, n3, u3), s3(d3, n3, c3, true)
                  }
                }
                var p3 = r2[n3],
                  v3 = Z2.find(p3, function (n4) {
                    return n4.selector === t3 && n4.context === e3
                  })
                v3 || ((v3 = { selector: t3, context: e3, listeners: [] }), p3.push(v3)),
                  v3.listeners.push([i2, l5])
              },
                    ...
                    if (p3.selector === t3 && p3.context === e3) {
                      for (var v3 = p3.listeners, h3 = v3.length - 1; h3 >= 0; h3--) {
                        ...
                        if (y3 === o4 && b3 === s4.capture && x3 === s4.passive) {
                          v3.splice(h3, 1),
                            v3.length || (f3.splice(a3, 1), l4(e3, n3, u3), l4(e3, n3, c3, true)),
                            (d3 = true)
                          break
                        }
                      }
          ...
          function s3(t3, e3, r3, o4) {
            var i2 = In(o4),
              s4 = Z2.find(n2, function (e4) {
                return e4.eventTarget === t3
              })
            s4 || ((s4 = { eventTarget: t3, events: {} }), n2.push(s4)),
              s4.events[e3] || (s4.events[e3] = []),
              t3.addEventListener &&
                !Z2.contains(s4.events[e3], r3) &&
                (t3.addEventListener(e3, r3, a2.supportsOptions ? i2 : i2.capture),
                s4.events[e3].push(r3))
          }
          __name(s3, 's')
          function l4(t3, e3, r3, o4) {
            var i2 = In(o4),
              s4 = Z2.findIndex(n2, function (e4) {
                return e4.eventTarget === t3
              }),
              u4 = n2[s4]
            if (u4 && u4.events)
              if (e3 !== 'all') {
                ...
                if (f3) {
                  if (r3 === 'all') {
                    for (var d3 = f3.length - 1; d3 >= 0; d3--) l4(t3, e3, f3[d3], i2)
                    return
                  }
                  for (var p3 = 0; p3 < f3.length; p3++)
                    if (f3[p3] === r3) {
                      t3.removeEventListener(e3, r3, a2.supportsOptions ? i2 : i2.capture),
                        f3.splice(p3, 1),
                        f3.length === 0 && (delete u4.events[e3], (c4 = true))
                      break
                    }
                }
                c4 && !Object.keys(u4.events).length && n2.splice(s4, 1)
              } else for (e3 in u4.events) u4.events.hasOwnProperty(e3) && l4(t3, e3, 'all')
          }
          __name(l4, 'l')
          function u3(t3, e3) {
            for (
              var n3 = In(e3),
                o4 = new kn(t3),
                a3 = r2[t3.type],
                s4 = Mn(B2.getEventTargets(t3), 1)[0],
                l5 = s4;
              i.default.element(l5);
              ...
              for (var u4 = 0; u4 < a3.length; u4++) {
                var c4 = a3[u4],
                  ...
                  d3 = c4.context
                if (
                  _2.matchesSelector(l5, f3) &&
                  _2.nodeContains(d3, s4) &&
                  _2.nodeContains(d3, l5)
                ) {
                  var p3 = c4.listeners
                  o4.currentTarget = l5
          ...
          return (
            (e2 = t2.document) == null ||
              e2.createElement('div').addEventListener('test', null, {
                get capture() {
      ...
      var Rn = {
        ...
        mouseOrPen: function (t2) {
          ...
          for (var l4 = 0; l4 < i2.interactions.list.length; l4++) {
            ...
            if (!(u3.pointerType !== r2 || (/down/i.test(o3) && u3.simulation))) return u3
          }
          return null
        },
        hasPointer: function (t2) {
          for (
            var e2 = t2.pointerId, n2 = t2.scope, r2 = 0;
            r2 < n2.interactions.list.length;
            r2++
          ) {
            var o3 = n2.interactions.list[r2]
            if (zn(o3, e2)) return o3
          }
          return null
        },
        idle: function (t2) {
          for (
            var e2 = t2.pointerType, n2 = t2.scope, r2 = 0;
            r2 < n2.interactions.list.length;
            r2++
          ) {
            var o3 = n2.interactions.list[r2]
            if (o3.pointers.length === 1) {
              ...
              if (i2 && (!i2.options.gesture || !i2.options.gesture.enabled)) continue
            } else if (o3.pointers.length >= 2) continue
            if (!o3.interacting() && e2 === o3.pointerType) return o3
          }
          return null
        },
      }
      ...
      function Yn(t2, e2) {
        return (
          ...
          (function (t3, e3) {
            if (t3) {
              if (typeof t3 == 'string') return Bn(t3, e3)
              var n2 = Object.prototype.toString.call(t3).slice(8, -1)
              return (
                n2 === 'Object' && t3.constructor && (n2 = t3.constructor.name),
                n2 === 'Map' || n2 === 'Set'
      ...
      __name(Un, 'Un')
      function Vn(t2, e2) {
        return !e2 || (Xn(e2) !== 'object' && typeof e2 != 'function')
          ? (function (t3) {
              if (t3 === void 0)
      ...
      function $n(t2, e2) {
        return function (n2) {
          var r2 = e2.interactions.list,
            o3 = B2.getPointerType(n2),
            i2 = Yn(B2.getEventTargets(n2), 2),
            a2 = i2[0],
            s3 = i2[1],
            l4 = []
          if (/^touch/.test(n2.type)) {
            ...
            for (var u3 = 0; u3 < n2.changedTouches.length; u3++) {
              var c3 = n2.changedTouches[u3],
                f3 = {
                  pointer: c3,
                  pointerId: B2.getPointerId(c3),
                  pointerType: o3,
                  eventType: n2.type,
                  eventTarget: a2,
                  curEventTarget: s3,
            ...
            if (!b2.default.supportsPointerEvent && /mouse/.test(n2.type)) {
              for (var v3 = 0; v3 < r2.length && !p3; v3++)
                p3 = r2[v3].pointerType !== 'mouse' && r2[v3].pointerIsDown
              p3 = p3 || e2.now() - e2.prevTouchTime < 500 || n2.timeStamp === 0
            }
            if (!p3) {
              var h3 = {
                  pointer: n2,
                  pointerId: B2.getPointerId(n2),
                  pointerType: o3,
                  eventType: n2.type,
                  curEventTarget: s3,
                  eventTarget: a2,
      ...
      function Gn(t2) {
        var e2 = t2.pointerType,
          n2 = t2.scope,
          r2 = { interaction: An.default.search(t2), searchDetails: t2 }
        return (
          n2.fire('interactions:find', r2),
          r2.interaction || n2.interactions.new({ pointerType: e2 })
        )
      }
      __name(Gn, 'Gn')
      function Hn(t2, e2) {
        var n2 = t2.doc,
          r2 = t2.scope,
          o3 = t2.options,
          i2 = r2.interactions.docEvents,
          a2 = r2.events,
          s3 = a2[e2]
        for (var l4 in (r2.browser.isIOS && !o3.events && (o3.events = { passive: false }),
        a2.delegatedEvents))
          s3(n2, l4, a2.delegateListener), s3(n2, l4, a2.delegateUseCapture, true)
        for (var u3 = o3 && o3.events, c3 = 0; c3 < i2.length; c3++) {
          var f3 = i2[c3]
          s3(n2, f3.type, f3.listener, u3)
        }
      }
      __name(Hn, 'Hn')
      var Kn = {
        ...
        install: function (t2) {
          ...
          __name(a2, 'a')
          ;(o3 = h2.default.PointerEvent
            ? [
                { type: i2.down, listener: a2 },
                { type: i2.down, listener: e2.pointerDown },
                { type: i2.move, listener: e2.pointerMove },
                { type: i2.up, listener: e2.pointerUp },
                { type: i2.cancel, listener: e2.pointerUp },
              ]
            : [
                { type: 'mousedown', listener: e2.pointerDown },
                { type: 'mousemove', listener: e2.pointerMove },
                { type: 'mouseup', listener: e2.pointerUp },
                { type: 'touchstart', listener: a2 },
                { type: 'touchstart', listener: e2.pointerDown },
                { type: 'touchmove', listener: e2.pointerMove },
                { type: 'touchend', listener: e2.pointerUp },
                { type: 'touchcancel', listener: e2.pointerUp },
              ]).push({
            type: 'blur',
            ...
            (t2.prevTouchTime = 0),
            (t2.Interaction = (function (e3) {
              !(function (t3, e4) {
                if (typeof e4 != 'function' && e4 !== null)
                  throw new TypeError('Super expression must either be null or a function')
                ;(t3.prototype = Object.create(e4 && e4.prototype, {
                  constructor: { value: t3, writable: true, configurable: true },
                })),
                  e4 && Un(t3, e4)
              })(s3, e3)
              var n3,
                ...
                a3 =
                  ...
                  function () {
                    ...
                    } else t3 = e4.apply(this, arguments)
                    return Vn(this, t3)
                  })
              function s3() {
        ...
        listeners: {
          ...
          'interactable:unset': function (t2, e2) {
            for (var n2 = t2.interactable, r2 = e2.interactions.list.length - 1; r2 >= 0; r2--) {
              ...
              o3.interactable === n2 &&
                (o3.stop(),
                e2.fire('interactions:destroy', { interaction: o3 }),
                o3.destroy(),
                e2.interactions.list.length > 2 && e2.interactions.list.splice(r2, 1))
            }
          },
        },
        onDocSignal: Hn,
      ...
      __name(tr, 'tr')
      function er(t2, e2) {
        return !e2 || (Jn(e2) !== 'object' && typeof e2 != 'function')
          ? (function (t3) {
              if (t3 === void 0)
                throw new ReferenceError(
                  "this hasn't been initialised - super() hasn't been called"
      ...
      var sr = (function () {
        function t2() {
          ...
          rr(this, t2),
            ...
            ar(this, 'isInitialized', false),
            ar(this, 'listenerMaps', []),
            ar(this, 'browser', b2.default),
            ar(this, 'defaults', (0, ge.default)(Me3.defaults)),
            ar(this, 'Eventable', cn.Eventable),
            ar(this, 'actions', {
              map: {},
              phases: { start: true, move: true, end: true },
              methodDict: {},
              phaselessTypes: {},
            }),
            ...
            ar(this, 'onWindowUnload', function (t3) {
          ...
          this.Interactable = (function (t3) {
            !(function (t4, e4) {
              ...
              ;(t4.prototype = Object.create(e4 && e4.prototype, {
                constructor: { value: t4, writable: true, configurable: true },
              })),
                e4 && tr(t4, e4)
            })(i2, t3)
            var e3,
              ...
              o3 =
                ...
                function () {
                  ...
                  } else t4 = n3.apply(this, arguments)
                  return er(this, t4)
                })
            function i2() {
            ...
            return (
              ir(i2, [
                ...
                },
                {
                  ...
                  value: function (t4) {
                    return (
                      Qn(nr(i2.prototype), 'set', this).call(this, t4),
                      n2.fire('interactable:set', { options: t4, interactable: this }),
                      this
                    )
                  },
                },
                {
                  key: 'unset',
                  value: function () {
                    Qn(nr(i2.prototype), 'unset', this).call(this),
                      n2.interactables.list.splice(n2.interactables.list.indexOf(this), 1),
                      n2.fire('interactable:unset', { interactable: this })
                  },
                },
              ]),
              i2
          ...
          ir(t2, [
            ...
            },
            {
              ...
              value: function (t3, e2) {
                for (var n2 = 0; n2 < this.listenerMaps.length; n2++) {
                  ...
                  if (r2 && r2(e2, this, t3) === false) return false
                }
              },
            },
            {
            ...
            },
            {
              ...
              value: function (t3, e2) {
                ...
                if (
                  (t3.id && (this._plugins.map[t3.id] = t3),
                  this._plugins.list.push(t3),
                  t3.install && t3.install(this, e2),
                  t3.listeners && t3.before)
                ) {
                  for (
                    var n2 = 0,
                      r2 = this.listenerMaps.length,
                      o3 = t3.before.reduce(function (t4, e3) {
            ...
            },
            {
              ...
              value: function (t3, n2) {
                if (this.getDocIndex(t3) !== -1) return false
                var r2 = e.getWindow(t3)
                ;(n2 = n2 ? (0, j2.default)({}, n2) : {}),
                  this.documents.push({ doc: t3, options: n2 }),
                  this.events.documents.push(t3),
                  t3 !== this.document && this.events.add(r2, 'unload', this.onWindowUnload),
                  this.fire('scope:add-document', { doc: t3, window: r2, scope: this, options: n2 })
              },
            },
            {
              key: 'removeDocument',
              value: function (t3) {
                var n2 = this.getDocIndex(t3),
                  r2 = e.getWindow(t3),
                  o3 = this.documents[n2].options
                this.events.remove(r2, 'unload', this.onWindowUnload),
                  this.documents.splice(n2, 1),
                  this.events.documents.splice(n2, 1),
            ...
            },
            {
              ...
              value: function (t3) {
                for (var e2 = 0; e2 < this.documents.length; e2++)
                  if (this.documents[e2].doc === t3) return e2
                return -1
              },
            },
            {
      ...
      function lr(t2, n2) {
        return (
          (t2.isInitialized = true),
          i.default.window(n2) && e.init(n2),
          h2.default.init(n2),
          b2.default.init(n2),
          jt2.default.init(n2),
          (t2.window = n2),
          (t2.document = n2.document),
          t2.usePlugin(Fn.default),
          t2.usePlugin(Sn.default),
          t2
        )
      }
      __name(lr, 'lr')
      ...
      function yr(t2, e2) {
        return (
          ...
          (function (t3, e3) {
            if (t3) {
              if (typeof t3 == 'string') return mr(t3, e3)
              var n2 = Object.prototype.toString.call(t3).slice(8, -1)
              return (
                n2 === 'Object' && t3.constructor && (n2 = t3.constructor.name),
                n2 === 'Map' || n2 === 'Set'
            ...
            n2 = /* @__PURE__ */ __name(function (n3, r2) {
              for (
                var o3 = t2.range,
                  i2 = t2.limits,
                  a2 =
                    i2 === void 0 ? { left: -1 / 0, right: 1 / 0, top: -1 / 0, bottom: 1 / 0 } : i2,
                  s3 = t2.offset,
                  l4 = s3 === void 0 ? { x: 0, y: 0 } : s3,
                  u3 = { range: o3, grid: t2, x: null, y: null },
                  c3 = 0;
                c3 < e2.length;
                c3++
              ) {
                var f3 = yr(e2[c3], 2),
                  d3 = f3[0],
                  p3 = f3[1],
                  v3 = Math.round((n3 - l4.x) / t2[d3]),
                  h3 = Math.round((r2 - l4.y) / t2[p3])
                ;(u3[d3] = Math.max(a2.left, Math.min(a2.right, v3 * t2[d3] + l4.x))),
                  (u3[p3] = Math.max(a2.top, Math.min(a2.bottom, h3 * t2[p3] + l4.y)))
              }
              return u3
            }, 'n')
      ...
      var wr = {
        ...
        install: function (t2) {
          var e2 = t2.interactStatic
          ;(e2.snappers = (0, j2.default)(e2.snappers || {}, br)),
            (e2.createSnapGrid = e2.snappers.grid)
        },
      }
      xr.default = wr
      var _r = {}
      ...
      function Or(t2) {
        for (var e2 = 1; e2 < arguments.length; e2++) {
          ...
          e2 % 2
            ? Pr(Object(n2), true).forEach(function (e3) {
                Sr(t2, e3, n2[e3])
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(t2, Object.getOwnPropertyDescriptors(n2))
            : Pr(Object(n2)).forEach(function (e3) {
      ...
      var Er = {
        start: function (t2) {
          var e2 = t2.state,
            ...
            s3 = a2.equalDelta,
            l4 = a2.modifiers
          i2 === 'preserve' && (i2 = n2.width / n2.height),
            (e2.startCoords = (0, j2.default)({}, o3)),
            (e2.startRect = (0, j2.default)({}, n2)),
            (e2.ratio = i2),
            (e2.equalDelta = s3)
          var u3 = (e2.linkedEdges = {
            top: r2.top || (r2.left && !r2.bottom),
            left: r2.left || (r2.top && !r2.right),
            bottom: r2.bottom || (r2.right && !r2.top),
            right: r2.right || (r2.bottom && !r2.left),
          })
          ...
          if (((0, j2.default)(t2.edges, u3), l4 && l4.length)) {
            ...
            f3.copyFrom(t2.interaction.modification),
              f3.prepareStates(l4),
              (e2.subModification = f3),
              f3.startAll(Or({}, t2))
          }
        },
        set: function (t2) {
          var e2 = t2.state,
            ...
            r2 = t2.coords,
            o3 = (0, j2.default)({}, r2),
            i2 = e2.equalDelta ? Tr : Mr
          if ((i2(e2, e2.xIsPrimaryAxis, r2, n2), !e2.subModification)) return null
          var a2 = (0, j2.default)({}, n2)
          ;(0, k2.addEdges)(e2.linkedEdges, a2, { x: r2.x - o3.x, y: r2.y - o3.y })
          var s3 = e2.subModification.setAll(
              Or(
                Or({}, t2),
                {},
                { rect: a2, edges: e2.linkedEdges, pageCoords: r2, prevCoords: r2, prevRect: a2 }
              )
            ),
            l4 = s3.delta
          return (
            s3.changed &&
              (i2(e2, Math.abs(l4.x) > Math.abs(l4.y), s3.coords, s3.rect),
              (0, j2.default)(r2, s3.coords)),
            s3.eventProps
          )
        },
      ...
      function Mr(t2, e2, n2, r2) {
        ...
        if (e2) {
          var l4 = r2.width / a2
          n2.y = i2.y + (l4 - o3.height) * s3
        } else {
          var u3 = r2.height * a2
          n2.x = i2.x + (u3 - o3.width) * s3
        }
      }
      __name(Mr, 'Mr')
      _r.aspectRatio = Er
      ...
      var Ir = /* @__PURE__ */ __name(function () {}, 'Ir')
      Ir._defaults = {}
      var Dr = Ir
      kr.default = Dr
      var Ar = {}
      ...
      function zr(t2, e2, n2) {
        return i.default.func(t2)
          ? k2.resolveRectLike(t2, e2.interactable, e2.element, [n2.x, n2.y, e2])
          : k2.resolveRectLike(t2, e2.interactable, e2.element)
      }
      __name(zr, 'zr')
      ...
      var Cr = {
        start: function (t2) {
          var e2 = t2.rect,
            ...
            a2 = r2.options,
            s3 = a2.elementRect,
            l4 = (0, j2.default)({ left: 0, top: 0, right: 0, bottom: 0 }, a2.offset || {})
          if (e2 && s3) {
            var u3 = zr(a2.restriction, o3, i2)
            if (u3) {
              var c3 = u3.right - u3.left - e2.width,
                f3 = u3.bottom - u3.top - e2.height
              c3 < 0 && ((l4.left += c3), (l4.right += c3)),
                f3 < 0 && ((l4.top += f3), (l4.bottom += f3))
            }
            ;(l4.left += n2.left - e2.width * s3.left),
              (l4.top += n2.top - e2.height * s3.top),
              (l4.right += n2.right - e2.width * (1 - s3.right)),
              (l4.bottom += n2.bottom - e2.height * (1 - s3.bottom))
          }
          r2.offset = l4
        },
        set: function (t2) {
          var e2 = t2.coords,
            ...
            o3 = r2.options,
            i2 = r2.offset,
            a2 = zr(o3.restriction, n2, e2)
          if (a2) {
            var s3 = k2.xywhToTlbr(a2)
            ;(e2.x = Math.max(Math.min(s3.right - i2.right, e2.x), s3.left + i2.left)),
              (e2.y = Math.max(Math.min(s3.bottom - i2.bottom, e2.y), s3.top + i2.top))
          }
        },
        defaults: {
          restriction: null,
      ...
      var Lr = {
        ...
        set: function (t2) {
          var e2 = t2.coords,
            ...
            a2 = o3.options
          if (n2) {
            var s3 = (0, j2.default)({}, e2),
              l4 = (0, Rr.getRestrictionRect)(a2.inner, r2, s3) || {},
              u3 = (0, Rr.getRestrictionRect)(a2.outer, r2, s3) || {}
            Wr(l4, Yr),
              Wr(u3, Br),
              n2.top
                ? (e2.y = Math.min(Math.max(u3.top + i2.top, s3.y), l4.top + i2.top))
                : n2.bottom &&
                  (e2.y = Math.max(Math.min(u3.bottom + i2.bottom, s3.y), l4.bottom + i2.bottom)),
              n2.left
                ? (e2.x = Math.min(Math.max(u3.left + i2.left, s3.x), l4.left + i2.left))
                : n2.right &&
                  (e2.x = Math.max(Math.min(u3.right + i2.right, s3.x), l4.right + i2.right))
          }
        },
        ...
        Zr = {
          ...
          set: function (t2) {
            var e2 = t2.interaction,
              ...
              i2 = n2.options
            if (o3) {
              var a2 = k2.tlbrToXywh((0, Rr.getRestrictionRect)(i2.min, e2, t2.coords)) || Hr,
                s3 = k2.tlbrToXywh((0, Rr.getRestrictionRect)(i2.max, e2, t2.coords)) || Kr
              ;(n2.options = {
                endOnly: i2.endOnly,
                inner: (0, j2.default)({}, Xr.restrictEdges.noInner),
                outer: (0, j2.default)({}, Xr.restrictEdges.noOuter),
              }),
                o3.top
                  ? ((n2.options.inner.top = r2.bottom - a2.height),
                    (n2.options.outer.top = r2.bottom - s3.height))
                  : o3.bottom &&
                    ((n2.options.inner.bottom = r2.top + a2.height),
                    (n2.options.outer.bottom = r2.top + s3.height)),
                o3.left
                  ? ((n2.options.inner.left = r2.right - a2.width),
                    (n2.options.outer.left = r2.right - s3.width))
                  : o3.right &&
                    ((n2.options.inner.right = r2.left + a2.width),
                    (n2.options.outer.right = r2.left + s3.width)),
                Xr.restrictEdges.set(t2),
                (n2.options = i2)
            }
          },
      ...
      var to2 = {}
      Object.defineProperty(to2, '__esModule', { value: true }), (to2.snap = to2.default = void 0)
      var eo = {
        start: function (t2) {
          var e2,
            n2 = t2.interaction,
            ...
            s3 = t2.startOffset,
            l4 = a2.options,
            u3 = l4.offsetWithOrigin
              ? (function (t3) {
                  var e3 = t3.interaction.element
                  return (
                    (0, k2.rectToXY)(
                      (0, k2.resolveRectLike)(t3.state.options.origin, null, null, [e3])
                    ) || (0, A3.default)(t3.interactable, e3, t3.interaction.prepared.name)
                  )
                })(t2)
              : { x: 0, y: 0 }
          ...
          a2.offsets =
            i2 && f3 && f3.length
              ? f3.map(function (t3, n3) {
                  return {
                    index: n3,
                    relativePoint: t3,
                    x: s3.left - i2.width * t3.x + e2.x,
                    y: s3.top - i2.height * t3.y + e2.y,
                  }
                })
        ...
        set: function (t2) {
          var e2 = t2.interaction,
            ...
            o3 = r2.options,
            a2 = r2.offsets,
            s3 = (0, A3.default)(e2.interactable, e2.element, e2.prepared.name),
            l4 = (0, j2.default)({}, n2),
            u3 = []
          o3.offsetWithOrigin || ((l4.x -= s3.x), (l4.y -= s3.y))
          for (var c3 = 0; c3 < a2.length; c3++)
            for (
              var f3 = a2[c3], d3 = l4.x - f3.x, p3 = l4.y - f3.y, v3 = 0, h3 = o3.targets.length;
              v3 < h3;
              v3++
            ) {
              var g3,
                y3 = o3.targets[v3]
              ;(g3 = i.default.func(y3) ? y3(d3, p3, e2._proxy, f3, v3) : y3) &&
                u3.push({
                  x: (i.default.number(g3.x) ? g3.x : d3) + f3.x,
                  y: (i.default.number(g3.y) ? g3.y : p3) + f3.y,
                  range: i.default.number(g3.range) ? g3.range : o3.range,
                  source: y3,
                  index: v3,
                  offset: f3,
                })
          ...
          for (
            var m3 = { target: null, inRange: false, distance: 0, range: 0, delta: { x: 0, y: 0 } },
              b3 = 0;
            b3 < u3.length;
            b3++
          ) {
            var x3 = u3[b3],
              ...
              _3 = x3.x - l4.x,
              P3 = x3.y - l4.y,
              O4 = (0, C2.default)(_3, P3),
              S3 = O4 <= w3
            w3 === 1 / 0 && m3.inRange && m3.range !== 1 / 0 && (S3 = false),
              (m3.target &&
                !(S3
                  ? m3.inRange && w3 !== 1 / 0
                    ? O4 / w3 < m3.distance / m3.range
                    : (w3 === 1 / 0 && m3.range !== 1 / 0) || O4 < m3.distance
                  : !m3.inRange && O4 < m3.distance)) ||
                ((m3.target = x3),
                (m3.distance = O4),
                (m3.range = w3),
                (m3.inRange = S3),
      ...
      var io = {
        start: function (t2) {
          ...
          ;(t2.state = {
            options: {
              targets: null,
              relativePoints: [{ x: n2.left ? 0 : 1, y: n2.top ? 0 : 1 }],
              offset: r2.offset || 'self',
              origin: { x: 0, y: 0 },
              range: r2.range,
            },
          }),
            (e2.targetFields = e2.targetFields || [
              ['width', 'height'],
              ['x', 'y'],
            ]),
            to2.snap.start(t2),
            (e2.offsets = t2.state.offsets),
            (t2.state = e2)
        },
        set: function (t2) {
          var e2,
                    ...
                    (function (t3) {
                      ...
                      (function (t3, e3) {
                        if (typeof Symbol != 'undefined' && Symbol.iterator in Object(t3)) {
                          ...
                          try {
                            for (
                              var a3, s4 = t3[Symbol.iterator]();
                              !(r3 = (a3 = s4.next()).done) &&
                              (n3.push(a3.value), !e3 || n3.length !== e3);
                              r3 = true
                            );
                          } catch (t4) {
                            ;(o4 = true), (i2 = t4)
                      ...
                      (function (t3, e3) {
                        if (t3) {
                          if (typeof t3 == 'string') return oo(t3, e3)
                          var n3 = Object.prototype.toString.call(t3).slice(8, -1)
                          return (
                            n3 === 'Object' && t3.constructor && (n3 = t3.constructor.name),
                            n3 === 'Map' || n3 === 'Set'
      ...
      var lo = {
        start: function (t2) {
          var e2 = t2.edges
          return e2
            ? ((t2.state.targetFields = t2.state.targetFields || [
                [e2.left ? 'left' : 'right', e2.top ? 'top' : 'bottom'],
              ]),
              ro.snapSize.start(t2))
            : null
        },
        set: ro.snapSize.set,
        defaults: (0, j2.default)((0, ge.default)(ro.snapSize.defaults), {
          targets: null,
          range: null,
          offset: { x: 0, y: 0 },
        }),
      ...
      var go = {
        ...
        install: function (t2) {
          var e2 = t2.interactStatic
          for (var n2 in (t2.usePlugin(Se3.default),
          t2.usePlugin(xr.default),
          (e2.modifiers = po.default),
          po.default)) {
            var r2 = po.default[n2],
              o3 = r2._defaults,
              i2 = r2._methods
      ...
      var So = (function (t2) {
        ...
        function a2(t3, e3, n3, r3, o4, s3) {
          ...
          if (
            ...
            Oo(_o((l4 = i2.call(this, o4))), 'type', void 0),
            Oo(_o(l4), 'originalEvent', void 0),
            Oo(_o(l4), 'pointerId', void 0),
            Oo(_o(l4), 'pointerType', void 0),
            Oo(_o(l4), 'double', void 0),
            Oo(_o(l4), 'pageX', void 0),
            Oo(_o(l4), 'pageY', void 0),
            Oo(_o(l4), 'clientX', void 0),
            Oo(_o(l4), 'clientY', void 0),
            Oo(_o(l4), 'dt', void 0),
            Oo(_o(l4), 'eventable', void 0),
            B2.pointerExtend(_o(l4), n3),
            n3 !== e3 && B2.pointerExtend(_o(l4), e3),
            (l4.timeStamp = s3),
            (l4.originalEvent = n3),
            (l4.type = t3),
            (l4.pointerId = B2.getPointerId(e3)),
            (l4.pointerType = B2.getPointerType(e3)),
            (l4.target = r3),
            (l4.currentTarget = null),
            t3 === 'tap')
          ) {
            ...
            l4.double = !!(
              o4.prevTap &&
              o4.prevTap.type !== 'doubletap' &&
              o4.prevTap.target === l4.target &&
              c3 < 500
            )
          } else t3 === 'doubletap' && (l4.dt = e3.timeStamp - o4.tapTime)
          return l4
        }
        __name(a2, 'a')
        return (
      ...
      var To = {
        ...
        install: function (t2) {
          ;(t2.pointerEvents = To),
            (t2.defaults.actions.pointerEvents = To.defaults),
            (0, j2.default)(t2.actions.phaselessTypes, To.types)
        },
        listeners: {
          'interactions:new': function (t2) {
            var e2 = t2.interaction
          ...
          'interactions:move': function (t2, e2) {
            var n2 = t2.interaction,
              ...
              i2 = t2.eventTarget
            t2.duplicate ||
              (n2.pointerIsDown && !n2.pointerWasMoved) ||
              (n2.pointerIsDown && ko(t2),
              Mo({ interaction: n2, pointer: r2, event: o3, eventTarget: i2, type: 'move' }, e2))
          },
          'interactions:down': function (t2, e2) {
            !(function (t3, e3) {
              for (
              ...
              if (u3.targets.length) {
                ...
                ;(s3.duration = d3),
                  (s3.timeout = setTimeout(function () {
                    Mo(
                      { interaction: n2, eventTarget: i2, pointer: r2, event: o3, type: 'hold' },
                      e3
                    )
                  }, d3))
              }
            ...
            ko(t2),
              ...
              (function (t3, e3) {
                var n2 = t3.interaction,
                  ...
                  i2 = t3.eventTarget
                n2.pointerWasMoved ||
                  Mo({ interaction: n2, eventTarget: i2, pointer: r2, event: o3, type: 'tap' }, e3)
              })(t2, e2)
          },
      ...
      function Mo(t2, e2) {
        var n2 = t2.interaction,
          ...
          a2 = t2.type,
          s3 = t2.targets,
          l4 = s3 === void 0 ? jo(t2, e2) : s3,
          u3 = new yo.PointerEvent(a2, r2, o3, i2, n2, e2.now())
        ...
        for (
          ...
          var d3 = l4[f3]
          for (var p3 in d3.props || {}) u3[p3] = d3.props[p3]
          var v3 = (0, A3.default)(d3.eventable, d3.node)
          if (
            (u3._subtractOrigin(v3),
            (u3.eventable = d3.eventable),
            (u3.currentTarget = d3.node),
            d3.eventable.fire(u3),
            u3._addOrigin(v3),
            u3.immediatePropagationStopped ||
              (u3.propagationStopped && f3 + 1 < l4.length && l4[f3 + 1].node !== u3.currentTarget))
          )
            break
        }
        if ((e2.fire('pointerEvents:fired', c3), a2 === 'tap')) {
          var h3 = u3.double
            ? Mo(
                { interaction: n2, pointer: r2, event: o3, eventTarget: i2, type: 'doubletap' },
                e2
              )
            : u3
      ...
      function jo(t2, e2) {
        var n2 = t2.interaction,
          ...
          i2 = t2.eventTarget,
          a2 = t2.type,
          s3 = n2.getPointerIndex(r2),
          l4 = n2.pointers[s3]
        if (a2 === 'tap' && (n2.pointerWasMoved || !l4 || l4.downTarget !== i2)) return []
        for (
          var u3 = _2.getPath(i2),
            c3 = {
              interaction: n2,
              pointer: r2,
              event: o3,
        ...
        return (
          a2 === 'hold' &&
            (c3.targets = c3.targets.filter(function (t3) {
              var e3
              return (
                t3.eventable.options.holdDuration ===
                ((e3 = n2.pointers[s3]) == null ? void 0 : e3.hold.duration)
              )
            })),
          c3.targets
        )
      ...
      function Ao(t2) {
        var e2 = t2.interaction
        e2.holdIntervalHandle &&
          (clearInterval(e2.holdIntervalHandle), (e2.holdIntervalHandle = null))
      }
      __name(Ao, 'Ao')
      ...
      var Ro = {
        ...
        install: function (t2) {
          ...
          ;(e2.defaults.holdRepeatInterval = 0),
            (e2.types.holdrepeat = t2.actions.phaselessTypes.holdrepeat = true)
        },
          ...
          },
          {
            ...
            'pointerEvents:fired': function (t2, e2) {
              ...
              if (r2.type === 'hold' && i2.length) {
                ...
                a2 <= 0 ||
                  (n2.holdIntervalHandle = setTimeout(function () {
                    e2.pointerEvents.fire(
                      { interaction: n2, eventTarget: o3, type: 'hold', pointer: r2, event: r2 },
                      e2
                    )
                  }, a2))
              }
        ...
        listeners: {
          'pointerEvents:collect-targets': function (t2, e2) {
            ...
            e2.interactables.forEachMatch(r2, function (t3) {
              ...
              e3.types[o3] &&
                e3.types[o3].length &&
                t3.testIgnoreAllow(a2, r2, i2) &&
                n2.push({ node: r2, eventable: e3, props: { interactable: t3 } })
            })
          },
          ...
          'interactable:set': function (t2, e2) {
            var n2 = t2.interactable,
              r2 = t2.options
            ;(0, j2.default)(n2.events.options, e2.pointerEvents.defaults),
              (0, j2.default)(n2.events.options, r2.pointerEvents || {})
          },
        },
      }
      zo.default = Fo
      ...
      function Wo(t2) {
        var e2 = t2.Interactable
        ;(t2.actions.phases.reflow = true),
          (e2.prototype.reflow = function (e3) {
            return (function (t3, e4, n2) {
              for (
                var r2 = i.default.string(t3.target)
                    ? Z2.from(t3._context.querySelectorAll(t3.target))
                    : [t3.target],
                  o3 = n2.window.Promise,
                  a2 = o3 ? [] : null,
                  s3 = function () {
                    var i2 = r2[l4],
                      s4 = t3.getRect(i2)
                    ...
                    if (u3)
                      ...
                      var f3 = (0, k2.tlbrToXywh)(s4),
                        d3 = {
                          page: { x: f3.x, y: f3.y },
                          client: { x: f3.x, y: f3.y },
                          timeStamp: n2.now(),
                        },
                        p3 = B2.coordsToEvent(d3)
                      c3 = (function (t4, e5, n3, r3, o4) {
                        var i3 = t4.interactions.new({ pointerType: 'reflow' }),
                          a3 = {
                            interaction: i3,
                            event: o4,
                            pointer: o4,
                        ...
                        ;(i3.interactable = e5),
                          (i3.element = n3),
                          (i3.prevEvent = o4),
                          i3.updatePointer(o4, o4, n3, true),
                          B2.setZeroCoords(i3.coords.delta),
                          (0, Yt.copyAction)(i3.prepared, r3),
                          i3._doPhase(a3)
                        var s5 = t4.window.Promise,
                          l5 = s5
                            ? new s5(function (t5) {
                            ...
                            : void 0
                        return (
                          (i3._reflowPromise = l5),
                          i3.start(r3, e5, n3),
                          i3._interacting
                            ? (i3.move(a3), i3.end(o4))
                            : (i3.stop(), i3._reflowResolve()),
                          i3.removePointer(o4, o4),
                          l5
                        )
                      })(n2, t3, i2, e4, p3)
                    }
                  ...
                  l4 = 0;
                l4 < r2.length && s3() !== 'break';
                l4++
              );
              return (
                a2 &&
                o3.all(a2).then(function () {
                  return t3
                })
              )
            })(this, e3, t2)
      ...
      var Lo = {
        ...
        listeners: {
          'interactions:stop': function (t2, e2) {
            var n2 = t2.interaction
            n2.pointerType === 'reflow' &&
              (n2._reflowResolve && n2._reflowResolve(), Z2.remove(e2.interactions.list, n2))
          },
        },
      }
      Bo.default = Lo
      ...
      __name(Vo, 'Vo')
      Object.defineProperty(Uo.exports, '__esModule', { value: true }),
        (Uo.exports.default = void 0),
        cr.default.use(se2.default),
        cr.default.use(Ge2.default),
        cr.default.use(Xo.default),
        cr.default.use(en.default),
        cr.default.use(ho.default),
        cr.default.use(ie.default),
        cr.default.use(Tt2.default),
      ...
      __name($o, '$o')
      Object.defineProperty(qo.exports, '__esModule', { value: true }),
...
function X(t) {
  ...
  if (r.length === 2) return parseInt(r[1])
...
function J(t) {
  try {
    let e = l(t),
      n = new import_fraction.default(e).toFraction().split('/'),
      i
    return (
      n[0] === '0'
        ? (i = '0')
...
function O(t, e) {
  if (e === 0) return I
  if (t instanceof Map) return G(t, e)
  if (t instanceof Set) return R(t, e)
  if (((n) => n[Symbol.iterator] !== void 0)(t)) return N(t, e)
}
__name(O, 'O')
function F(t, e) {
  let r = String(t)
...
var u = /* @__PURE__ */ __name(
  class {
    static parseFloat(e) {
      if (e.length === 0) throw new Error(`Not a number: '${e}'`)
      if (e[0] === '-') return -u.parseFloat(e.substr(1))
      if (e[0] === '\u221A') return Math.sqrt(u.parseFloat(e.substr(1)))
      let r = u.matchUnicodeFraction((i) => i.character === e)
      if (r !== void 0) return r.value
      let n = parseFloat(e)
      if (isNaN(n)) throw new Error(`Not a number: '${e}'`)
      return n
    }
    static simplifyByRounding(e, r) {
      if (e < 0) return -u.simplifyByRounding(-e, r)
      let n = e % 1
      if (n <= r || 1 - n <= r) return Math.round(e)
    ...
    static matchUnicodeFraction(e) {
      for (let r of D) if (e(r)) return r
    }
    constructor(e, r, n, i) {
      ;(this.allowAbbreviation = e),
        (this.maxAbbreviationError = r),
        (this.fixedDigits = n),
        (this.itemSeparator = i)
    }
    formatFloat(e) {
      return this.allowAbbreviation
        ? this.abbreviateFloat(e, this.maxAbbreviationError, this.fixedDigits)
        : this.fixedDigits !== void 0
        ? e.toFixed(this.fixedDigits)
        : String(e)
    }
    abbreviateFloat(e, r = 0, n = void 0) {
      if (Math.abs(e) < r) return '0'
      if (e < 0) return `-${this.abbreviateFloat(-e, r, n)}`
      let i = u.matchUnicodeFraction((s2) => Math.abs(s2.value - e) <= r)
      if (i !== void 0) return i.character
      let a = u.matchUnicodeFraction((s2) => Math.abs(Math.sqrt(s2.value) - e) <= r)
      return a !== void 0
        ? `\u221A${a.character}`
        : e % 1 !== 0 && n !== void 0
...
var p = u
;(p.CONSISTENT = new u(false, 0, 2, ', ')),
  (p.EXACT = new u(true, 0, void 0, ', ')),
  (p.MINIFIED = new u(true, 0, void 0, ',')),
  (p.SIMPLIFIED = new u(true, 5e-4, 3, ', '))
var m = /* @__PURE__ */ __name(
  class {
    static need(e, r, n) {
      if (e !== true) {
        let i = n === void 0 ? '(not provided)' : `[${Array.prototype.slice.call(n).join(', ')}]`,
...
var o = /* @__PURE__ */ __name(
  class {
    static from(e) {
      ...
      if (typeof e == 'number') return new o(e, 0)
    ...
    static realPartOf(e) {
      if (e instanceof o) return e.real
      if (typeof e == 'number') return e
      throw new d('Unrecognized value type.', { v: e })
    }
    static imagPartOf(e) {
      if (e instanceof o) return e.imag
    ...
    static rootsOfQuadratic(e, r, n) {
      if (((e = o.from(e)), (r = o.from(r)), (n = o.from(n)), e.isEqualTo(0))) {
        if (!r.isEqualTo(0)) return [n.times(-1).dividedBy(r)]
        if (!n.isEqualTo(0)) return []
        throw Error('Degenerate')
      }
      let i = r.times(r).minus(e.times(n).times(4)).sqrts(),
        a = r.times(-1),
        s2 = e.times(2)
      return i.map((x2) => a.minus(x2).dividedBy(s2))
    }
    isEqualTo(e) {
      return e instanceof o
        ? this.real === e.real && this.imag === e.imag
        : typeof e == 'number'
        ? this.real === e && this.imag === 0
        : false
    }
    ...
    sqrts() {
      let [e, r] = [this.real, this.imag],
        n = Math.sqrt(Math.sqrt(e * e + r * r))
      if (n === 0) return [o.ZERO]
      if (r === 0 && e < 0) return [new o(0, n), new o(0, -n)]
      let i = this.phase() / 2,
        a = o.polar(n, i)
      return [a, a.times(-1)]
    }
    ...
    toString(e) {
      return (
        (e = e || p.EXACT),
        e.allowAbbreviation ? this.toStringAllowSingleValue(e) : this.toStringBothValues(e)
      )
    }
    neg() {
      return new o(-this.real, -this.imag)
    ...
    raisedTo(e) {
      return e === 0.5 && this.imag === 0 && this.real >= 0
        ? new o(Math.sqrt(this.real), 0)
        : o.ZERO.isEqualTo(e)
        ? o.ONE
        : this.isEqualTo(o.ZERO)
        ? o.ZERO
        : this.ln().times(o.from(e)).exp()
    }
    exp() {
    ...
    toStringAllowSingleValue(e) {
      return Math.abs(this.imag) <= e.maxAbbreviationError
        ? e.formatFloat(this.real)
        : Math.abs(this.real) <= e.maxAbbreviationError
        ? Math.abs(this.imag - 1) <= e.maxAbbreviationError
          ? 'i'
          : Math.abs(this.imag + 1) <= e.maxAbbreviationError
          ? '-i'
          : `${e.formatFloat(this.imag)}i`
        : this.toStringBothValues(e)
    }
    toStringBothValues(e) {
      let r = this.imag >= 0 ? '+' : '-',
        n =
          e.allowAbbreviation && Math.abs(Math.abs(this.imag) - 1) <= e.maxAbbreviationError
            ? ''
            : e.formatFloat(Math.abs(this.imag))
      return `${
        (e.allowAbbreviation || e.fixedDigits === void 0 || this.real < 0 ? '' : '+') +
        e.formatFloat(this.real) +
        r +
        n
      }i`
...
function bind(controller2) {
  ...
  if (controller2.shadowRoot) bindShadow(controller2.shadowRoot)
  ...
  for (const binding of bindings(el)) {
    if (event2.type === binding.type) {
      ...
      if (
        ...
        controllers.has(root.host) &&
        root.host.matches(binding.tag)
      ) {
...
function findTarget(controller2, name) {
  ...
  for (const el of controller2.querySelectorAll(`[data-target~="${tag}.${name}"]`)) {
    if (el.closest(tag) === controller2) return el
  }
}
...
function findTargets(controller2, name) {
  ...
  if (controller2.shadowRoot) {
    for (const el of controller2.shadowRoot.querySelectorAll(`[data-targets~="${tag}.${name}"]`)) {
      if (!el.closest(tag)) targets2.push(el)
    }
  }
  for (const el of controller2.querySelectorAll(`[data-targets~="${tag}.${name}"]`)) {
    if (el.closest(tag) === controller2) targets2.push(el)
  }
  return targets2
}
...
var warn = /* @__PURE__ */ __name(function () {}, 'warn')
if (!IS_PRODUCTION) {
...
function evaluateGuard(machine, guard, context, _event, state) {
  ...
  if (guard.type === DEFAULT_GUARD_TYPE) {
    return (
      (guards === null || guards === void 0 ? void 0 : guards[guard.name]) || guard.predicate
    )(context, _event.data, guardMeta)
  }
  var condFn = guards[guard.type]
  if (!condFn) {
    throw new Error(
      "Guard '".concat(guard.type, "' is not implemented on machine '").concat(machine.id, "'.")
    )
  }
            ...
            if (exec_1 && preservedContexts) {
              ...
              resolvedActionObject = __assign(__assign({}, resolvedActionObject), {
                exec: function (_ctx) {
                  ...
                  exec_1.apply(
                    void 0,
                    __spreadArray([preservedContexts[contextIndex_1]], __read(args), false)
                  )
                },
              })
            }
    ...
    for (
      ...
      if (s2.type === 'compound' && (!adjList.get(s2) || !adjList.get(s2).length)) {
        ...
        if (s2.type === 'parallel') {
          try {
            for (
              var _e2 = ((e_3 = void 0), __values(getChildren(s2))), _f = _e2.next();
              !_f.done;
              _f = _e2.next()
            ) {
              var child = _f.value
...
var State = /* @__PURE__ */ (function () {
  function State2(config) {
    ...
    this.tags =
      (_a2 = Array.isArray(config.tags) ? new Set(config.tags) : config.tags) !== null &&
      _a2 !== void 0
        ? _a2
        : /* @__PURE__ */ new Set()
  ...
  State2.prototype.toJSON = function () {
    var _a2 = this,
      configuration = _a2.configuration,
      transitions = _a2.transitions,
      tags = _a2.tags,
      machine = _a2.machine,
      jsonValues = __rest(_a2, ['configuration', 'transitions', 'tags', 'machine'])
  ...
  State2.prototype.can = function (event2) {
    ...
    var transitionData =
      (_a2 = this.machine) === null || _a2 === void 0 ? void 0 : _a2.getTransitionData(this, event2)
    return (
...
function createInvocableActor(invokeDefinition, machine, context, _event) {
  ...
  var serviceCreator =
    (_a2 = machine === null || machine === void 0 ? void 0 : machine.options.services) === null ||
    _a2 === void 0
      ? void 0
      : _a2[invokeSrc.type]
...
var validateArrayifiedTransitions = /* @__PURE__ */ __name(function (
  stateNode,
  event2,
  transitions
) {
...
var StateNode = /* @__PURE__ */ (function () {
  function StateNode2(config, options, _context) {
    ...
    this.id =
      this.config.id ||
      __spreadArray([this.machine.key], __read(this.path), false).join(this.delimiter)
    ...
    this.states = this.config.states
      ? mapValues(this.config.states, function (stateConfig, key) {
          ...
          Object.assign(
            _this.idMap,
            __assign(((_a3 = {}), (_a3[stateNode.id] = stateNode), _a3), stateNode.idMap)
          )
          return stateNode
        })
      : EMPTY_OBJECT
  ...
  StateNode2.prototype.getStateNodes = function (state) {
    ...
    if (isString(stateValue)) {
      ...
      return initialStateValue !== void 0
        ? this.getStateNodes(((_a2 = {}), (_a2[stateValue] = initialStateValue), _a2))
  ...
  StateNode2.prototype.transitionParallelNode = function (stateValue, state, _event) {
    ...
    var enabledTransitions = flatten(
      stateTransitions.map(function (st2) {
  ...
  StateNode2.prototype.transition = function (state, event2, context) {
    ...
    if (this.strict) {
      if (!this.events.includes(_event.name) && !isBuiltInEvent(_event.name)) {
        throw new Error(
          "Machine '".concat(this.id, "' does not accept event '").concat(_event.name, "'")
        )
      }
    }
  ...
  StateNode2.prototype.resolveTransition = function (
    ...
    var invokeActions = resolvedActions.filter(function (action2) {
      ...
      return (
        action2.type === start &&
        ((_a3 = action2.activity) === null || _a3 === void 0 ? void 0 : _a3.type) === invoke
      )
    })
    ...
    var changed =
      ...
      (history2
        ? !!maybeNextState.actions.length ||
          didUpdateContext ||
          typeof history2.value !== typeof maybeNextState.value ||
          !stateValuesEqual(maybeNextState.value, history2.value)
        : void 0)
  ...
  StateNode2.prototype.getStateNode = function (stateKey) {
    ...
    if (!result) {
      throw new Error(
        "Child state '".concat(stateKey, "' does not exist on '").concat(this.id, "'")
      )
    }
    return result
  }
    ...
    get: function () {
      ...
      if (this.type === 'parallel') {
        ...
        initialStateValue = isLeafNode(this.states[this.initial])
          ? this.initial
          : ((_a2 = {}), (_a2[this.initial] = this.states[this.initial].initialStateValue), _a2)
      } else {
        initialStateValue = {}
      }
    ...
    get: function () {
      ...
      if (this.type === 'history') {
        ...
        if (isString(historyConfig.target)) {
          target2 = isStateId(historyConfig.target)
            ? pathToStateValue(
                this.machine.getStateNodeById(historyConfig.target).path.slice(this.path.length - 1)
              )
        ...
        try {
          for (var _c = __values(keys(states)), _d = _c.next(); !_d.done; _d = _c.next()) {
            ...
            if (state.states) {
              try {
                for (
                  var _e2 = ((e_8 = void 0), __values(state.events)), _f = _e2.next();
                  !_f.done;
                  _f = _e2.next()
                ) {
  ...
  StateNode2.prototype.formatTransitions = function () {
            ...
            if (!IS_PRODUCTION && key === NULL_EVENT) {
              warn(
                ...
                "Empty string transition configs (e.g., `{ on: { '': ... }}`) for transient transitions are deprecated. Specify the transition in the `{ always: ... }` property instead. " +
                  'Please check the `on` configuration for "#'.concat(_this.id, '".')
              )
            }
    ...
    var formattedTransitions = flatten(
      __spreadArray(
        __spreadArray(
          __spreadArray(__spreadArray([], __read(doneConfig), false), __read(invokeConfig), false),
          __read(onConfig),
          false
        ),
...
var Interpreter = /* @__PURE__ */ (function () {
  function Interpreter2(machine, options) {
    ...
    this.sendTo = function (event2, to2) {
      var isParent = _this.parent && (to2 === SpecialTargets.Parent || _this.parent.id === to2)
      var target2 = isParent
        ? _this.parent
        : isString(to2)
        ? _this.children.get(to2) || registry.get(to2)
        : isActor(to2)
        ? to2
        : void 0
      if (!target2) {
        if (!isParent) {
          throw new Error(
            "Unable to send event to child '".concat(to2, "' from service '").concat(_this.id, "'.")
          )
        }
        if (!IS_PRODUCTION) {
          warn(
    ...
    if (this.status === InterpreterStatus.NotStarted && this.options.deferEvents) {
      if (!IS_PRODUCTION) {
        warn(
          false,
          ''
            .concat(events.length, ' event(s) were sent to uninitialized service "')
            .concat(
              this.machine.id,
  ...
  Interpreter2.prototype.spawn = function (entity, name, options) {
    if (isPromiseLike(entity)) {
      ...
      throw new Error(
        'Unable to spawn entity "'.concat(name, '" of type "').concat(typeof entity, '".')
      )
    }
  }
          ...
          default:
            console.error(
              'PopperJS: an invalid property has been provided to the "' +
                ...
                VALID_PROPERTIES.map(function (s2) {
                  return '"' + s2 + '"'
                }).join(', ') +
                '; but "' +
                key +
    ...
    function runModifierEffects() {
      state.orderedModifiers.forEach(function (_ref3) {
        ...
        if (typeof effect5 === 'function') {
          ...
          var noopFn = /* @__PURE__ */ __name(function noopFn2() {}, 'noopFn')
...
function actualContains(parent, child) {
  ...
  while (target2) {
    ...
    target2 =
      target2.getRootNode == null
        ? void 0
        : (_target$getRootNode = target2.getRootNode()) == null
        ? void 0
...
function validateTargets(targets2) {
  ...
  var didPassPlainObject =
    Object.prototype.toString.call(targets2) === '[object Object]' && !targets2.addEventListener
  errorWhen(
    didPassFalsyValue,
    [
      'tippy() was passed',
...
var defaultProps = Object.assign(
  {
    ...
    moveTransition: '',
    offset: [0, 10],
    onAfterUpdate: /* @__PURE__ */ __name(function onAfterUpdate() {}, 'onAfterUpdate'),
    onBeforeUpdate: /* @__PURE__ */ __name(function onBeforeUpdate() {}, 'onBeforeUpdate'),
    onCreate: /* @__PURE__ */ __name(function onCreate() {}, 'onCreate'),
    onDestroy: /* @__PURE__ */ __name(function onDestroy() {}, 'onDestroy'),
    onHidden: /* @__PURE__ */ __name(function onHidden() {}, 'onHidden'),
    onHide: /* @__PURE__ */ __name(function onHide() {}, 'onHide'),
    onMount: /* @__PURE__ */ __name(function onMount() {}, 'onMount'),
    onShow: /* @__PURE__ */ __name(function onShow() {}, 'onShow'),
    onShown: /* @__PURE__ */ __name(function onShown() {}, 'onShown'),
    onTrigger: /* @__PURE__ */ __name(function onTrigger() {}, 'onTrigger'),
    onUntrigger: /* @__PURE__ */ __name(function onUntrigger() {}, 'onUntrigger'),
    onClickOutside: /* @__PURE__ */ __name(function onClickOutside() {}, 'onClickOutside'),
    placement: 'top',
    plugins: [],
    popperOptions: {},
    render: null,
...
function render(instance) {
  ...
  function onUpdate(prevProps, nextProps) {
    var _getChildren = getChildren2(popper2),
...
function createTippy(reference2, passedProps) {
  ...
  function onTrigger2(event2) {
    ...
    if (
      ...
      isEventListenerStopped(event2) ||
      didHideDueToDocumentMouseDown
    ) {
      return
    }
    var wasFocused =
      ((_lastTriggerEvent = lastTriggerEvent) == null ? void 0 : _lastTriggerEvent.type) === 'focus'
  ...
  function onMouseMove(event2) {
    ...
    var isCursorOverReferenceOrPopper =
      getCurrentTarget().contains(target2) || popper2.contains(target2)
  ...
  function onBlurOrFocusOut(event2) {
    ...
    if (
      ...
      popper2.contains(event2.relatedTarget)
    ) {
      return
    }
    scheduleHide(event2)
  ...
  function isEventListenerStopped(event2) {
    return currentInput.isTouch
      ? getIsCustomTouchBehavior() !== event2.type.indexOf('touch') >= 0
      : false
  }
  ...
  function scheduleHide(event2) {
    ...
    if (
      ...
      ['mouseleave', 'mousemove'].indexOf(event2.type) >= 0 &&
      isVisibleFromClick
    ) {
      return
    }
...
var createSingleton = /* @__PURE__ */ __name(function createSingleton2(
  tippyInstances,
  optionalProps
) {
...
var __classPrivateFieldSet = function (receiver, state, value, kind, f2) {
  ...
  return (
    kind === 'a' ? f2.call(receiver, value) : f2 ? (f2.value = value) : state.set(receiver, value),
    value
  )
}
...
;(_AttributeTemplatePart_setter = /* @__PURE__ */ new WeakMap()),
  (_AttributeTemplatePart_value = /* @__PURE__ */ new WeakMap())
...
var NodeTemplatePart = class {
  ...
  get value() {
    return __classPrivateFieldGet2(this, _NodeTemplatePart_parts, 'f')
  ...
  get nextSibling() {
    return __classPrivateFieldGet2(this, _NodeTemplatePart_parts, 'f')[
      __classPrivateFieldGet2(this, _NodeTemplatePart_parts, 'f').length - 1
    ].nextSibling
  }
  replace(...nodes) {
    ...
    for (const part of __classPrivateFieldGet2(this, _NodeTemplatePart_parts, 'f')) part.remove()
...
var TemplateInstance = class extends DocumentFragment {
  constructor(template, params, processor = propertyIdentity) {
    ...
    ;(_b = (_a2 = __classPrivateFieldGet3(this, _TemplateInstance_processor, 'f'))
      .createCallback) === null || _b === void 0
      ? void 0
      : _b.call(_a2, this, __classPrivateFieldGet3(this, _TemplateInstance_parts, 'f'), params)
  }
  update(params) {
    __classPrivateFieldGet3(this, _TemplateInstance_processor, 'f').processCallback(
      this,
      __classPrivateFieldGet3(this, _TemplateInstance_parts, 'f'),
      params
    )
  }
}
__name(TemplateInstance, 'TemplateInstance')
;(_TemplateInstance_processor = /* @__PURE__ */ new WeakMap()),
  (_TemplateInstance_parts = /* @__PURE__ */ new WeakMap())
...
function g(a) {
  ...
  __name(t, 't')
  return l2(t, 'ActivateableMixinClass'), t
}
__name(g, 'g')
l2(g, 'ActivateableMixin')
var et = l2(
  (a) =>
    typeof a == 'object' &&
    a !== null &&
    typeof a.angle == 'string' &&
    typeof a.reducedAngle == 'string',
  'isAngleable'
)
function J2(a) {
  class t extends a {
  ...
  __name(t, 't')
  return (
    l2(t, 'AngleableMixinClass'),
    s([attr], t.prototype, 'angle', 2),
    s([attr], t.prototype, 'reducedAngle', 2),
    t
  )
}
__name(J2, 'J')
...
var it = l2(
  (a) => typeof a == 'object' && a !== null && typeof a.controls == 'object',
  'isControllable'
)
function S(a) {
  class t extends a {
...
function T(a) {
  ...
  __name(t, 't')
  return l2(t, 'DisableableMixinClass'), s([attr], t.prototype, 'disabled', 2), t
}
__name(T, 'T')
l2(T, 'DisableableMixin')
var ft = l2((a) => a != null && a.tagName === 'CIRCUIT-DROPZONE', 'isCircuitDropzoneElement')
var Gt = l2((a) => a != null && a.tagName === 'PALETTE-DROPZONE', 'isPaletteDropzoneElement')
function v(a) {
  class t extends a {
    constructor() {
      super(...arguments)
      ...
      this.draggableMachine = createMachine(
        {
          id: 'draggable',
          initial: 'idle',
          states: {
        ...
        },
        {
          actions: {
            setInteract: () => {
              ...
              i.styleCursor(false),
                i.on('down', this.grab.bind(this)),
                i.on('up', this.unGrab.bind(this)),
                i.draggable({
              ...
              let n = this.dropzone
              ft(n) ? (this.snappedDropzone = n) : (this.snappedDropzone = null)
            },
            grab: (i, n) => {
              n.type === 'GRAB' &&
                ((this.grabbed = true),
                this.dispatchEvent(new Event('operation-grab', { bubbles: true })),
                Gt(this.dropzone) && ((this.snapped = false), this.moveByOffset(n.x, n.y)))
            },
            unGrab: () => {
              ;(this.grabbed = false),
              ...
              ;(this.snapped = false),
                this.snappedDropzone &&
                  this.snappedDropzone.dispatchEvent(
                    new Event('operation-unsnap', { bubbles: true })
                  )
            },
            drop: () => {
              !this.snapped ||
            ...
            delete: () => {
              ;(0, import_interactjs.default)(this).unset(),
                this.dispatchEvent(new Event('operation-delete', { bubbles: true }))
            },
          },
          guards: {
            isOnCircuitDropzone: () => ft(this.dropzone),
            isOnPaletteDropzone: () => Gt(this.dropzone),
            droppedOnCircuitDropzone: () => this.snapped && ft(this.dropzone),
    ...
    get dropzone() {
      ...
      return m.notNull(i), !Gt(i) && !ft(i) ? null : i
    }
    ...
    set snapTargets(i) {
      ;(0, import_interactjs.default)(this).draggable({
        modifiers: [
    ...
    move(i, n) {
      let r = this.operationX + i,
        o2 = this.operationY + n
      this.moveTo(r, o2)
    }
    moveTo(i, n) {
      ;(this.operationX = i),
        (this.operationY = n),
        (this.style.transform = `translate(${i}px, ${n}px)`)
    }
    moveByOffset(i, n) {
      let r = i - this.clientWidth / 2,
        o2 = n - this.clientHeight / 2
      this.move(r, o2)
    }
  }
  __name(t, 't')
  return (
    l2(t, 'DraggableMixinClass'),
    s([attr], t.prototype, 'operationX', 2),
    s([attr], t.prototype, 'operationY', 2),
    s([attr], t.prototype, 'grabbed', 2),
    s([attr], t.prototype, 'dragging', 2),
    s([attr], t.prototype, 'snapped', 2),
    s([attr], t.prototype, 'bit', 2),
    s([attr], t.prototype, 'debugDraggable', 2),
    t
  )
}
__name(v, 'v')
...
function ee(a) {
  ...
  __name(t, 't')
  return l2(t, 'FlaggableMixinClass'), s([attr], t.prototype, 'flag', 2), t
}
__name(ee, 'ee')
l2(ee, 'FlaggableMixin')
var It = l2(
  (a) => typeof a == 'object' && a !== null && typeof a.initHelp == 'function',
  'isHelpable'
)
function E(a) {
  class t extends a {
    constructor() {
      ...
      this.helpableMachine = createMachine(
        {
          id: 'helpable',
          initial: 'idle',
          states: {
            ...
            initialized: {
              ...
              states: {
                ...
                disabled: { on: { ENABLE: { target: 'enabled', actions: ['init', 'enable'] } } },
              },
            },
          },
        },
        {
          ...
          actions: {
            init: () => {
              ...
              i !== null &&
                ((this.popup = tippy_esm_default(this, {
                  allowHTML: true,
                  animation: false,
  ...
  __name(t, 't')
  return (
    l2(t, 'HelpableMixinClass'),
    s([attr], t.prototype, 'help', 2),
    s([attr], t.prototype, 'helpId', 2),
    s([attr], t.prototype, 'debugHelpable', 2),
    t
  )
}
__name(E, 'E')
...
function y(a) {
  ...
  __name(t, 't')
  return l2(t, 'IconableMixinClass'), s([attr], t.prototype, 'icon', 2), t
}
__name(y, 'y')
l2(y, 'IconableMixin')
var j = l2((a) => typeof a == 'object' && a !== null && typeof a.if == 'string', 'isIfable')
function O2(a) {
  class t extends a {
    constructor() {
      super(...arguments)
  ...
  __name(t, 't')
  return l2(t, 'IfableMixinClass'), s([attr], t.prototype, 'if', 2), t
}
__name(O2, 'O')
l2(O2, 'IfableMixin')
var ne = l2(
  (a) => typeof a == 'object' && a !== null && typeof a.initMenu == 'function',
  'isMenuable'
)
function x(a) {
  class t extends a {
    initMenu() {
      this._tippy ||
        ...
        (this.menu = tippy_esm_default(this, {
          allowHTML: true,
          animation: false,
          arrow: false,
          ...
          onHide: () => {
            var n, r, o2, p2
            ;(n = this.ifTooltip) == null || n.hide(),
              (r = this.angleTooltip) == null || r.hide(),
              (o2 = this.flagTooltip) == null || o2.hide(),
              (p2 = this.deleteTooltip) == null || p2.hide()
          },
        })))
    }
    showMenu() {
    ...
    get menuContent() {
      ...
      m.notNull(i)
      let n = i.content.cloneNode(true),
    ...
    initMenuItems(i) {
      if (j(i.reference)) {
        ...
        m.notNull(r),
          (r.disabled = false),
          (this.ifTooltip = r._tippy),
          this.ifTooltip === void 0 &&
            ((this.ifTooltip = tippy_esm_default(r, {
              animation: false,
              content: "Set `if' Conditional",
            })),
            r.addEventListener('mousedown', this.showIfInspector.bind(this)))
      }
      if (et(i.reference)) {
        let r = i.popper.querySelector('button[data-operation-menu-angle]')
        m.notNull(r),
          (r.disabled = false),
          (this.angleTooltip = r._tippy),
          this.angleTooltip === void 0 &&
            ((this.angleTooltip = tippy_esm_default(r, {
              animation: false,
              content: 'Change Angle',
            })),
            r.addEventListener('mousedown', this.showAngleInspector.bind(this)))
      }
      if (ot(i.reference)) {
        let r = i.popper.querySelector('button[data-operation-menu-flag]')
        m.notNull(r),
          (r.disabled = false),
          (this.flagTooltip = r._tippy),
          this.flagTooltip === void 0 &&
            ((this.flagTooltip = tippy_esm_default(r, {
              animation: false,
              content: 'Set Condifitonal Flag',
            })),
            r.addEventListener('mousedown', this.showFlagInspector.bind(this)))
      }
      let n = i.popper.querySelector('[data-operation-menu-delete]')
      m.notNull(n),
        (this.deleteTooltip = n._tippy),
        this.deleteTooltip === void 0 &&
          (this.deleteTooltip = tippy_esm_default(n, { animation: false, content: 'Delete' })),
        n.addEventListener('mousedown', this.destroyMenu.bind(this)),
        n.addEventListener('mousedown', this.dispatchOperationDeleteEvent.bind(this))
    }
    showIfInspector() {
  ...
  __name(t, 't')
  return l2(t, 'MenuableMixinClass'), t
}
__name(x, 'x')
l2(x, 'MenuableMixin')
var z2 = /* @__PURE__ */ __name(
  class extends x(E(v(g(HTMLElement)))) {
    constructor() {
      super(...arguments)
      this.x = 0
      this.y = 0
    ...
    showInspector() {
      if ((m.notNull(this.parentElement), this.parentElement.tagName === 'PALETTE-DROPZONE')) return
      let t = this._tippy
      t && t.destroy()
      let e = this.blochInspectorPopupContent()
      tippy_esm_default(this, {
        allowHTML: true,
        animation: false,
        arrow: ROUND_ARROW + ROUND_ARROW,
        delay: 0,
    ...
    attributeChangedCallback(t, e, i) {
      !this.body ||
        (e !== i &&
          i !== null &&
          (t === 'data-x' && (this.x = parseFloat(i)),
          t === 'data-y' && (this.y = parseFloat(i)),
          t === 'data-z' && (this.z = parseFloat(i)),
              ...
              <div id="perspective" part="perspective">
                <div id="vector" data-target="bloch-display.vector">
                  ...
                  <div id="vector-end" data-target="bloch-display.vectorEnd">
                    ${e(0, 'Y')} ${e(20, 'Y')} ${e(40, 'Y')} ${e(60, 'Y')} ${e(80, 'Y')}
                    ${e(100, 'Y')} ${e(120, 'Y')} ${e(140, 'Y')} ${e(160, 'Y')} ${e(90, 'X')}
                  </div>
                </div>
              </div>
            </div>
...
l2(z2, 'BlochDisplayElement'),
  s([target], z2.prototype, 'body', 2),
  s([target], z2.prototype, 'vectorLine', 2),
  s([target], z2.prototype, 'vectorEnd', 2),
  s([target], z2.prototype, 'vector', 2),
  s([targets], z2.prototype, 'vectorEndCircles', 2),
  s([attr], z2.prototype, 'x', 2),
  s([attr], z2.prototype, 'y', 2),
  s([attr], z2.prototype, 'z', 2)
controller(z2)
var se = `<svg
  id="icon"
  width="48"
...
var M2 = /* @__PURE__ */ __name(
  class extends x(E(v(T(y(g(HTMLElement)))))) {
    get operationType() {
      return Fe
    }
    connectedCallback() {
    ...
    update() {
      render2(html`${this.iconHtml(se)}`, this.shadowRoot)
    }
    toJson() {
      return `"${Fe}"`
    }
...
var k = /* @__PURE__ */ __name(
  class extends x(E(O2(S(v(T(y(g(HTMLElement)))))))) {
    get operationType() {
      return le
    }
    connectedCallback() {
    ...
    update() {
      render2(html`<div part="body">${this.iconHtml(le2)}</div>`, this.shadowRoot)
    }
    toJson() {
...
`
var R2 = /* @__PURE__ */ __name(
  class extends x(E(ee(v(y(g(HTMLElement)))))) {
    constructor() {
      super(...arguments)
      this.value = ''
    }
...
l2(R2, 'MeasurementGateElement'), s([attr], R2.prototype, 'value', 2)
controller(R2)
var de2 = `<svg
  width="48"
  height="48"
...
var q2 = /* @__PURE__ */ __name(
  class extends x(E(O2(S(J2(v(T(y(g(HTMLElement))))))))) {
    get operationType() {
      return be
    }
    connectedCallback() {
...
l2(D2, 'RnotGateElement')
controller(D2)
var he = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
  ...
  <sodipodi:namedview
    ...
    <sodipodi:guide
       position="4.6428572,35.678571"
       orientation="0,-1"
       id="guide863" />
    <sodipodi:guide
       position="4.1071429,13"
       orientation="0,-1"
       id="guide865" />
    <sodipodi:guide
       position="12.321429,46.571429"
       orientation="1,0"
       id="guide869" />
    <sodipodi:guide
       position="34.821429,46.75"
       orientation="1,0"
       id="guide877" />
  </sodipodi:namedview>
  <metadata
  ...
  <g
    ...
    <path
       ...
       d="M 12.321429,13.001579 V 35 l 0.124113,-9.836569 c 3.147523,0.03772 6.353769,-0.04212 8.02449,-1.255731 3.393398,-2.464969 2.536391,-7.829543 -0.882743,-10.075755 -1.55048,-1.018589 -4.37683,-0.830366 -7.26586,-0.830366 z M 18.235742,25.599948 21.730352,35 Z"
       sodipodi:nodetypes="ccccscccc" />
    <path
       style="fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1"
       d="M 34.609303,13.001579 24.747496,35"
       id="path837"
       sodipodi:nodetypes="cc" />
    <path
       style="fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1"
       d="M 24.818679,13.001579 34.609303,35"
       id="path839"
       sodipodi:nodetypes="cc" />
  </g>
</svg>
...
l2(N2, 'RxGateElement')
controller(N2)
var me = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   xmlns:dc="http://purl.org/dc/elements/1.1/"
   xmlns:cc="http://creativecommons.org/ns#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <g
    ...
    <path
       style="fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1"
       d="M 34.609303,13.001579 29.642858,23.928571"
       id="path837"
       sodipodi:nodetypes="cc" />
    <path
       style="fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1"
       d="m 25.030805,13.001579 4.612053,10.926992"
       id="path839-3"
       sodipodi:nodetypes="cc" />
    <path
       style="fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1"
       d="M 29.642858,23.928571 29.676413,35"
       id="path837-4"
       sodipodi:nodetypes="cc" />
  </g>
</svg>
...
l2(L, 'RyGateElement')
controller(L)
var be2 = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   xmlns:dc="http://purl.org/dc/elements/1.1/"
   xmlns:cc="http://creativecommons.org/ns#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <g
    ...
    <path
       style="fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1"
       d="m 24.818679,13.001579 h 9.790624"
       id="path839-0"
       sodipodi:nodetypes="cc" />
    <path
       style="fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1"
       d="M 24.747496,35 H 34.821429"
       id="path839-0-8"
       sodipodi:nodetypes="cc" />
  </g>
</svg>
...
`
var V2 = /* @__PURE__ */ __name(
  class extends x(E(S(v(T(y(g(HTMLElement))))))) {
    get operationType() {
      return Me
    }
    connectedCallback() {
    ...
    update() {
      render2(html`${this.iconHtml(fe2)}`, this.shadowRoot)
    }
    toJson() {
      return `"${Me}"`
    }
...
var ve2 = `<svg
  ...
  stroke-linecap="round"
>
  <path d="M15 13L33 13M24 13L24 35" />
</svg>
`
var $ = /* @__PURE__ */ __name(
  class extends x(E(O2(S(v(T(y(g(HTMLElement)))))))) {
...
var H2 = /* @__PURE__ */ __name(
  class extends x(E(v(y(g(HTMLElement))))) {
    constructor() {
      super(...arguments)
      this.value = ''
    }
...
l2(H2, 'WriteGateElement'), s([attr], H2.prototype, 'value', 2)
controller(H2)
var xe2 = `<svg
  width="48"
  height="48"
...
var we = l2((a) => a != null && a instanceof k, 'isHGateElement')
var Te = l2((a) => a != null && a instanceof B, 'isXGateElement')
var Se2 = l2((a) => a != null && a instanceof U, 'isYGateElement')
var Ge = l2((a) => a != null && a instanceof F2, 'isZGateElement')
var ht = l2((a) => a != null && a instanceof q2, 'isPhaseGateElement')
var Oe = l2((a) => a != null && a instanceof $, 'isTGateElement')
var Ie2 = l2((a) => a != null && a instanceof D2, 'isRnotGateElement')
var xt = l2((a) => a != null && a instanceof N2, 'isRxGateElement')
var yt = l2((a) => a != null && a instanceof L, 'isRyGateElement')
var Ct = l2((a) => a != null && a instanceof P, 'isRzGateElement')
var ze = l2((a) => a != null && a instanceof V2, 'isSwapGateElement')
var Bt = l2((a) => a != null && a instanceof M2, 'isControlGateElement')
var _e = l2((a) => a != null && a instanceof z2, 'isBlochDisplayElement')
var Qs = l2((a) => a != null && a instanceof H2, 'isWriteGateElement')
var Ae = l2((a) => a != null && a instanceof R2, 'isMeasurementGateElement')
function Me2(a) {
  return /^-?\d+$/.test(a)
}
__name(Me2, 'Me')
l2(Me2, 'isNumeric')
var Ut = /* @__PURE__ */ __name(
...
l2(Ut, 'InspectorButtonElement')
controller(Ut)
var Ft = l2((a) => a !== null && a instanceof Z, 'isAngleSliderElement')
var Z = /* @__PURE__ */ __name(
  class extends HTMLElement {
    constructor() {
      ...
      this.debug = false
      this.snapAngles = {}
      this.angleSliderMachine = createMachine(
        {
          id: 'angle-slider',
          initial: 'idle',
          states: {
            ...
            moving: {
              on: {
                SET_ANGLE: { target: 'moving', actions: ['dispatchChangeEvent'] },
                END_MOVE: { target: 'idle', actions: ['dispatchUpdateEvent'] },
              },
            },
          },
        },
        {
          actions: {
            ...
            setAngleInRadian: (t, e) => {
              if (e.type !== 'SET_DENOMINATOR') return
              let [, i] = this.findSnapAngle(this.radian)
              this.angle = i
            },
            setRadianInAngle: (t, e) => {
              if (e.type !== 'SET_ANGLE') return
    ...
    attributeChangedCallback(t, e, i) {
      e !== i &&
        i !== null &&
        (t === 'data-angle' && i !== '' && this.angleSliderService.send({ type: 'SET_ANGLE' }),
        t === 'data-denominator' &&
          this.angleSliderService !== void 0 &&
    ...
    initInteraction() {
      ;(0, import_interactjs2.default)(this).draggable({
        origin: 'self',
        modifiers: [import_interactjs2.default.modifiers.restrict({ restriction: 'self' })],
        listeners: {
    ...
    move(t) {
      let e = import_interactjs2.default.getElementRect(t.target).width,
        i = t.pageX / e
      this.left = i
    ...
    updateSnapAngles() {
      ...
      let t = -2 * this.denominator,
        ...
        i = new Array(e - t + 1).fill(null).map((n, r) => r + t)
      this.snapAngles = {}
      for (let n of i)
        this.denominator === 1
          ? n === 0
          ...
          : (this.snapAngles[(n * Math.PI) / this.denominator] = `${n}\u03C0/${this.denominator}`)
    }
    findSnapAngle(t) {
      let e = null,
        i = null,
...
l2(Z, 'AngleSliderElement'),
  s([attr], Z.prototype, 'angle', 2),
  s([attr], Z.prototype, 'radian', 2),
  s([attr], Z.prototype, 'denominator', 2),
  s([attr], Z.prototype, 'disabled', 2),
  s([attr], Z.prototype, 'debug', 2)
controller(Z)
var A2 = /* @__PURE__ */ __name(
  class extends HTMLElement {
    constructor() {
      super(...arguments)
    ...
    set operation(t) {
      if (
        ...
        j(t) && ((this.conditionalGatePaneDisabled = false), (this.ifInput.value = t.if)),
        et(t))
      ) {
        let e = X(t.angle)
        ht(t)
          ...
          (this.angleSlider.angle = t.angle),
    ...
    changeAngle(t) {
      let e = t.target
      if (!Ft(e)) throw new Error(`${e} isn't an angle-slider`)
    ...
    updateAngleInput() {
      ...
      if (Q(t)) {
        let e,
          i = X(t)
        ;(this.denominatorInput.value = i.toString()),
          (this.denominatorLabel.textContent = i.toString()),
          this.backupCurrentDenominator(),
          W(t, '-2\u03C0')
            ? ((e = `-${i * 2}\u03C0/${i}`), (this.angleInput.value = e))
            : H(t, '2\u03C0')
            ? ((e = `${i * 2}\u03C0/${i}`), (this.angleInput.value = e))
            : (e = t),
          this.backupCurrentPhi(),
          (this.angleSlider.angle = e),
          this.dispatchEvent(new Event('operation-inspector-angle-update', { bubbles: true }))
    ...
    changeDenominator() {
      ...
      Me2(t) && parseInt(t) > 1
        ? ((this.denominatorLabel.textContent = t),
          (this.angleSlider.denominator = parseInt(t)),
...
l2(A2, 'OperationInspectorElement'),
  s([target], A2.prototype, 'ifInput', 2),
  s([target], A2.prototype, 'angleInputLabel', 2),
  s([target], A2.prototype, 'angleInput', 2),
  s([target], A2.prototype, 'angleSlider', 2),
  s([target], A2.prototype, 'denominatorInput', 2),
  s([target], A2.prototype, 'denominatorVariableLabel', 2),
  s([target], A2.prototype, 'denominatorLabel', 2),
  s([target], A2.prototype, 'reduceAngleFractionCheckbox', 2),
  s([target], A2.prototype, 'flagInput', 2),
  s([attr], A2.prototype, 'conditionalGatePaneDisabled', 2),
  s([attr], A2.prototype, 'anglePaneDisabled', 2),
  s([attr], A2.prototype, 'conditionalFlagPaneDisabled', 2)
controller(A2)
  ...
  class extends HTMLElement {
    ...
    setAmplitudes(t) {
      ...
      for (let [i, n] of Object.entries(t)) {
        let r = e[parseInt(i)],
          o2 = h.from(n)
        r.setAttribute('data-amplitude-real', o2.real.toString()),
          r.setAttribute('data-amplitude-imag', o2.imag.toString())
        let p2 = o2.abs()
        if ((this.setRoundedMagnitude(r, p2), p2 === 0)) continue
          ...
          for (let r of n) {
            ...
            r.intersectionRatio >= 0.2
              ...
              : r.intersectionRatio === 0 &&
                o2.setAttribute('data-targets', 'circle-notation.qubitCircleGroups')
          }
        }, 'callback'),
        i = new IntersectionObserver(e, t)
      for (let n of this.qubitCircleGroups) i.observe(n)
    }
    ...
    setRoundedMagnitude(t, e) {
      ...
      ;(i = i < 10 ? (i === 0 ? 0 : 10) : Math.round(i / 10) * 10),
        (i = i / 100),
        t.setAttribute('data-magnitude', e.toString()),
        t.setAttribute('data-rounded-magnitude', i.toString())
    }
    setRoundedPhase(t, e) {
      if (t === null || t === void 0) return
      ...
      i < 0 && (i = 360 + i),
        ...
        t.setAttribute('data-rounded-phase', i.toString())
    }
    get qubitCirclesHtml() {
      return this.multiQubits
        ? this.stateVectorHtml(10)
        : html`${this.qubitCircleHtml(0)} ${this.qubitCircleHtml(1)}`
    }
    qubitCircleHtml(t) {
      return html`<div
        class="qubit-circle"
    ...
    stateVectorHtml(t) {
      let e = html``,
        i = this.qubitCircleGroup(
          [...Array(2 ** t).keys()],
          (n) =>
            this.qubitCircleGroup(n, (r) =>
              this.qubitCircleGroup(r, (o2) =>
                this.qubitCircleGroup(o2, (p2) =>
                  this.qubitCircleGroup(p2, (d2) =>
                    this.qubitCircleGroup(d2, (c2) => this.qubitCircleGroup(c2))
                  )
                )
              )
            ),
      ...
      for (let n of i) e = html`${e} ${n}`
      return e
    }
    qubitCircleGroup(t, e, i = t.length / 2) {
      return l2(
        (r, o2 = 1) => r.reduce((p2, d2, c2) => (c2 % o2 ? p2 : [...p2, r.slice(c2, c2 + o2)]), []),
        'arrayChunk'
      )(t, i).map((r) => {
        let o2 = html``
        if (e) for (let p2 of e(r)) o2 = html`${o2} ${p2}`
        else for (let p2 of r) o2 = html`${o2} ${this.qubitCircleHtml(p2)}`
        return i === 64
          ? html`<div
          ...
          : html`<div class="qubit-circle-group--size${i}">${o2}</div>`
      })
    }
    ...
    setPopupContent(t) {
      ...
      let e = t.target,
        i = this.ketDecimal(e),
        n = e.getAttribute('data-amplitude-real'),
        r = e.getAttribute('data-amplitude-imag'),
        o2 = e.getAttribute('data-magnitude'),
        p2 = e.getAttribute('data-phase'),
        d2
      n === null || r === null ? (d2 = h.ZERO) : (d2 = new h(parseFloat(n), parseFloat(r)))
      let c2
      o2 && parseFloat(o2) === 0 ? (c2 = 0) : (c2 = p2 ? parseFloat(p2) : 0),
    ...
    popupContent(t, e, i, n, r, o2) {
      let p2 = t.querySelector('.circle-notation-popup__ket-binary'),
        d2 = t.querySelector('.circle-notation-popup__ket-decimal'),
        c2 = t.querySelector('.circle-notation-popup__amplitude-real'),
        m2 = t.querySelector('.circle-notation-popup__amplitude-imag'),
        h2 = t.querySelector('.circle-notation-popup__probability'),
        u2 = t.querySelector('.circle-notation-popup__phase')
      p2 && (p2.textContent = e.toString(2).padStart(o2, '0')),
        d2 && (d2.textContent = e.toString()),
        c2 && (c2.textContent = this.forceSigned(i.real, 5)),
        m2 && (m2.textContent = `${this.forceSigned(i.imag, 5)}i`),
        h2 && (h2.textContent = `${this.forceSigned(n * n * 100, 4)}%`),
        u2 && (u2.textContent = `${this.forceSigned(r, 2)}\xB0`)
...
l2(Y, 'CircleNotationElement'),
  s([attr], Y.prototype, 'qubitCount', 2),
  s([attr], Y.prototype, 'size', 2),
  s([attr], Y.prototype, 'magnitudes', 2),
  s([attr], Y.prototype, 'phases', 2),
  s([attr], Y.prototype, 'multiQubits', 2),
  s([attr], Y.prototype, 'showKets', 2),
  s([targets], Y.prototype, 'qubitCircles', 2),
  s([targets], Y.prototype, 'qubitCircleGroups', 2),
  s([targets], Y.prototype, 'visibleQubitCircleGroups', 2)
controller(Y)
...
`
var He = `<svg part="tail-spin-icon" width="38" height="38" viewBox="0 0 38 38" xmlns="http://www.w3.org/2000/svg">
    <defs>
...
`
var rt = /* @__PURE__ */ __name(
  class extends HTMLElement {
    constructor() {
      super(...arguments)
      this.running = false
      this.debug = false
      this.runCircuitButtonMachine = createMachine(
        {
        ...
        },
        {
          actions: {
            ...
            ripple: (t, e) => {
              ...
              i.id = 'ripple'
              let n = Math.max(this.clientWidth, this.clientHeight),
                r = n / 2,
                o2 = this.getBoundingClientRect(),
                p2 = o2.left + window.pageXOffset,
                d2 = o2.top + window.pageYOffset
              i.setAttribute('part', 'ripple'),
                i.setAttribute('data-target', 'run-circuit-button.ripple'),
                (i.style.width = i.style.height = `${n}px`),
                (i.style.left = `${e.clientX - (p2 + r)}px`),
                (i.style.top = `${e.clientY - (d2 + r)}px`),
    ...
    update() {
      render2(
        html`<style>
          ...
          <div id="body" part="body" data-target="run-circuit-button.body">
...
l2(rt, 'RunCircuitButtonElement'),
  s([attr], rt.prototype, 'running', 2),
  s([attr], rt.prototype, 'debug', 2),
  s([target], rt.prototype, 'body', 2),
  s([target], rt.prototype, 'ripple', 2)
controller(rt)
...
`
var jt = l2((a) => a != null && a instanceof _, 'isCircuitDropzoneElement')
var _ = /* @__PURE__ */ __name(
  class extends HTMLElement {
    constructor() {
      ...
      this.shadow = false
      this.debug = false
      this.circuitDropzoneMachine = createMachine(
        {
          id: 'circuit-dropzone',
          initial: 'empty',
          states: {
    ...
    initDropzone() {
      this.operation !== null && (this.operationName = this.operation.tagName.toLocaleLowerCase()),
        (0, import_interactjs3.default)(this).dropzone({
    ...
    deleteOperation(t) {
      let e = t.target
      if (!G2(e)) throw new Error(`${e} isn't an Operation.`)
...
l2(_, 'CircuitDropzoneElement'),
  s([attr], _.prototype, 'operationName', 2),
  s([attr], _.prototype, 'inputWireQuantum', 2),
  s([attr], _.prototype, 'outputWireQuantum', 2),
  s([attr], _.prototype, 'connectTop', 2),
  s([attr], _.prototype, 'connectBottom', 2),
  s([attr], _.prototype, 'shadow', 2),
  s([attr], _.prototype, 'debug', 2)
controller(_)
var Tt = /* @__PURE__ */ __name(
  class extends HTMLElement {
    constructor() {
      super(...arguments)
      this.debug = false
      this.paletteDropzoneMachine = createMachine(
        {
          id: 'palette-dropzone',
          initial: 'idle',
          states: {
        ...
        },
        {
          actions: {
            newOperation: (t, e) => {
              ...
              let i = e.operation,
                n = i.cloneNode(false)
              if (!G2(n)) throw new TypeError(`${n} isn't an operation.`)
              It(i) && i.disableHelp(), this.prepend(n), this.initOperation(n)
            },
            deleteOperation: (t, e) => {
    ...
    initOperation(t) {
      ;(t.draggable = true), (t.snapped = true), (t.grabbed = false), It(t) && t.initHelp()
    }
    get operation() {
      let e = Array.from(this.children).filter((i) => G2(i))
      if (e.length === 0) throw new Error('palette-dropzone must have an operation.')
      if (e.length === 1) return e[0]
      throw new Error('palette-dropzone cannot hold multiple operations.')
    }
    grabOperation(t) {
      let e = t.target
      if (!G2(e)) throw new TypeError(`${e} isn't an operation.`)
...
var W2 = /* @__PURE__ */ __name(
  class extends HTMLElement {
    constructor() {
      ...
      this.shadow = false
      this.debug = false
      this.circuitStepMachine = createMachine(
        {
          id: 'circuit-step',
          initial: 'unknown',
          states: {
            ...
            visible: {
              ...
              on: {
                ...
                DELETE_OPERATION: { target: 'visible', actions: ['dispatchDeleteOperationEvent'] },
              },
              states: {
                activatable: {
                  type: 'compound',
    ...
    attributeChangedCallback(t, e, i) {
      if (
        ...
        for (let n of this.dropzones) i !== null ? (n.shadow = true) : (n.shadow = false)
    }
    update() {
      render2(html`<slot></slot>`, this.shadowRoot), this.dispatchUpdateEvent()
    }
    updateOperationAttributes(t) {
      for (let n of this.dropzones) (n.connectTop = false), (n.connectBottom = false)
      let e = this.controlGateDropzones,
        i = this.controllableDropzones(t)
      for (let n of i) it(n.operation) && (n.operation.controls = [])
    ...
    updateSwapConnections(t) {
      let e = t == null ? void 0 : t.disableSwap,
        i = this.swapGateDropzones
      if (i.length !== 2 || e) for (let n of i) n.operation.disable()
      else {
        for (let r of i)
          r.operation.enable(),
            (r.connectTop = i.some((p2) => this.bit(p2) < this.bit(r))),
            (r.connectBottom = i.some((p2) => this.bit(p2) > this.bit(r)))
    ...
    updatePhasePhaseConnections(t) {
      ...
      for (let i of e) {
        let n = i.operation
        if (n.angle === '' || (t !== void 0 && t.maxPhasePhaseTargetGates === 1)) continue
        let r = e
          .filter((o2) => {
            if (!ht(o2.operation)) throw new Error(`${o2.operation} isn't a phase-gate element.`)
            return n.angle === o2.operation.angle
          })
          .map((o2) => this.bit(o2))
        t !== void 0 &&
          t.maxPhasePhaseTargetGates > 1 &&
          (r = r.slice(0, t.maxPhasePhaseTargetGates)),
          !!r.includes(this.bit(i)) &&
            ((i.connectTop = r.some((o2) => o2 < this.bit(i))),
            (i.connectBottom = r.some((o2) => o2 > this.bit(i))))
      }
      for (let i of this.freeDropzones) {
        let r = this.phaseGateDropzones
            .filter((d2) => d2.connectTop || d2.connectBottom)
            .map((d2) => this.bit(d2)),
          o2 = Math.min(...r),
          p2 = Math.max(...r)
    ...
    updateControlControlConnections(t) {
      let e = this.controlGateDropzones,
        i = e.map((r) => this.bit(r)),
        n = 0
      t !== void 0 &&
        (t.maxControlControlTargetGates === 1
          ? (i = [])
          : t.maxControlControlTargetGates > 1 && (i = i.slice(0, t.maxControlControlTargetGates)))
      for (let r of e) {
        n += 1
        let o2 = r.operation
        ...
        (t !== void 0 &&
          (t.maxControlControlTargetGates === 1 ||
            (t.maxControlControlTargetGates > 0 && n > t.maxControlControlTargetGates)))
          ? o2.disable()
          : (o2.enable(),
            (r.connectTop = i.some((p2) => this.bit(r) > p2)),
            (r.connectBottom = i.some((p2) => this.bit(r) < p2)))
      }
    }
    updateControlledUConnections(t) {
      let e = this.controllableDropzones(t),
        i = this.controlGateDropzones,
        n = [...new Set(e.map((m2) => m2.operationName))],
        r = this.numControlGateDropzones(t, n),
        o2 = i.map((m2) => this.bit(m2)),
        p2 = r === null ? o2 : o2.slice(0, r),
        d2 = e.map((m2) => this.bit(m2)),
        c2 = p2.concat(d2)
      for (let [m2, h2] of Object.entries(i)) {
        let u2 = h2.operation
        ;(h2.connectBottom = c2.some((w2) => this.bit(h2) < w2)),
          (h2.connectTop = c2.some((w2) => this.bit(h2) > w2)),
          r === null || (r !== null && parseInt(m2) < r)
            ? u2.enable()
            : ((h2.connectTop = Math.max(...c2) > this.bit(h2)), u2.disable())
      }
      for (let m2 of e) {
        if (!it(m2.operation)) throw new Error(`${m2.operation} isn't controllable.`)
        ;(m2.operation.controls = this.controlBits(m2, o2, t)),
          (m2.connectTop = c2.some((h2) => h2 < this.bit(m2))),
          (m2.connectBottom = c2.some((h2) => h2 > this.bit(m2)))
      }
    }
    updateFreeDropzoneConnections(t) {
      let e = this.controllableDropzones(t),
        i = this.controlGateDropzones
          .filter((d2) => Bt(d2.operation) && !d2.operation.disabled)
          .map((d2) => this.bit(d2)),
        n = e.map((d2) => this.bit(d2)),
        r = i.concat(n),
        o2 = Math.min(...r),
        p2 = Math.max(...r)
      for (let d2 of this.freeDropzones)
        o2 < this.bit(d2) &&
          this.bit(d2) < p2 &&
          ((d2.connectTop = true), (d2.connectBottom = true))
    }
    controlBits(t, e, i) {
      let n = e
      return (
        i &&
          (i.maxChControlGates > 0 && t.operationName === 'h-gate'
            ? (n = e.slice(0, i.maxChControlGates))
            : i.maxCnotControlGates > 0 && t.operationName === 'x-gate'
            ? (n = e.slice(0, i.maxCnotControlGates))
            : i.maxCyControlGates > 0 && t.operationName === 'y-gate'
            ? (n = e.slice(0, i.maxCyControlGates))
            : i.maxCzControlGates > 0 && t.operationName === 'z-gate'
            ? (n = e.slice(0, i.maxCzControlGates))
            : i.maxCphaseControlGates > 0 && t.operationName === 'phase-gate'
            ? (n = e.slice(0, i.maxCphaseControlGates))
            : i.maxCtControlGates > 0 && t.operationName === 't-gate'
            ? (n = e.slice(0, i.maxCtControlGates))
            : i.maxCrnotControlGates > 0 && t.operationName === 'rnot-gate'
            ? (n = e.slice(0, i.maxCrnotControlGates))
            : i.maxCrxControlGates > 0 && t.operationName === 'rx-gate'
            ? (n = e.slice(0, i.maxCrxControlGates))
            : i.maxCryControlGates > 0 && t.operationName === 'ry-gate'
            ? (n = e.slice(0, i.maxCryControlGates))
            : i.maxCrzControlGates > 0 && t.operationName === 'rz-gate'
            ? (n = e.slice(0, i.maxCrzControlGates))
            : i.maxCswapControlGates > 0 &&
              t.operationName === 'swap-gate' &&
              (n = e.slice(0, i.maxCswapControlGates))),
        n
      )
    }
    bit(t) {
    ...
    get controlGateDropzones() {
      return this.dropzones.filter((t) => t.occupied && Bt(t.operation))
    }
    numControlGateDropzones(t, e) {
      ...
      return (
        e.includes('h-gate') &&
          !t.disableCh &&
          t.maxChControlGates > i &&
          (i = t.maxChControlGates),
        e.includes('x-gate') &&
          !t.disableCnot &&
          t.maxCnotControlGates > i &&
          (i = t.maxCnotControlGates),
        e.includes('y-gate') &&
          !t.disableCy &&
          t.maxCyControlGates > i &&
          (i = t.maxCyControlGates),
        e.includes('z-gate') &&
          !t.disableCz &&
          t.maxCzControlGates > i &&
          (i = t.maxCzControlGates),
        e.includes('phase-gate') &&
          !t.disableCphase &&
          t.maxCphaseControlGates > i &&
          (i = t.maxCphaseControlGates),
        e.includes('t-gate') &&
          !t.disableCt &&
          t.maxCtControlGates > i &&
          (i = t.maxCtControlGates),
        e.includes('rnot-gate') &&
          !t.disableCrnot &&
          t.maxCrnotControlGates > i &&
          (i = t.maxCrnotControlGates),
        e.includes('rx-gate') &&
          !t.disableCrx &&
          t.maxCrxControlGates > i &&
          (i = t.maxCrxControlGates),
        e.includes('ry-gate') &&
          !t.disableCry &&
          t.maxCryControlGates > i &&
          (i = t.maxCryControlGates),
        e.includes('rz-gate') &&
          !t.disableCrz &&
          t.maxCrzControlGates > i &&
          (i = t.maxCrzControlGates),
        e.includes('swap-gate') &&
          !t.disableCswap &&
          t.maxCswapControlGates > i &&
          (i = t.maxCswapControlGates),
        i === 0 ? null : i
      )
    }
    controllableDropzones(t) {
      let e = 0,
        ...
        h2 = 0
      return this.dropzones
        .filter((u2) => u2.occupied)
        .filter((u2) => it(u2.operation))
        .filter((u2) =>
          t === void 0
            ? true
            : we(u2.operation)
            ? ((e += 1), t.maxChTargetGates !== 0 && e > t.maxChTargetGates ? false : !t.disableCh)
            : Te(u2.operation)
            ? ((i += 1),
              t.maxCnotTargetGates !== 0 && i > t.maxCnotTargetGates ? false : !t.disableCnot)
            : Se2(u2.operation)
            ? ((n += 1), t.maxCyTargetGates !== 0 && n > t.maxCyTargetGates ? false : !t.disableCy)
            : Ge(u2.operation)
            ? ((r += 1), t.maxCzTargetGates !== 0 && r > t.maxCzTargetGates ? false : !t.disableCz)
            : ht(u2.operation)
            ? ((o2 += 1),
              t.maxCphaseTargetGates !== 0 && o2 > t.maxCphaseTargetGates
                ? false
                : !t.disableCphase)
            : Oe(u2.operation)
            ? ((p2 += 1),
              t.maxCtTargetGates !== 0 && p2 > t.maxCtTargetGates ? false : !t.disableCt)
            : Ie2(u2.operation)
            ? ((d2 += 1),
              t.maxCrnotTargetGates !== 0 && d2 > t.maxCrnotTargetGates ? false : !t.disableCrnot)
            : xt(u2.operation)
            ? ((c2 += 1),
              t.maxCrxTargetGates !== 0 && c2 > t.maxCrxTargetGates ? false : !t.disableCrx)
            : yt(u2.operation)
            ? ((m2 += 1),
              t.maxCryTargetGates !== 0 && m2 > t.maxCryTargetGates ? false : !t.disableCry)
            : Ct(u2.operation)
            ? ((h2 += 1),
              t.maxCrzTargetGates !== 0 && h2 > t.maxCrzTargetGates ? false : !t.disableCrz)
            : ze(u2.operation)
            ? !t.disableCswap
            : true
        )
      ...
      for (let [e, i] of C(this.operations, (n) => n.constructor))
        switch (e) {
              ...
              for (let [p2, d2] of C(o2, (c2) => c2.if))
                for (let [c2, m2] of C(d2, (h2) => h2.controls.toString())) {
                  let h2 = m2[0],
                    u2 = h2.operationType,
                    w2 = m2.map((tt) => tt.bit),
                    I2 = { type: u2, targets: w2 }
                  p2 !== '' && (I2.if = p2),
                    r !== '' && (I2.angle = r),
                    c2 !== '' && (I2.controls = h2.controls),
                    t.push(I2)
                }
            break
          }
          ...
          case V2: {
            ...
            if (n.length !== 2) break
            let r = n[0].operationType,
              o2 = n[0].controls,
              p2 = { type: r, targets: [n[0].bit, n[1].bit] }
          ...
          case R2: {
            ...
            for (let [r, o2] of C(n, (p2) => p2.flag)) {
              let p2 = o2.map((m2) => m2.bit),
                c2 = { type: o2[0].operationType, targets: p2 }
...
l2(W2, 'CircuitStepElement'),
  s([attr], W2.prototype, 'active', 2),
  s([attr], W2.prototype, 'breakpoint', 2),
  s([attr], W2.prototype, 'shadow', 2),
  s([attr], W2.prototype, 'debug', 2)
controller(W2)
var b = /* @__PURE__ */ __name(
  class extends HTMLElement {
    constructor() {
      ...
      this.quantumCircuitMachine = createMachine({
        id: 'quantum-circuit',
        initial: 'idle',
        states: {
    ...
    get largestStep() {
      let t = null,
        e = 0
      for (let i of this.steps) i.wireCount > 0 && i.wireCount > e && ((t = i), (e = i.wireCount))
      return t
    }
    appendMinimumSteps() {
      let t = this.minStepCount - this.steps.length
      for (let e = 0; e < t; e++) this.append(new W2())
    }
    stepAt(t) {
      let e = this.steps[t]
      return m.notNull(e), e
    ...
    addShadowStepAfter(t) {
      let e = new W2()
      e.shadow = true
      for (let i = 0; i < this.wireCount; i++) e.appendDropzone()
    ...
    deactivateAllSteps() {
      for (let t of this.steps) t.active = false
    }
    setBreakpoint(t) {
      for (let e of this.steps) e.breakpoint = false
      t.breakpoint = true
    }
    get breakpoint() {
    ...
    phase(...t) {
      let e = '',
        i,
        n
      if (typeof t[0] == 'number') i = t
      else if (typeof t[0] == 'string') (e = t[0]), (i = t.slice(1))
      else {
        let o2 = t[0]
    ...
    control(...t) {
      let e = this.applyOperationToTargets(() => new M2(), ...t)
      return this.updateStepOperationAttributes(e), this
    }
    bloch(...t) {
    ...
    measure(...t) {
      return this.applyOperationToTargets(() => new R2(), ...t), this.resize(), this
    }
    applyOperationToTargets(t, ...e) {
      let i = Math.max(...e) + 1,
        n = this.appendStepWithDropzones(i)
      for (let r of e) {
        let o2 = t()
    ...
    cnot(t, e) {
      return this.controlledU(B, t, e), this.resize(), this
    }
    cy(t, e) {
    ...
    cc(...t) {
      let e = Math.max(...t) + 1,
        i = this.appendStepWithDropzones(e)
      for (let n of t) i.dropzoneAt(n).put(new M2())
    ...
    controlledU(t, e, i) {
      let n = [].concat(e),
        ...
        o2 = n.concat(r),
        p2 = Math.max(...o2) + 1,
        d2 = this.appendStepWithDropzones(p2)
      for (let c2 of n) d2.dropzoneAt(c2).put(new M2())
      for (let c2 of r) d2.dropzoneAt(c2).put(new t())
    ...
    updateAllWires() {
      ...
      for (let i = 0; i < e; i++) this.updateWire(i)
    }
    activateOperation(t) {
      for (let e of this.operations) e.active = false
      t.active = true
    }
    appendWire() {
        ...
        for (let r of i) {
          switch (true) {
            ...
            case /^[\]}]$/.test(r):
              break
            default: {
              if (r !== 1) throw new Error(`Unknown instruction: ${r}`)
              n.appendDropzone()
            }
          }
          n.updateOperationAttributes()
        }
      }
      this.resize()
    }
    appendMinimumWires() {
      ...
      for (let i of this.steps) {
        let n = e - i.wireCount
        for (let r = 0; r < n; r++) i.appendDropzone()
      }
    }
    updateWire(t) {
      let e = false
      for (let i of this.steps) {
        ...
        if (((n.inputWireQuantum = e), n.operationName === 'write-gate'))
          ...
          if (r.length === 2) {
            let o2 = r.map((m2) => i.bit(m2)),
              p2 = i.bit(n),
              d2 = o2[0] === p2 ? o2[1] : o2[0],
              c2 = i.dropzoneAt(d2)
            ;(n.inputWireQuantum = e),
              (n.outputWireQuantum = c2.inputWireQuantum),
              (e = c2.inputWireQuantum)
          } else (n.inputWireQuantum = e), (n.outputWireQuantum = e)
        } else (n.inputWireQuantum = e), (n.outputWireQuantum = e)
      }
    }
    updateChangedWire(t) {
      let e = t.target
      if (!Q2(e)) throw new Error(`${e} isn't a circuit-step.`)
      let i = t.detail.dropzone
      if (!jt(i)) throw new Error(`${i} isn't a circuit-dropzone.`)
    ...
    setSnapTargets(t) {
      let e = this.dropzones.filter((r) => !r.occupied),
        i = []
      this.snapTargets = {}
      let n = t.dropzone
      jt(n) && e.push(n)
      for (let [r, o2] of Object.entries(this.dropzones)) {
        let p2 = o2.snapTarget,
          d2 = this.isVertical ? p2.y : p2.x,
          c2 = this.isVertical ? p2.x : p2.y,
          m2 = parseInt(r) % this.wireCount,
          h2 = d2 - t.snapRange * 0.75,
          u2 = d2 + t.snapRange * 0.75
        parseInt(r) < this.wireCount &&
          (this.isVertical ? i.push({ x: c2, y: h2 }) : i.push({ x: h2, y: c2 }),
          this.snapTargets[h2] === void 0 && (this.snapTargets[h2] = {}),
          this.snapTargets[h2][c2] === void 0 &&
            (this.snapTargets[h2][c2] = { dropzone: null, stepIndex: -1, wireIndex: m2 })),
          this.isVertical ? i.push({ x: c2, y: u2 }) : i.push({ x: u2, y: c2 }),
          this.snapTargets[u2] === void 0 && (this.snapTargets[u2] = {}),
          this.snapTargets[u2][c2] === void 0 &&
            (this.snapTargets[u2][c2] = {
              dropzone: null,
              stepIndex: Math.floor(parseInt(r) / this.wireCount),
              wireIndex: m2,
            }),
          (!o2.occupied || o2 === n) && i.push(p2),
          this.snapTargets[d2] === void 0 && (this.snapTargets[d2] = {}),
          this.snapTargets[d2][c2] === void 0 &&
            (this.snapTargets[d2][c2] = { dropzone: o2, stepIndex: null, wireIndex: m2 })
      }
      t.snapTargets = i
    }
    updateSnapTargets(t) {
      ...
      for (let [n, r] of Object.entries(t)) {
        let o2 = r.snapTarget,
          p2 = this.isVertical ? o2.y : o2.x,
          d2 = this.isVertical ? o2.x : o2.y
        m.notNull(this.snapTargets[p2]),
          (this.snapTargets[p2][d2] = { dropzone: r, stepIndex: null, wireIndex: parseInt(n) })
      }
    }
    serialize() {
...
l2(b, 'QuantumCircuitElement'),
  s([attr], b.prototype, 'minStepCount', 2),
  s([attr], b.prototype, 'minWireCount', 2),
  s([attr], b.prototype, 'maxWireCount', 2),
  s([attr], b.prototype, 'editing', 2),
  s([attr], b.prototype, 'updateUrl', 2),
  s([attr], b.prototype, 'json', 2),
  s([attr], b.prototype, 'circuitTitle', 2),
  s([attr], b.prototype, 'debug', 2),
  s([attr], b.prototype, 'chDisabled', 2),
  s([attr], b.prototype, 'chMaxControlGates', 2),
  s([attr], b.prototype, 'chMaxTargetGates', 2),
  s([attr], b.prototype, 'cnotDisabled', 2),
  s([attr], b.prototype, 'cnotMaxControlGates', 2),
  s([attr], b.prototype, 'cnotMaxTargetGates', 2),
  s([attr], b.prototype, 'cyDisabled', 2),
  s([attr], b.prototype, 'cyMaxControlGates', 2),
  s([attr], b.prototype, 'cyMaxTargetGates', 2),
  s([attr], b.prototype, 'czDisabled', 2),
  s([attr], b.prototype, 'czMaxControlGates', 2),
  s([attr], b.prototype, 'czMaxTargetGates', 2),
  s([attr], b.prototype, 'cphaseDisabled', 2),
  s([attr], b.prototype, 'cphaseMaxControlGates', 2),
  s([attr], b.prototype, 'cphaseMaxTargetGates', 2),
  s([attr], b.prototype, 'ctDisabled', 2),
  s([attr], b.prototype, 'ctMaxControlGates', 2),
  s([attr], b.prototype, 'ctMaxTargetGates', 2),
  s([attr], b.prototype, 'crnotDisabled', 2),
  s([attr], b.prototype, 'crnotMaxControlGates', 2),
  s([attr], b.prototype, 'crnotMaxTargetGates', 2),
  s([attr], b.prototype, 'crxDisabled', 2),
  s([attr], b.prototype, 'crxMaxControlGates', 2),
  s([attr], b.prototype, 'crxMaxTargetGates', 2),
  s([attr], b.prototype, 'cryDisabled', 2),
  s([attr], b.prototype, 'cryMaxControlGates', 2),
  s([attr], b.prototype, 'cryMaxTargetGates', 2),
  s([attr], b.prototype, 'crzDisabled', 2),
  s([attr], b.prototype, 'crzMaxControlGates', 2),
  s([attr], b.prototype, 'crzMaxTargetGates', 2),
  s([attr], b.prototype, 'cswapDisabled', 2),
  s([attr], b.prototype, 'cswapMaxControlGates', 2),
  s([attr], b.prototype, 'swapDisabled', 2),
  s([attr], b.prototype, 'controlControlDisabled', 2),
  s([attr], b.prototype, 'controlControlMaxTargetGates', 2),
  s([attr], b.prototype, 'phasePhaseDisabled', 2),
  s([attr], b.prototype, 'phasePhaseMaxTargetGates', 2)
controller(b)
var ct = /* @__PURE__ */ __name(
  class extends HTMLElement {
    constructor() {
      super(...arguments)
      this.debug = false
      this.circuitEditorMachine = createMachine(
        {
          id: 'circuit-editor',
          initial: 'inspectable',
          states: {
              ...
              states: {
                ...
                idle: {
                  ...
                  on: {
                    ...
                    MOUSE_LEAVE_STEP: { target: 'idle', actions: ['deactivateStep'] },
        ...
        {
          guards: { isIdle: () => !this.circuit.editing, isEditing: () => this.circuit.editing },
          actions: {
            enableDragging: () => {
            ...
            snapOperationIntoDropzone: (t, e) => {
              ...
              let i = e.operation,
                n = this.circuit.snapTargetAt(e.x, e.y)
              if (((i.snapped = true), n.dropzone === null)) {
                let r = n.stepIndex
                m.notNull(r)
                let o2 = this.circuit.addShadowStepAfter(r),
                  p2 = o2.dropzones[n.wireIndex]
                m.notNull(p2),
                  p2.append(i),
                  (p2.operationName = i.tagName.toLocaleLowerCase()),
                  this.circuit.updateSnapTargets(o2.dropzones)
              } else n.dropzone.append(i)
            },
            addDocumentCursorGrabbingStyle: () => {
            ...
            deactivateStep: (t, e) => {
              ;(e.type !== 'MOUSE_LEAVE_STEP' && e.type !== 'UNSNAP_STEP') ||
                (e.step.active = false)
            },
            deactivateAllSteps: () => {
    ...
    activateOperation(t) {
      let e = t.target
      if (!G2(e)) throw new Error(`${e} must be an Operation.`)
    ...
    setOperationFlag(t) {
      let e = t.target,
        i = this.activeOperation
      if (!ot(i)) throw new Error('[data-flag] not found.')
...
l2(ct, 'CircuitEditorElement'),
  s([attr], ct.prototype, 'debug', 2),
  s([target], ct.prototype, 'circuit', 2),
  s([target], ct.prototype, 'inspectorButton', 2)
controller(ct)
var st = /* @__PURE__ */ __name(
  class extends HTMLElement {
    constructor() {
      super(...arguments)
      this.updateUrl = false
    ...
    handleServiceWorkerMessage(t) {
      ...
      switch (e.type) {
        ...
        case 'finish': {
          for (let r of this.runCircuitButtons) r.running = false
          break
        }
        default:
    ...
    run() {
      ...
      let i = Math.max(
        ...
        n = i >= 0 ? i + 1 : 1
      ;(this.circleNotation.qubitCount = n),
    ...
    get activeStepIndex() {
      let t = this.circuit.activeStep,
        ...
        i = t || e
      return (
        i === null && ((i = this.circuit.stepAt(0)), this.circuit.setBreakpoint(i)),
        this.circuit.fetchStepIndex(i)
      )
    }
...
l2(st, 'QuantumSimulatorElement'),
  s([attr], st.prototype, 'updateUrl', 2),
  s([target], st.prototype, 'circuit', 2),
  s([target], st.prototype, 'circleNotation', 2),
  s([targets], st.prototype, 'runCircuitButtons', 2)
controller(st)
