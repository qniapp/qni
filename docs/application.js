      ...
      var sd = (function () {
        function n() {
          ...
          Ul(this, n),
            ...
            ie(this, 'interactStatic', (0, Wa.createInteractStatic)(this)),
...
Args: ${o}`
  ...
  c(_c, 'getSideOffsets')
  function Pc(t) {
    return [Lt, Wt, Vt, $t].some(function (e) {
      return t[e] >= 0
    })
  }
    ...
    if (!!D) {
      ...
      if (g) {
        var jr,
          ...
          fr = dr ? Ve + X[Ye] + Y[Ye] - Me - U.altAxis : Kt,
      ...
      if (!(L || tt || ot) && (ht('onHide', [E], !1), E.props.onHide(E) !== !1)) {
        if (
          ...
          var vt = Ct(),
            te = vt.box,
            ee = vt.content
          E.props.animation && (il([te, ee], wt), Wc([te, ee], 'hidden'))
        }
